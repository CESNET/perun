...
public class urn_perun_user_attribute_def_def_mfaEnforceSettingsTest {
	...
	public void testAttributeSyntaxNotValidJSON() {
		...
		try {
			...
			assertEquals("Attribute value " + attributeToCheck.getValue() + " is not a valid JSON." , errorWithoutId(e.getMessage()));
		}
	}
	...
	public void testCheckAttributeSemanticsCorrect() throws Exception {
		...
		attributeToCheck.setValue("{\"include_categories\":[\"cat1\",\"cat2\"],\"exclude_rps\":[\"cat1_rps2\",\"cat2_rps1\"]}");
	...
	public void testCheckAttributeSemanticsWrongCategoryReference() throws Exception {
		...
		attributeToCheck.setValue("{\"include_categories\":[\"cat1\",\"wrong_cat\"],\"exclude_rps\":[\"cat1_rps2\",\"cat2_rps1\"]}");
