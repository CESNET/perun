...
public class urn_perun_user_attribute_def_virt_earliestActiveLastAccessTest {
	...
	public void setUp() throws Exception {
		...
		ues1 = new UserExtSource(10, new ExtSource(100, "earliestAccessExtSource1", ExtSourcesManager.EXTSOURCE_IDP), "login");
		...
		when(session.getPerunBl().getUsersManagerBl().getUserExtSources(session, user)).thenReturn(List.of(ues1,ues2,ues3,ues4));
	}
