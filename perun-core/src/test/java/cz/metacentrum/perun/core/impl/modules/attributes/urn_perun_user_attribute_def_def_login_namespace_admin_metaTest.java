...
public class urn_perun_user_attribute_def_def_login_namespace_admin_metaTest {
  ...
  public void testAlreadyReservedLogin() throws Exception {
    ...
    doThrow(new AlreadyReservedLoginException("")).when(userManagerMock)
  ...
  public void testCorrectSyntax() throws Exception {
    ...
    doNothing().when(module).checkLoginFormat(session, value);
    classInstance.checkAttributeSyntax(session, user, attributeToCheck);
    verify(module).checkLoginFormat(session, value);
  }
  ...
  public void testIncorrectCharSyntax() throws Exception {
    ...
    doThrow(new InvalidLoginException("")).when(module).checkLoginFormat(session, value);
    classInstance.checkAttributeSyntax(session, user, attributeToCheck);
  }
