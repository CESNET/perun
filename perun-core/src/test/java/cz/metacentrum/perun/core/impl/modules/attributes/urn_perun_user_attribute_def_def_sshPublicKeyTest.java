...
public class urn_perun_user_attribute_def_def_sshPublicKeyTest {
  ...
  public void testCheckCorrectEcdsaNistp384AttributeSyntax() throws Exception {
    ...
    List<String> value = new ArrayList<>();
    value.add(
        "ecdsa-sha2-nistp384 AAAAE2VjZHNhLXNoYTItbmlzdHAzODQAAAAIbmlzdHAzODQAAABhBEi2C/YeOHQ3RVo1WhZwOkEj5nHeX6eFJvpdVmxBIeiCNyVXGrUO1PXj13/ywlz6YaT9rs6CfpbV99gsvp7uZP1rbaGHm0ZuxWbt+C9WV3Br/hf2CZtNljDXCpNwjvCt0A== martin@martin-ThinkPad-T480");
    attributeToCheck.setValue(value);
  ...
  public void testCheckCorrectEcdsaNistp521AttributeSyntax() throws Exception {
    ...
    List<String> value = new ArrayList<>();
    value.add(
        "ecdsa-sha2-nistp521 AAAAE2VjZHNhLXNoYTItbmlzdHA1MjEAAAAIbmlzdHA1MjEAAACFBAFtrrFATKkxbaAKKBvl/X8SIbpJZffbCS0v2v9KLEE+6VEHqQFIDreZEXKbvk5/3JZ9Foh6+SJLE8fSyZKJE/0zcgEhhHfsYMdQASwshLSKpoaBNApo5gIqHD8a0WFIed86MOFIuB/Ux90X3an23bPSyM7Ri4mko3BXc8iAvvLQwf10HA== martin@martin-ThinkPad-T480");
    attributeToCheck.setValue(value);
  ...
  public void testCheckCorrectEcdsaSkAttributeSyntax() throws Exception {
    ...
    List<String> value = new ArrayList<>();
    value.add(
        "sk-ecdsa-sha2-nistp256@openssh.com AAAAInNrLWVjZHNhLXNoYTItbmlzdHAyNTZAb3BlbnNzaC5jb20AAAAIbmlzdHAyNTYAAABBBM1agPWb+qLilWO+bpaMxNIeMb7Nx6hs3stZeYhnlZYw51vV5GMmc8OGDbm/hiPRiqqSt7mgzdR6WYpwyvssHlwAAAAEc3NoOg== martin@martin-ThinkPad-T480");
    attributeToCheck.setValue(value);
  ...
  public void testCheckSshED25519AttributeSyntaxWithWrongPrefix() throws Exception {
    ...
    List<String> value = new ArrayList<>();
    value.add(
        "ssh-rsa environment=\"GIT_AUTHOR_NAME=John Doe\",environment=\"GIT_AUTHOR_EMAIL=john.doe@email.cz\" ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJhGU1cLG0UldPhYxbEjKcZmFSZsGznmAYvra2QPls7a martin@martin-ThinkPad-T480");
    attributeToCheck.setValue(value);
  ...
  public void testCheckAttributeSyntaxWithInvalidTypePosition() throws Exception {
    ...
    List<String> value = new ArrayList<>();
    value.add(
        "ecdsa-sha2-nistp256 some_random_text AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBGgt1/rkRvQJp92tP8uxLJfy340lJGSSxsPp3+W1JdMbk+S2qIPwM5o/oblTjGhVRzKcas4pLrBz7L/Mxn6D6qw= martin@martin-ThinkPad-T480");
    attributeToCheck.setValue(value);
