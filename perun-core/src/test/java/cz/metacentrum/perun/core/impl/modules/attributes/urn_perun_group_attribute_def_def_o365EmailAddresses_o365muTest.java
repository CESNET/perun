...
public class urn_perun_group_attribute_def_def_o365EmailAddresses_o365muTest {
  ...
  public void fillAttribute() throws Exception {
    ...
    when(am.getPerunBeanIdsForUniqueAttributeValue(eq(session), argThat(new BeanAttributeMatcher("user")))).thenReturn(
        Sets.newHashSet());
  ...
  public void setUp() throws Exception {
    ...
    when(am.getAttribute(session, group,
        urn_perun_group_attribute_def_def_o365EmailAddresses_o365mu.ADNAME_ATTRIBUTE)).thenReturn(adNameAttr);
