...
public class urn_perun_group_attribute_def_def_flatGroupStructureEnabledTest {
  ...
  public void testCheckWithoutMandatoryAttributeSemantics() throws Exception {
    ...
    when(attributesManagerBl.getAttribute(sess, group,
        GroupsManager.GROUPS_STRUCTURE_SYNCHRO_ENABLED_ATTRNAME)).thenReturn(null);
  ...
  public void testCorrectSemantics() throws Exception {
    ...
    when(attributesManagerBl.getAttribute(sess, group,
        GroupsManager.GROUPS_STRUCTURE_SYNCHRO_ENABLED_ATTRNAME)).thenReturn(attributeToCheck);
    attributeToCheck.setValue(true);
