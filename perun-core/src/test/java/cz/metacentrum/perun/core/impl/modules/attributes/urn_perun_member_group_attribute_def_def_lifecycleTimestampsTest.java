...
public class urn_perun_member_group_attribute_def_def_lifecycleTimestampsTest {
  private static urn_perun_member_group_attribute_def_def_lifecycleTimestamps classInstance;
  private static PerunSessionImpl session;
  private static Attribute attributeToCheck;

  @Before
  public void setUp() throws Exception {
    classInstance = new urn_perun_member_group_attribute_def_def_lifecycleTimestamps();
  ...
  public void testCheckAttributeSyntaxCorrect() throws Exception {
    ...
    classInstance.checkAttributeSyntax(session, null, null, attributeToCheck);
  }
  ...
  public void testCheckAttributeSemanticsCorrect() throws Exception {
    ...
    value.put("expiredAt", "2001-12-25");
    attributeToCheck.setValue(value);
    classInstance.checkAttributeSemantics(session, null, null, attributeToCheck);
  }
  ...
  @Test(expected = WrongReferenceAttributeValueException.class)
  public void testCheckAttributeSemanticsDateNullValue() throws Exception {
    System.out.println("testCheckAttributeSemanticsDateNullValue()");
    LinkedHashMap<String, String> value = new LinkedHashMap<>();
