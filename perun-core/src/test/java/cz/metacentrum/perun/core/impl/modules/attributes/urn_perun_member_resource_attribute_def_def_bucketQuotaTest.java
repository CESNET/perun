...
public class urn_perun_member_resource_attribute_def_def_bucketQuotaTest extends AbstractPerunIntegrationTest {
  ...
  public void setUp() throws Exception {
    classInstance = new urn_perun_member_resource_attribute_def_def_bucketQuota();
  ...
  public void checkAttributeSemantic() throws Exception {
    System.out.println("urn_perun_member_resource_attribute_def_def_bucketQuota.checkAttributeSemantic()");
  ...
  public void checkAttributeSemanticNull() throws Exception {
    System.out.println("urn_perun_member_resource_attribute_def_def_bucketQuota.checkAttributeSemanticNull()");
    maxAttr.setValue("0:0");
  ...
  public void checkAttributeSemanticSame() throws Exception {
    System.out.println("urn_perun_member_resource_attribute_def_def_bucketQuota.checkAttributeSemanticSame()");
  ...
  public void checkAttributeSemanticSoftLarger() throws Exception {
    System.out.println("urn_perun_member_resource_attribute_def_def_bucketQuota.checkAttributeSemanticSoftLarger()");
  ...
  public void checkAttributeSemanticHardLarger() throws Exception {
    System.out.println("urn_perun_member_resource_attribute_def_def_bucketQuota.checkAttributeSemanticHardLarger()");
