...
public class urn_perun_user_attribute_def_virt_studentIdentifiersTest extends AbstractPerunIntegrationTest {
  ...
  private final urn_perun_user_attribute_def_virt_studentIdentifiers classInstance =
      new urn_perun_user_attribute_def_virt_studentIdentifiers();
  ...
  private final String schacPersonalUniqueCodeAttrName =
      AttributesManager.NS_UES_ATTR_DEF + ":" + schacPersonalUniqueCodeFriendlyName;
  private final String voPersonExternalAffiliationAttrName =
      AttributesManager.NS_UES_ATTR_DEF + ":" + voPersonExternalAffiliationFriendlyName;
  private final String schacHomeOrganizationAttrName =
  ...
  private final String loginNamespaceAttrFriendlyName =
      AttributesManager.LOGIN_NAMESPACE + ":" + organizationNamespaceValue;
  private final String loginNamespaceAttrValue = "123456";
  // Expected (returned) values
  private final String schacPersonalUniqueCodeValue =
      studentIdentifiersValuePrefix + organizationScopeValue + ":" + loginNamespaceAttrValue;
  ...
  public void memberAddedEvent() throws PerunException {
    ...
    String shoValue =
        perun.getAttributesManagerBl().getAttribute(sess, ues, schacHomeOrganizationAttrName).valueAsString();
    String epsaValue =
        perun.getAttributesManagerBl().getAttribute(sess, ues, voPersonExternalAffiliationAttrName).valueAsString();
    List<String> spucValue =
        perun.getAttributesManagerBl().getAttribute(sess, ues, schacPersonalUniqueCodeAttrName).valueAsList();
