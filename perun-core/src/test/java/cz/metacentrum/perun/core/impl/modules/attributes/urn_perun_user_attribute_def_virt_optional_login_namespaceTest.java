...
public class urn_perun_user_attribute_def_virt_optional_login_namespaceTest {
	...
	public void setUp() throws Exception {
		...
		String namespace = AttributesManager.NS_USER_ATTR_DEF + ":login-namespace:" + attributeToCheck.getFriendlyNameParameter();
		...
		when(session.getPerunBl().getAttributesManagerBl().getAttribute(session, user, namespace)).thenReturn(attributeToCheck);
	}
