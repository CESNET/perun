...
public class ExtSourceJSONTest {
  ...
  public void getGroupMembersJsonTest() throws Exception {
    ...
    String json =
        "{\"members\":{\"uuid_1\":{\"urn:perun:user:attribute-def:virt:login-namespace:mu\":\"123456\"}," +
            "\"uuid_2\":{\"urn:perun:user:attribute-def:virt:login-namespace:mu\":\"987654\"}}}";
    ...
    mapOfSubject.put("additionalues_1",
        "https://oidc.muni.cz/oidc/|cz.metacentrum.perun.core.impl.ExtSourceIdp|123456|2");
    mapOfSubject.put("login", "123456");
    expectedSubjects.add(mapOfSubject);
    mapOfSubject = new HashMap<>();
    mapOfSubject.put("additionalues_1",
        "https://oidc.muni.cz/oidc/|cz.metacentrum.perun.core.impl.ExtSourceIdp|987654|2");
