 ...
 */
public class urn_perun_group_resource_attribute_def_def_adName extends GroupResourceAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Group group, Resource resource, Attribute attribute)
    ...
    List<Group> groupsWithSameADNameInSameOu =
        sess.getPerunBl().getSearcherBl().getGroupsByGroupResourceSetting(sess, attribute, resourceAdOuName);
