...
public class urn_perun_user_attribute_def_virt_login_namespace_geant_persistent extends UserVirtualAttributesModuleAbstract {
	...
	public Attribute getAttributeValue(PerunSessionImpl sess, User user, AttributeDefinition attributeDefinition) {
		...
		try {
			...
			if (geantPersistentShadow.getValue() == null) {
				...
				geantPersistentShadow = sess.getPerunBl().getAttributesManagerBl().fillAttribute(sess, user, geantPersistentShadow);
