 ...
 */
public class urn_perun_entityless_attribute_def_def_namespace_maxUID extends EntitylessAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl perunSession, String key, Attribute attribute)
    ...
    try {
      ...
      if (minUID != null) {
        if (maxUID < minUID) {
          throw new WrongReferenceAttributeValueException(attribute, minUIDAttr, key, null, key, null,
              "Attribute value must be more than minUID. MinUID = " + minUID + ", and maxUID try to set = " + maxUID);
        }
      }
