...
public interface AuthzResolverImplApi {
   ...
   *
   * @param user
   * @return Map<String, Map < String, Map < Integer, List < Group>>>> complementary objects with associated authorized
   * groups
   */
   ...
   */
  boolean groupMatchesUserRolesFilter(PerunSession sess, User user, Group group, List<String> roles,
