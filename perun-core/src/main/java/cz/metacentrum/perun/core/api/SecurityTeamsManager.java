...
public interface SecurityTeamsManager {
   ...
   */
  void addUserToBlacklist(PerunSession perunSession, SecurityTeam securityTeam, User user, String description)
   ...
   * @throws SecurityTeamNotExistsException
   */
  List<User> getBlacklist(PerunSession perunSession, SecurityTeam securityTeam)
      throws PrivilegeException, SecurityTeamNotExistsException;
   ...
   */
  List<User> getBlacklist(PerunSession perunSession, Facility facility)
   ...
   * @throws SecurityTeamNotExistsException
   */
  List<Pair<User, String>> getBlacklistWithDescription(PerunSession perunSession, SecurityTeam securityTeam)
      throws PrivilegeException, SecurityTeamNotExistsException;
