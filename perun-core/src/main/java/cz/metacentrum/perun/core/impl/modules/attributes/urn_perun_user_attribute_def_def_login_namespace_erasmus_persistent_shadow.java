...
/**
 * Class for checking logins uniqueness in the namespace and filling erasmus-persistent id. It is only storage! Use
 * module login erasmus_persistent for access the value.
 */
public class urn_perun_user_attribute_def_def_login_namespace_erasmus_persistent_shadow
  ...
  private static final String attrNameErasmus = "login-namespace:erasmus-persistent-shadow";

  private static final String CONFIG_EXT_SOURCE_NAME_ERASMUS = "extSourceNameErasmus";
  private static final String CONFIG_DOMAIN_NAME_ERASMUS = "domainNameErasmus";
