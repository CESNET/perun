...
public class urn_perun_user_attribute_def_virt_organizationsWithLoa extends UserVirtualAttributesModuleAbstract
  ...
  private void initializeMapOfExtSourceName() {
    mapOfExtSourcesNames.put("https://idp.upce.cz/idp/shibboleth",
        new Pair("Univerzita Pardubice", "University in Pardubice"));
    mapOfExtSourcesNames.put("https://idp.slu.cz/idp/shibboleth",
        new Pair("Univerzita v Opavě", "University in Opava"));
    mapOfExtSourcesNames.put("https://login.feld.cvut.cz/idp/shibboleth",
        new Pair("Fakulta elektrotechnická, České vysoké učení technické v Praze",
            "Faculty of Electrical Engineering, Czech Technical University In Prague"));
    mapOfExtSourcesNames.put("https://www.vutbr.cz/SSO/saml2/idp",
        new Pair("Vysoké učení technické v Brně", "Brno University of Technology"));
    mapOfExtSourcesNames.put("https://shibboleth.nkp.cz/idp/shibboleth",
        new Pair("Národní knihovna České republiky", "The National Library of the Czech Republic"));
    mapOfExtSourcesNames.put("https://idp2.civ.cvut.cz/idp/shibboleth",
        new Pair("České vysoké účení technické v Praze", "Czech Technical University In Prague"));
    mapOfExtSourcesNames.put("https://shibbo.tul.cz/idp/shibboleth",
        new Pair("Technická univerzita v Liberci", "Technical University of Liberec"));
    mapOfExtSourcesNames.put("https://idp.mendelu.cz/idp/shibboleth",
        new Pair("Mendlova univerzita v Brně", "Mendel University in Brno"));
    mapOfExtSourcesNames.put("https://cas.cuni.cz/idp/shibboleth",
        new Pair("Univerzita Karlova v Praze", "Charles University in Prague"));
    mapOfExtSourcesNames.put("https://wsso.vscht.cz/idp/shibboleth",
        new Pair("Vysoká škola chemicko-technická v Praze", "Institute of Chemical Technology Prague"));
    mapOfExtSourcesNames.put("https://idp.vsb.cz/idp/shibboleth",
        new Pair("VŠB - Technická univerzita Ostrava", "VSB – Technical University of Ostrava"));
    mapOfExtSourcesNames.put("https://whoami.cesnet.cz/idp/shibboleth",
        new Pair("CESNET, z. s. p. o.", "CESNET, a. l. e."));
    mapOfExtSourcesNames.put("https://helium.jcu.cz/idp/shibboleth",
        new Pair("Jihočeská univerzita v Českých Budějovicích", "University of South Bohemia"));
    mapOfExtSourcesNames.put("https://idp.ujep.cz/idp/shibboleth",
        new Pair("Univerzita Jana Evangelisty Purkyně v Ústí nad Labem",
            "Jan Evangelista Purkyne University in Usti nad Labem"));
    mapOfExtSourcesNames.put("https://idp.amu.cz/idp/shibboleth",
        new Pair("Akademie múzických umění v Praze", "Academy of Performing Arts in Prague"));
    mapOfExtSourcesNames.put("https://idp.lib.cas.cz/idp/shibboleth",
        new Pair("Knihovna AV ČR, v. v. i.", "Academy of Sciences Library"));
    mapOfExtSourcesNames.put("https://shibboleth.mzk.cz/simplesaml/metadata.xml",
        new Pair("Moravská zemská knihovna", "Moravian  Library"));
    mapOfExtSourcesNames.put("https://idp2.ics.muni.cz/idp/shibboleth",
        new Pair("Masarykova univerzita", "Masaryk University"));
    mapOfExtSourcesNames.put("https://idp.upol.cz/idp/shibboleth",
        new Pair("Univerzita Palackého v Olomouci", "Palacky University, Olomouc"));
    mapOfExtSourcesNames.put("https://idp.fnplzen.cz/idp/shibboleth", new Pair("FN Plzeň", "FN Plzen"));
    mapOfExtSourcesNames.put("https://id.vse.cz/idp/shibboleth",
        new Pair("Vysoká škola ekonomická v Praze", "University of Economics, Prague"));
    mapOfExtSourcesNames.put("https://shib.zcu.cz/idp/shibboleth",
        new Pair("Západočeská univerzita v Plzni", "University of West Bohemia"));
    mapOfExtSourcesNames.put("https://idptoo.osu.cz/simplesaml/saml2/idp/metadata.php",
        new Pair("Ostravská Univerzita v Ostravě", "University of Ostrava"));
