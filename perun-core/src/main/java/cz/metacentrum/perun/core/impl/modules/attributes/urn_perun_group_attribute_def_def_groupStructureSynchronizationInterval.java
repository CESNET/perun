...
public class urn_perun_group_attribute_def_def_groupStructureSynchronizationInterval
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Group group, Attribute attribute)
    ...
    try {
      ...
      throw new ConsistencyErrorException(
          "Attribute " + GroupsManager.GROUP_STRUCTURE_SYNCHRO_TIMES_ATTRNAME + " is supposed to exist", exc);
    }
  }
