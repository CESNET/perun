 ...
 */
public class urn_perun_user_attribute_def_def_userCertDNs extends UserAttributesModuleAbstract
  ...
  public void changedAttributeHook(PerunSessionImpl session, User user, Attribute attribute)
    ...
    try {
      userPreferredCertDN = session.getPerunBl().getAttributesManagerBl()
          .getAttribute(session, user, AttributesManager.NS_USER_ATTR_DEF + ":userPreferredCertDN");
