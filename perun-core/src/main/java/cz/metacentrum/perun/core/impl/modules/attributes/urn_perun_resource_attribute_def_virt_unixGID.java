 ...
 */
public class urn_perun_resource_attribute_def_virt_unixGID extends ResourceVirtualAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Resource resource, Attribute attribute)
    ...
    try {
      gidAttribute = sess.getPerunBl().getAttributesManagerBl()
          .getAttribute(sess, resource, A_R_unixGID_namespace + unixGIDNamespaceAttribute.getValue());
  ...
  public Attribute getAttributeValue(PerunSessionImpl sess, Resource resource,
    ...
    try {
      Attribute gidAttribute = sess.getPerunBl().getAttributesManagerBl()
          .getAttribute(sess, resource, A_R_unixGID_namespace + unixGIDNamespaceAttribute.getValue());
  ...
  public boolean removeAttributeValue(PerunSessionImpl sess, Resource resource, AttributeDefinition attribute)
    ...
    try {
      AttributeDefinition groupGidAttribute = sess.getPerunBl().getAttributesManagerBl()
          .getAttributeDefinition(sess, A_R_unixGID_namespace + unixGIDNamespaceAttribute.getValue());
