 ...
 */
public class urn_perun_facility_attribute_def_def_quotaEnabled extends FacilityAttributesModuleAbstract
  ...
  public void checkAttributeSyntax(PerunSessionImpl perunSession, Facility facility, Attribute attribute)
    ...
    if (quotaEnabled > 1 || quotaEnabled < 0) {
      throw new WrongAttributeValueException(attribute, facility,
          "Attribute has only two possible options for quota: 0 - means not enabled, 1 - means enabled.");
    }
