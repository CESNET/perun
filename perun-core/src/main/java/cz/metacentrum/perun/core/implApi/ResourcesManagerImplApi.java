...
public interface ResourcesManagerImplApi {
   ...
   */
  void assignAutomaticGroupToResource(PerunSession perunSession, Group group, Resource resource, Group sourceGroup)
      throws GroupAlreadyAssignedException;
   ...
   * @throws GroupAlreadyAssignedException
   */
  void assignGroupToResource(PerunSession perunSession, Group group, Resource resource, boolean autoAssignSubgroups)
      throws GroupAlreadyAssignedException;
   ...
   */
  void assignGroupToResourceState(PerunSession perunSession, Group group, Resource resource,
  ...
  /**
   * Creates the resource. This methods sets ids and uuid to the given resource object but returns a new resource object
   * loaded from db.
   *
   * @param perunSession
   * @param vo
  ...
  /**
   * Gets list of direct user administrators of the Resource. 'Direct' means, there aren't included users, who are
  ...
  /**
   * Gets the current cause of failed group-resource assignment. Returns null if there is no such group-resource
   * assignment.
   *
   * @param sess     session
   * @param group    group
   ...
   * @throws InternalErrorException
   */
  GroupResourceStatus getGroupResourceStatus(PerunSession sess, Group group, Resource resource)
   ...
   */
  List<RichResource> getRichResourcesWithMemberAndAttribute(PerunSession perunSession, Member member,
   ...
   * @throws GroupNotDefinedOnResourceException if there is no such group-resource assignment
   */
  void setFailedGroupResourceAssignmentCause(PerunSession sess, Group group, Resource resource, String cause)
      throws GroupNotDefinedOnResourceException;
   ...
   * @throws InternalErrorException
   */
  void setGroupResourceStatus(PerunSession sess, Group group, Resource resource, GroupResourceStatus status)
      throws GroupNotDefinedOnResourceException;
