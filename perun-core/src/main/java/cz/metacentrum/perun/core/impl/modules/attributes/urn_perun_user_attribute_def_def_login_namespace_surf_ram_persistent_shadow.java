...
/**
 * Class for checking logins uniqueness in the namespace and filling surf-ram-persistent id. It is only storage! Use
 * module login surf_ram_persistent for access the value.
 */
public class urn_perun_user_attribute_def_def_login_namespace_surf_ram_persistent_shadow
  ...
  private static final String attrNameSurfRam = "login-namespace:surf-ram-persistent-shadow";

  private static final String CONFIG_EXT_SOURCE_NAME_SURF_RAM = "extSourceNameSurfRam";
  private static final String CONFIG_DOMAIN_NAME_SURF_RAM = "domainNameSurfRam";
