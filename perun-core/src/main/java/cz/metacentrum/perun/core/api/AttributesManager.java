...
public interface AttributesManager {
  ...
  String[] ENTITY_TYPES =
    {"facility", "resource", "member_resource", "member_group", "member", "user_facility", "user", "vo", "group",
        "host", "group_resource", "entityless", "ues"};
   ...
   */
  void checkAttributesSemantics(PerunSession sess, Resource resource, Group group, List<Attribute> attributes)
      throws PrivilegeException, AttributeNotExistsException, ResourceNotExistsException, GroupNotExistsException,
      WrongAttributeAssignmentException, GroupResourceMismatchException, WrongReferenceAttributeValueException;
   ...
   */
  void checkAttributesSyntax(PerunSession sess, Resource resource, Group group, List<Attribute> attributes)
      throws PrivilegeException, AttributeNotExistsException, ResourceNotExistsException, GroupNotExistsException,
   ...
   */
  void convertAttributeToNonunique(PerunSession session, int attrId)
      throws PrivilegeException, AttributeNotExistsException, AttributeNotMarkedUniqueException;

  /**
   * Converts attribute to unique. Marks the attribute definition as unique, and copies all values to a special table
   * with unique constraint that ensures that all values remain unique. Values of type ArrayList and LinkedHashMap are
   * splitted into multiple values, thus each of the subvalues must be unique.
   * <p>
   * Entityless attributes cannot be converted to unique, only attributes attached to PerunBeans or pairs of
   * PerunBeans.
   *
   * @param session perun session
   * @param attrId  attribute id
   ...
   * WrongAttributeValueException are thrown if same attribute can't be set correctly.
   * <p>
   * PRIVILEGE: Only for PerunAdmin.
   */
  ...
  /**
   * This method tries to fill value of the member-resource attribute. This value is automatically generated, but not
   * all attributes can be filled this way.
   * <p>
   * PRIVILEGE: Fill attribute only when principal has access to write on it.
   *
   * @param sess      perun session
   ...
   * @param attribute attribute to fill. If attribute already have set value, this value won't be overwritten. This
   *                  means the attribute value must be empty otherwise this method won't fill it.
   * @return attribute which MAY have filled value
   * @throws InternalErrorException     if an exception raise in concrete implementation, the exception is wrapped in
   *                                    InternalErrorException
   * @throws PrivilegeException         if privileges are not given
   * @throws ResourceNotExistsException if the resource doesn't exists in underlying data source
   * @throws MemberNotExistsException   if member doesn't exists in underlying data source or he doesn't have access to
   *                                    this resource
   */
  ...
  /**
   * This method tries to fill value of the member attribute. This value is automatically generated, but not all
   * attributes can be filled this way.
   * <p>
   * PRIVILEGE: Fill attribute only when principal has access to write on it.
   *
  ...
  /**
   * This method tries to fill value of the user-facility attribute. This value is automatically generated, but not all
   * attributes can be filled this way.
   * <p>
   * PRIVILEGE: Fill attribute only when principal has access to write on it.
   *
   ...
   * @throws PrivilegeException          if privileges are not given
   * @throws FacilityNotExistsException  if the facility doesn't exists in underlying data source
   * @throws UserNotExistsException      if user doesn't exists in underlying data source or he doesn't have access to
   *                                     this facility
   * @throws AttributeNotExistsException if the attribute doesn't exists in underlying data source
   */
  ...
  /**
   * This method tries to fill value of the user attribute. This value is automatically generated, but not all
   * attributes can be filled this way.
   * <p>
   * PRIVILEGE: Fill attribute only when principal has access to write on it.
   *
  ...
  Attribute fillAttribute(PerunSession sess, User user, Attribute attribute)
      throws PrivilegeException, UserNotExistsException, AttributeNotExistsException, WrongAttributeAssignmentException;

  /**
   * This method tries to fill group-resource attribute. This value is automatically generated, but not all attributes
  ...
  /**
   * This method tries to fill host attribute. This value is automatically generated, but not all attributes can be
   * filled this way.
   * <p>
   * PRIVILEGE: Fill attribute only when principal has access to write on it.
   *
  ...
  /**
   * This method tries to fill group attribute. This value is automatically generated, but not all attributes can be
   * filled this way.
   * <p>
   * PRIVILEGE: Fill attribute only when principal has access to write on it.
   *
  ...
  /**
   * This method tries to fill value of the user, member, member-resource and user-facility attributes. This value is
   ...
   */
  List<Attribute> fillAttributes(PerunSession sess, Resource resource, Group group, List<Attribute> attributes)
   ...
   */
  List<Attribute> fillAttributes(PerunSession sess, Group group, List<Attribute> attributes)
  ...
  /**
   * Get all <b>non-empty</b> attributes associated with the facility. PRIVILEGE: Get only those attributes the
  ...
  /**
   * Get all <b>non-empty</b> attributes associated with the vo. PRIVILEGE: Get only those attributes the principal has
   * access to.
   *
   * @param sess perun session
  ...
  /**
   * Get all <b>non-empty</b> attributes associated with the group. PRIVILEGE: Get only those attributes the principal
   * has access to.
   *
   * @param sess  perun session
  ...
  /**
   * Get all <b>non-empty</b> attributes associated with the resource. PRIVILEGE: Get only those attributes the
   * principal has access to.
   *
   * @param sess     perun session
  ...
  /**
   * Get all <b>non-empty</b> attributes associated with the member on the resource. PRIVILEGE: Get only those
   * attributes the principal has access to.
   *
   * @param sess     perun session
   ...
   * true, gets also all <b>non-empty</b> user, user-facility and member attributes. PRIVILEGE: Get only those
   * attributes the principal has access to.
   *
   * @param sess                   perun session
   * @param member                 to get the attributes from
   ...
   *                               get from member and facility is get from resource)
   * @return list of attributes
   * @throws ResourceNotExistsException      if the resource doesn't exists in underlying data source
   * @throws InternalErrorException          if an exception raise in concrete implementation, the exception is wrapped
   *                                         in InternalErrorException
  ...
  /**
   * Get all <b>non-empty</b> attributes associated with the member in the group. PRIVILEGE: Get only those attributes
  ...
  /**
   * Get all <b>non-empty</b> attributes associated with the group and resource. Virtual attribute too.
   * <p>
   * PRIVILEGE: Get only those attributes the principal has access to.
   * <p>
   * If workWithGroupAttributes is true, return also all group attributes in list of attrNames (with virtual attributes
   * too).
   *
   * @param sess                    perun session
   * @param resource                to get the attributes from
  ...
  /**
   * Get all attributes associated with the member which have name in list attrNames (empty too). Virtual attribute
   * too.
   * <p>
   * PRIVILEGE: Get only those attributes the principal has access to.
   *
  ...
  /**
   * Get all attributes associated with the host which have name in list attrNames (empty too). Empty list attrNames
   * will return no attributes.
   * <p>
   * PRIVILEGE: Get only those attributes the principal has access to.
   *
   * @param sess      perun session
  ...
  List<Attribute> getAttributes(PerunSession sess, Host host, List<String> attrNames)
      throws InternalErrorException, HostNotExistsException;
  ...
  List<Attribute> getRequiredAttributes(PerunSession sess, Facility facility)
      throws PrivilegeException, InternalErrorException, FacilityNotExistsException;
  */
  ...
  /**
   * Returns all attributes with not-null value which fits the attributeDefinition. Can't proscess core or virtual
   * attributes.
   * <p>
   ...
   * of entities or possible combination of entities. For Example: If entities are "member, user, resource" then return
   ...
   * @throws PrivilegeException     insufficient permissions
   */
  GraphDTO getModulesDependenciesGraph(PerunSession session, GraphTextFormat format, String attributeName)
      throws PrivilegeException, AttributeNotExistsException;
  ...
  /**
   * Get member, member-group attributes which are required by services which are relater to this member. If
   * workWithUserAttributes = true, then user attributes are returned too.
   * <p>
   * PRIVILEGE: Get only those required attributes principal has access to.
   *
   * @param sess                   perun session
   ...
   * @return list of member, member-group and optionally user attributes which are required by services which are
   ...
   * @throws ServiceNotExistsException  if the service doesn't exists in underlying data source
   */
  List<Attribute> getRequiredAttributes(PerunSession sess, List<Service> services, Facility facility)
      throws FacilityNotExistsException, ServiceNotExistsException;
  ...
  /**
   * Get member, member-resource and member-group attributes required by the specified service. if
   ...
   * list of members. If workWithUserAttributes is false return only member-resource attributes.
   *
   * @param sess                   perun session
  ...
  List<Attribute> getRequiredAttributes(PerunSession sess, Service service, Member member, Group group)
      throws ServiceNotExistsException, MemberNotExistsException, GroupNotExistsException, MemberGroupMismatchException;
  ...
  /**
   * Get group-resource attributes required for the service. !!WARNING THIS IS VERY TIME-CONSUMING METHOD. DON'T USE IT
   * IN BATCH!!
   * <p>
   * PRIVILEGE: Get only those required attributes principal has access to.
   *
  ...
  /**
   * Get member-resource attributes which are required by services which are defined on "resourceToGetServicesFrom"
   * resource.
   * <p>
   * PRIVILEGE: Get only those required attributes principal has access to.
   *
  ...
  /**
   * Get member-group attributes which are required by services defined on specified resource Services are known from
   * the resourceToGetServicesFrom.
   * <p>
   * PRIVILEGE: Get only those required attributes principal has access to.
   *
   * @param sess                      perun session
  ...
  /**
   * Get member-group attributes which are required by services defined on specified resource and if
   * workWithUserAttributes is true also user and member attributes. Services are known from the
  ...
  /**
   * Get group-resource attributes which are required by services defined on specified resource Get also group
   * attributes, if workWithGroupAttributes is true.
   * <p>
   * PRIVILEGE: Get only those required attributes principal has access to.
   *
   * @param resourceToGetServicesFrom getRequired attributes from services which are assigned on this resource
  ...
  /**
   * Get member-group and member-resource attributes required by the services specified on resource Get also user,
   * member, user-facility attributes, if workWithUserAttributes is true.
   * <p>
   * PRIVILEGE: Get only those required attributes principal has access to.
   * <p>
   * Group and group-resource attributes are not supported in this context !!
   ...
   * @return List of required attributes (member-group, member-resource). Return also user, member, user-facility
   * attributes, if workWithUserAttributes is true.
   */
  List<Attribute> getResourceRequiredAttributes(PerunSession sess, Resource resourceToGetServicesFrom,
   ...
   */
  void removeAllAttributes(PerunSession sess, Host host)
   ...
   */
  void removeAttribute(PerunSession sess, Resource resource, AttributeDefinition attribute)
  ...
  void removeAttribute(PerunSession sess, Resource resource, Group group, AttributeDefinition attribute)
      throws PrivilegeException, ResourceNotExistsException, GroupNotExistsException, AttributeNotExistsException,
      WrongAttributeAssignmentException, GroupResourceMismatchException, WrongAttributeValueException,
      WrongReferenceAttributeValueException;
   ...
   * @throws AttributeNotExistsException       if the attribute doesn't exists in underlying data source
   * @throws UserExtSourceNotExistsException   if the user external source doesn't exists in underlying data source
   * @throws WrongAttributeAssignmentException if attribute isn't user external source attribute or if it is core
   *                                           attribute
   */
  ...
  /**
   * Unset the group-resource attributes. If an attribute is core attribute, then the attribute isn't unset (it's
   ...
   * @param workWithGroupAttributes if true, remove also group attributes, if false, remove only group-resource
   *                                attributes
   * @throws InternalErrorException                if an exception raise in concrete implementation, the exception is
   *                                               wrapped in InternalErrorException
   * @throws PrivilegeException                    if privileges are not given
   ...
   * attribute isn't unset (It's skipped without any notification).
   * <p>
   * PRIVILEGE: Remove attributes only when principal has access to write on them.
   *
   * @param sess     perun session
   ...
   * attribute then the attribute isn't unset (It's skipped without any notification).
   * <p>
   ...
   * <p>
   * Batch version of removeAttribute. This method automatically skip all core attributes which can't be removed this
   * way. If workWithUserAttributes is true, unset also user attributes.
   *
   ...
   *
   * @throws AttributeNotExistsException if the any of attributes doesn't exists in underlying data source
   * @see cz.metacentrum.perun.core.api.AttributesManager#removeAttribute(PerunSession, Facility, User,
   * AttributeDefinition)
   */
   ...
   *
   * @throws AttributeNotExistsException if the any of attributes doesn't exists in underlying data source
   * @see cz.metacentrum.perun.core.api.AttributesManager#removeAttribute(PerunSession, UserExtSource,
   * AttributeDefinition)
   */
   ...
   * @throws AttributeNotExistsException           when there is no attribute definition with such id
   * @throws PrivilegeException                    insufficient permissions
   * @throws RoleNotSupportedException             when some of the AttributePolicyCollection does have a role which
   *                                               does not exist
   * @throws RoleObjectCombinationInvalidException when the combination role + RoleObject of any included policy isn't
   *                                               valid
   */
  ...
  void setAttributes(PerunSession sess, Resource resource, List<Attribute> attributes)
      throws PrivilegeException, ResourceNotExistsException, AttributeNotExistsException,
      WrongAttributeAssignmentException, WrongReferenceAttributeValueException, WrongAttributeValueException;
   ...
   * @throws MemberResourceMismatchException       if member and resource are not in the same VO
   *                                               <p>
   *                                               !!WARNING THIS IS VERY TIME-CONSUMING METHOD. DON'T USE IT IN
   *                                               BATCH!!
   */
  void setAttributes(PerunSession sess, Member member, Resource resource, List<Attribute> attributes,
                     boolean workWithUserAttributes)
  ...
  /**
   * Store the attributes associated with the member and group combination. If an attribute is core attribute then the
  ...
  /**
   * Store the attributes associated with the member and group combination. If an attribute is core attribute then the
   * attribute isn't stored (It's skipped without any notification). If workWithUserAttributes is true, the method
   ...
   * @throws PrivilegeException                    if privileges are not given
   * @throws MemberNotExistsException              if the member doesn't exists in the underlying data source
   * @throws UserNotExistsException                if the user (get from this member after workWithUserAttributes=true)
   *                                               doesn't exists in the underlying data source
   * @throws InternalErrorException                if an exception raise in concrete implementation, the exception is
   *                                               wrapped in InternalErrorException
   * @throws AttributeNotExistsException           if the attribute doesn't exists in the underlying data source
   * @throws WrongAttributeValueException          if the attribute value is illegal
   ...
   * @throws AttributeNotExistsException       if the attribute doesn't exists in the underlying data source
   * @throws WrongAttributeValueException      if the attribute value is illegal
   * @throws WrongAttributeAssignmentException if attribute is not one of user, member, user-facility, member-group,
   *                                           member-resource
   */
   ...
   *
   * @throws PrivilegeException                    if privileges are not given
   * @throws InternalErrorException                if an exception raises in concrete implementation, the exception is
   *                                               wrapped in InternalErrorException
  ...
  void setAttributes(PerunSession sess, Resource resource, Group group, List<Attribute> attributes)
      throws PrivilegeException, ResourceNotExistsException, GroupNotExistsException, WrongAttributeValueException,
      WrongAttributeAssignmentException, GroupResourceMismatchException, AttributeNotExistsException,
      WrongReferenceAttributeValueException;

  /**
   * Store the attributes associated with group and resource if workWithUserAttributes is true then also from group
   * itself. If an attribute is core attribute then the attribute isn't stored (It's skipped without any notification).
   * <p>
   * PRIVILEGE: Principal need to have access to all attributes which he wants to set.
   *
   * @param sess                    perun session
   ...
   * @throws PrivilegeException                    if privileges are not given
   * @throws GroupNotExistsException               if the group doesn't exists in the underlying data source
   * @throws ResourceNotExistsException            if the resource (get from this member after
   *                                               workWithUserAttributes=true) doesn't exists in the underlying data
   *                                               source
   * @throws InternalErrorException                if an exception raise in concrete implementation, the exception is
   *                                               wrapped in InternalErrorException
   * @throws AttributeNotExistsException           if the attribute doesn't exists in the underlying data source
   ...
   *                                               wrapped in InternalErrorException
   * @throws PrivilegeException                    if privileges are not given
   * @throws UserExtSourceNotExistsException       if the user external source doesn't exists in the underlying data
   *                                               source
   * @throws AttributeNotExistsException           if the attribute doesn't exists in the underlying data source
   * @throws WrongAttributeValueException          if the attribute value is illegal
   * @throws WrongAttributeAssignmentException     if attribute is not user external source attribute
  ...
  /**
   * Updates AttributeDefinition. PRIVILEGE: only PerunAdmin
   *
