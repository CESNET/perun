...
/**
 * Checks that value of m365AllowedLicensesPriorities is valid: - does not contain a null key - when a change is made,
 * there is no m365LicenseGroup attribute under the same facility containing a license that no longer exists in this
 * map
 *
    ...
    for (Resource res : resources) {
      if (fetchResourceLicense(perunSession, res) != null) {
        throw new WrongReferenceAttributeValueException("The attribute '" + attribute +
                            "' is being cleared, but there is still a resource in this " +
