 ...
 */
public class urn_perun_member_group_attribute_def_virt_o365SendOnBehalf
  ...
  private static final String A_G_o365SendOnBehalfGroups =
      AttributesManager.NS_GROUP_ATTR_DEF + ":o365SendOnBehalfGroups";
  ...
  public Attribute getAttributeValue(PerunSessionImpl sess, Member member, Group group, AttributeDefinition attribute) {
    boolean value = sess.getPerunBl().getModulesUtilsBl()
        .getSendRightFromAttributes(sess, member, group, A_MG_o365SendOnBehalf, A_G_o365SendOnBehalfGroups);
