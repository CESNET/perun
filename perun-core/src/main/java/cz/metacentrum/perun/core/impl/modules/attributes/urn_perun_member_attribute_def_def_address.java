 ...
 */
public class urn_perun_member_attribute_def_def_address extends MemberAttributesModuleAbstract
  ...
  public void changedAttributeHook(PerunSessionImpl session, Member member, Attribute attribute)
    ...
    if (attribute.getValue() != null) {
      ...
      try {
        ...
        throw new WrongReferenceAttributeValueException(attribute, userAddress,
            "Mismatch in checking of member address and user address (different checking rules)", ex);
      }
    }
  }
