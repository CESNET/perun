...
public class TasksManagerEntry implements TasksManager {
  ...
  @Override
  public List<FacilityState> getAllFacilitiesStatesForVo(PerunSession session, Vo vo)
  ...
  @Override
  public FacilityState getFacilityState(PerunSession session, Facility facility)
      throws PrivilegeException, FacilityNotExistsException {
    Utils.notNull(session, "session");
  ...
  @Override
  public List<ResourceState> getResourcesState(PerunSession session, Vo vo)
  ...
  public Task getTask(PerunSession perunSession, Service service, Facility facility)
    ...
    //Authorization
    if (!AuthzResolver.authorizedInternal(perunSession, "getTask_Service_Facility_policy",
  ...
  @Override
  public List<TaskResult> getTaskResultsByTaskAndDestination(PerunSession session, int taskId, int destinationId)
      throws DestinationNotExistsException, FacilityNotExistsException, PrivilegeException {
    Utils.notNull(session, "session");
  ...
  @Override
  public boolean isThereSuchTask(PerunSession session, Service service, Facility facility)
      throws PrivilegeException, FacilityNotExistsException, ServiceNotExistsException {
    Utils.notNull(session, "session");
    perun.getFacilitiesManagerBl().checkFacilityExists(session, facility);
    ...
    //Authorization
    if (!AuthzResolver.authorizedInternal(session, "isThereSuchTask_Service_Facility_policy",
        Arrays.asList(service, facility))) {
