 ...
 */
public class urn_perun_facility_attribute_def_virt_minUID extends FacilityVirtualAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Facility facility, Attribute attribute)
    ...
    try {
      ...
      sess.getPerunBl().getAttributesManagerBl()
          .checkAttributeSemantics(sess, uidNamespaceAttribute.valueAsString(), namespaceMinUidAttribute);
  ...
  public boolean setAttributeValue(PerunSessionImpl sess, Facility facility, Attribute attribute)
    ...
    Attribute namespaceMinUidAttribute = getNamespaceMinUidAttribute(sess, (String) uidNamespaceAttribute.getValue());
    if (!(attribute.getValue() == null ? namespaceMinUidAttribute.getValue() == null :
        attribute.getValue().equals(namespaceMinUidAttribute.getValue()))) {
