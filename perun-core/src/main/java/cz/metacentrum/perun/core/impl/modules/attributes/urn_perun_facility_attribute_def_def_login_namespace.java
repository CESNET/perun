 ...
 */
public class urn_perun_facility_attribute_def_def_login_namespace extends FacilityAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl session, Facility facility, Attribute attribute)
    ...
    try {
      session.getPerunBl().getAttributesManagerBl()
          .getAttributeDefinition(session, userFacilityLoginNamespaceAttributeName);
    } catch (AttributeNotExistsException e) {
      throw new WrongReferenceAttributeValueException(attribute, null, facility, null,
          "Attribute " + userFacilityLoginNamespaceAttributeName + " doesn't exists");
    }
  }
