 ...
 */
public class urn_perun_facility_attribute_def_virt_maxUID extends FacilityVirtualAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Facility facility, Attribute attribute)
    ...
    try {
      ...
      sess.getPerunBl().getAttributesManagerBl()
          .checkAttributeSemantics(sess, uidNamespaceAttribute.valueAsString(), namespaceMaxUidAttribute);
  ...
  public boolean setAttributeValue(PerunSessionImpl sess, Facility facility, Attribute attribute)
    ...
    Attribute namespaceMaxUidAttribute = getNamespaceMaxUidAttribute(sess, (String) uidNamespaceAttribute.getValue());
    if (!(attribute.getValue() == null ? namespaceMaxUidAttribute.getValue() == null :
        attribute.getValue().equals(namespaceMaxUidAttribute.getValue()))) {
