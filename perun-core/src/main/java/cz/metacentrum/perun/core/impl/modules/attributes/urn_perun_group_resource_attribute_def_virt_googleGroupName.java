 ...
 */
public class urn_perun_group_resource_attribute_def_virt_googleGroupName
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Group group, Resource resource, Attribute attribute)
    ...
    Attribute googleGroupNameNamespaceAttribute =
        sess.getPerunBl().getModulesUtilsBl().getGoogleGroupNameNamespaceAttributeWithNotNullValue(sess, resource);
    ...
    try {
      groupNameAttribute = sess.getPerunBl().getAttributesManagerBl()
          .getAttribute(sess, group, AttributesManager.NS_GROUP_ATTR_DEF + ":googleGroupName-namespace:" + namespace);
  ...
  public Attribute fillAttribute(PerunSessionImpl sess, Group group, Resource resource,
    ...
    Attribute googleGroupNameNamespaceAttribute;
    try {
      googleGroupNameNamespaceAttribute =
          sess.getPerunBl().getModulesUtilsBl().getGoogleGroupNameNamespaceAttributeWithNotNullValue(sess, resource);
    ...
    try {
      ...
      Attribute groupNameAttribute = new Attribute(sess.getPerunBl().getAttributesManagerBl()
          .getAttributeDefinition(sess,
              AttributesManager.NS_GROUP_ATTR_DEF + ":googleGroupName-namespace:" + namespace));
      groupNameAttribute.setValue(attribute.getValue());
