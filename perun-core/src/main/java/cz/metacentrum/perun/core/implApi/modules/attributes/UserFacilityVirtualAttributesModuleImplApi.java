...
public interface UserFacilityVirtualAttributesModuleImplApi
   ...
   */
  Attribute getAttributeValue(PerunSessionImpl perunSession, User user, Facility facility,
   ...
   *                                implementation, the exception is wrapped in InternalErrorException
   */
  boolean setAttributeValue(PerunSessionImpl perunSession, User user, Facility facility, Attribute attribute)
   ...
   */
  boolean removeAttributeValue(PerunSessionImpl perunSession, User user, Facility facility,
                               AttributeDefinition attribute);
}
