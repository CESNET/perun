...
public class urn_perun_user_attribute_def_def_elixirBonaFideStatus extends UserAttributesModuleAbstract
  ...
  public Attribute fillAttribute(PerunSessionImpl sess, User user, AttributeDefinition attributeDefinition) {
    ...
    try {
      Attribute statusAttr =
          sess.getPerunBl().getAttributesManagerBl().getAttribute(sess, user, A_U_D_userBonaFideStatusRems);
    ...
    try {
      Attribute affiliationsAttr =
          sess.getPerunBl().getAttributesManagerBl().getAttribute(sess, user, A_U_V_userAffiliations);
    ...
    try {
      Attribute publicationsAttr =
          sess.getPerunBl().getAttributesManagerBl().getAttribute(sess, user, A_U_D_userPublications);
