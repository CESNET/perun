 ...
 */
public class urn_perun_entityless_attribute_def_def_namespace_uid_policy extends EntitylessAttributesModuleAbstract
  ...
  public void checkAttributeSyntax(PerunSessionImpl perunSession, String key, Attribute attribute)
    ...
    if (!(RECYCLE_POLICY.equals(attribute.getValue()) || INCREMENT_POLICY.equals(attribute.getValue()))) {
      throw new WrongAttributeValueException(attribute, key,
          "Posible values for this attribute are " + RECYCLE_POLICY + " or " + INCREMENT_POLICY);
    }
  }
