 ...
 */
public abstract class AbstractApplicationAutoRejectMessagesModule<T extends PerunBean> extends AttributesModuleAbstract
  ...
  public void checkAttributeSyntax(PerunSessionImpl perunSession, T entity, Attribute attribute)
  ...
  private boolean isInvalidKey(String key) {
    return !IGNORED_BY_ADMIN_PATTERN.matcher(key).matches() && !MAIL_VERIFICATION_PATTERN.matcher(key).matches();
  }
}
