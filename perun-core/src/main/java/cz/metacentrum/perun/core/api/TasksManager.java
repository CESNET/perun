...
public interface TasksManager {
   ...
   */
  List<FacilityState> getAllFacilitiesStatesForVo(PerunSession session, Vo vo)
   ...
   * @throws InternalErrorException
   */
  FacilityState getFacilityState(PerunSession session, Facility facility)
      throws PrivilegeException, FacilityNotExistsException;
   ...
   * @throws PrivilegeException
   */
  List<TaskResult> getTaskResultsByTaskAndDestination(PerunSession session, int taskId, int destinationId)
   ...
   * @throws ServiceNotExistsException
   */
  boolean isThereSuchTask(PerunSession session, Service service, Facility facility)
      throws PrivilegeException, FacilityNotExistsException, ServiceNotExistsException;
