 ...
 * @date 23.11.2011
 */
public class urn_perun_resource_attribute_def_def_accountExpirationTime extends ResourceAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl perunSession, Resource resource, Attribute attribute)
    ...
    try {
      ...
      facilityAccExpTimeAttribute =
          perunSession.getPerunBl().getAttributesManagerBl().getAttribute(perunSession, fac, A_F_accountExpirationTime);
    ...
    if (facilityAccExpTime == null) {
      throw new WrongReferenceAttributeValueException(attribute, facilityAccExpTimeAttribute, resource, null, fac, null,
          "cant determine attribute value on underlying facility");
    }
    if (facilityAccExpTime < accExpTime) {
      throw new WrongReferenceAttributeValueException(attribute, facilityAccExpTimeAttribute, resource, null, fac, null,
          "value can be higher than same facility attribute");
    }
  }
