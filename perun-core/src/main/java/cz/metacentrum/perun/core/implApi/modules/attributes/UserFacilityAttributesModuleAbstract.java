...
/**
 * Abstract class for Facility User Attributes modules. Implements methods for modules to perform default function. In
 * the function that the method in the module does nothing, it is not necessary to implement it, simply extend this
 * abstract class.
 *
 * @author Michal Stava <stavamichal@gmail.com>
 */
public abstract class UserFacilityAttributesModuleAbstract extends AttributesModuleAbstract
