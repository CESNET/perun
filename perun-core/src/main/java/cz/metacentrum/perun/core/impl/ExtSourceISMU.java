...
public class ExtSourceISMU extends ExtSourceImpl implements ExtSourceSimpleApi {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ExtSourceISMU.class);
  ...
  protected List<Map<String, String>> querySource(String query, String searchString, int maxResults) {
    ...
    try {
      ...
      while ((line = reader.readLine()) != null) {
        ...
        // entries[3] contains name of the user, so parse it to get titleBefore, firstName, lastName and titleAfter
        // in separate fields
