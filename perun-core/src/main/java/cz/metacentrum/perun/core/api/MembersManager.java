...
public interface MembersManager {
   ...
   */
  String
      MEMBERSHIP_EXPIRATION_RULES_ATTRIBUTE_NAME = AttributesManager.NS_VO_ATTR_DEF + ":" + "membershipExpirationRules";

  /**
   * Attribute which contains member's expiration
   */
  String MEMBERSHIP_EXPIRATION_ATTRIBUTE_NAME = AttributesManager.NS_MEMBER_ATTR_DEF + ":membershipExpiration";
   ...
   */
  void addMemberCandidates(PerunSession sess, Vo vo, List<MemberCandidate> candidates)
   ...
   * @throws VoNotExistsException                  vo does not exist
   */
  void addMemberCandidates(PerunSession sess, Vo vo, List<MemberCandidate> candidates, Group group)
   ...
   */
  boolean canBeMemberWithReason(PerunSession sess, Vo vo, User user, String loa)
   ...
   * validityTo (set to never if null).
   *
   * @param session
   ...
   */
  void copySponsoredMembers(PerunSession session, List<Member> sponsored, User copyFrom, User copyTo,
   ...
   */
  Member createMember(PerunSession sess, Vo vo, String extSourceName, String extSourceType, String login,
                      Candidate candidate)
   ...
   * @throws GroupNotExistsException
   */
  Member createMember(PerunSession sess, Vo vo, String extSourceName, String extSourceType, int extSourceLoa,
  ...
  /**
   * Creates a new member from candidate which is prepared for creating specific User In list specificUserOwners can't
   * be specific user, only normal users and sponsored users are allowed.
   * <strong>This method runs WITHOUT synchronization. If validation is needed, need to call concrete validateMember
   * method (validateMemberAsync recommended).</strong>
   *
   * @param sess
   ...
   * @throws GroupNotExistsException
   */
  Member createSpecificMember(PerunSession sess, Vo vo, Candidate candidate, List<User> specificUserOwners,
  ...
  /**
   * Creates a new member from candidate which is prepared for creating specificUser In list specificUserOwners can't be
   * specific user, only normal users and sponsored users are allowed.
   * <p>
   * Also add this member to groups in list.
   *
   * <strong>This method runs WITHOUT synchronization. If validation is needed, need to call concrete validateMember
   ...
   */
  RichMember createSponsoredMember(PerunSession session, SponsoredUserData data, Vo vo, User sponsor,
  ...
  List<Map<String, String>> createSponsoredMembersFromCSV(PerunSession sess, Vo vo, String namespace, List<String> data,
                                                          ...
                                                          boolean sendActivationLink, String language, String url,
                                                          List<Group> groups) throws PrivilegeException;
   ...
   * @throws MemberLifecycleAlteringForbiddenException if some member comes from hierarchical member vo and cannot be
   ...
   * @throws PrivilegeException
   * @throws MemberAlreadyRemovedException
   * @throws MemberLifecycleAlteringForbiddenException if member comes from hierarchical member vo and cannot be altered
   *                                                   in parent vo
   */
   ...
   * @throws PrivilegeException     if not REGISTRAR or VOADMIN
   */
  String extendExpirationForSponsoredMember(PerunSession session, Member sponsored, User sponsor)
   ...
   * @throws ExtendMembershipException
   */
  void extendMembership(PerunSession sess, Member member)
      throws PrivilegeException, MemberNotExistsException, ExtendMembershipException;

  /**
   * Return list of richMembers for specific vo by the searchString with attrs specific for list of attrsNames. If
   ...
   */
  List<RichMember> findCompleteRichMembers(PerunSession sess, Vo vo, List<String> attrsNames, String searchString,
                                           boolean onlySponsored) throws PrivilegeException, VoNotExistsException;

  /**
   * Return list of richMembers for specific vo by the searchString with attrs specific for list of attrsNames and who
   * have only status which is contain in list of statuses. If attrsNames is empty or null return all attributes for
   ...
   * @throws ParentGroupNotExistsException
   */
  List<RichMember> findCompleteRichMembers(PerunSession sess, Vo vo, List<String> attrsNames,
                                           List<String> allowedStatuses, String searchString)
      throws PrivilegeException, VoNotExistsException;

  /**
   * Return list of richMembers from Perun by searchString with attrs specific for list of attrsNames and who have only
   ...
   * @throws PrivilegeException
   */
  List<RichMember> findCompleteRichMembers(PerunSession sess, List<String> attrsNames, List<String> allowedStatuses,
                                           String searchString) throws PrivilegeException;

  /**
   * Return list of richMembers for specific group by the searchString with attrs specific for list of attrsNames. If
   * attrsNames is empty or null return all attributes for specific richMembers.
   * <p>
   ...
   * @throws ParentGroupNotExistsException
   */
  List<RichMember> findCompleteRichMembers(PerunSession sess, Group group, List<String> attrsNames, String searchString,
                                           boolean lookingInParentGroup)
      throws PrivilegeException, GroupNotExistsException, ParentGroupNotExistsException;

  /**
   * Return list of richMembers for specific group by the searchString with attrs specific for list of attrsNames and
   * who have only status which is contain in lists of statuses. If attrsNames is empty or null return all attributes
   * for specific richMembers. If listOfStatuses or listOfGroupStatuses is empty or null, return all possible statuses.
   * <p>
   * If lookingInParentGroup is true, find all these richMembers only for parentGroup of this group. If this group is
   * top level group, so find richMembers from members group.
   *
   ...
   * @throws ParentGroupNotExistsException
   */
  List<RichMember> findCompleteRichMembers(PerunSession sess, Group group, List<String> attrsNames,
   ...
   * @throws PrivilegeException
   */
  List<RichMember> findRichMembersInVo(PerunSession sess, Vo vo, String searchString)
      throws PrivilegeException, VoNotExistsException;
  ...
  /**
   * Return list of rich with attributes members by the searchString under parent group of defined Group. Search is done
  ...
  /**
   * Return list of rich members with attributes by the searchString under defined VO. Search is done in name, email and
   * login.
   *
   * @param sess
   * @param searchString
   ...
   */
  List<MemberWithSponsors> getAllSponsoredMembersAndTheirSponsors(PerunSession sess, Vo vo, List<String> attrNames)
   ...
   * in lists of statuses. If attrsNames is empty or null return all attributes for specific richMembers. If
   ...
   * @throws PrivilegeException
   */
  Member getMemberByUser(PerunSession sess, Vo vo, User user)
   ...
   * @throws ExtendMembershipException
   */
  Date getNewExtendMembership(PerunSession sess, Vo vo, String loa)
   ...
   */
  List<RichMember> getRichMembersByIds(PerunSession sess, List<Integer> ids, List<String> attrsNames)
  ...
  /**
   * Get all rich members with allowed statuses from specific group. Rich member object contains user, member,
   * userExtSources and member/user attributes.
   *
   * @param sess
  ...
  /**
   * Get all rich members of VO with specified status. Rich member object contains user, member, userExtSources and
   * member/user attributes.
   *
   * @param sess
   * @param vo
   * @param status
   * @return list of rich members with all member/user attributes, empty list if there are no members in VO with
   * specified status
   * @throws InternalErrorException
   * @throws PrivilegeException
   * @throws VoNotExistsException
   ...
   */
  List<RichMember> getSponsoredMembers(PerunSession sess, Vo vo, User user, List<String> attrNames)
   ...
   * @throws PrivilegeException     if not REGISTRAR or VOADMIN
   */
  List<RichMember> getSponsoredMembers(PerunSession sess, Vo vo, User user)
   ...
   * @throws PrivilegeException   if not VOADMIN, VOOBSERVER, PERUNOBSERVER or SPONSOR
   */
  List<MemberWithSponsors> getSponsoredMembersAndTheirSponsors(PerunSession sess, Vo vo, List<String> attrNames)
      throws VoNotExistsException, PrivilegeException, AttributeNotExistsException;
   ...
   * @throws MemberNotExistsException                 If member not exists
   * @throws NotificationMemberMailNotExistsException If the attribute with stored mail is not filled.
   */
   ...
   * @throws NotificationMemberMailNotExistsException If the attribute with stored mail is not filled.
   */
  void sendPasswordResetLinkEmail(PerunSession sess, Member member, String namespace, String url,
                                  String mailAttributeUrn, String language)
      throws PrivilegeException, MemberNotExistsException, UserNotExistsException, AttributeNotExistsException,
      NotificationMemberMailNotExistsException;

  /**
   * Send mail to user's preferred email address with reminder of the username in the given namespace.
   *
   * @param sess             PerunSession
   * @param member           Member to get user to send link mail to
   * @param namespace        namespace to change password in (member must have login in it)
   ...
   * @throws NotificationMemberMailNotExistsException If the attribute with stored mail is not filled.
   */
  void sendUsernameReminderEmail(PerunSession sess, Member member, String namespace, String mailAttributeUrn,
                                 String language)
      throws PrivilegeException, MemberNotExistsException, UserNotExistsException, AttributeNotExistsException,
      NotificationMemberMailNotExistsException;
   ...
   * @throws AlreadySponsorException
   */
  RichMember setSponsoredMember(PerunSession session, Vo vo, User userToBeSponsored, String namespace, String password,
                                String login, User sponsor, LocalDate validityTo)
      throws PrivilegeException, AlreadyMemberException, LoginNotExistsException, PasswordCreationFailedException,
      ExtendMembershipException, WrongAttributeValueException, ExtSourceNotExistsException,
      WrongReferenceAttributeValueException, UserNotInRoleException, PasswordStrengthException, InvalidLoginException,
      AlreadySponsorException, InvalidSponsoredUserDataException, NamespaceRulesNotExistsException;
   ...
   */
  RichMember setSponsorshipForMember(PerunSession session, Member sponsoredMember, User sponsor, LocalDate validityTo)
      throws MemberNotExistsException, AlreadySponsoredMemberException, UserNotInRoleException, AlreadySponsorException,
      PrivilegeException;
   ...
   * @throws UserNotInRoleException
   */
  RichMember sponsorMember(PerunSession session, Member sponsored, User sponsor, LocalDate validityTo)
      throws PrivilegeException, MemberNotSponsoredException, AlreadySponsorException, UserNotInRoleException;

  /**
   * Assigns a new sponsor to existing members. If some members are non-sponsored, turn them into sponsored and assign
   * the sponsor.
   *
   * @param session    actor
   ...
   * @throws UserNotInRoleException
   */
  void sponsorMembers(PerunSession session, List<Member> sponsored, User sponsor, LocalDate validityTo)
      throws PrivilegeException, MemberNotSponsoredException, AlreadySponsorException, UserNotInRoleException;
   ...
   * @throws PrivilegeException          if not PerunAdmin
   */
  RichMember unsetSponsorshipForMember(PerunSession session, Member sponsoredMember)
  ...
  /**
   * Validate all attributes for member and set member's status to VALID. This method runs asynchronously. It
   * immediately return member with <b>ORIGINAL</b> status and after asynchronous validation successfully finishes it
