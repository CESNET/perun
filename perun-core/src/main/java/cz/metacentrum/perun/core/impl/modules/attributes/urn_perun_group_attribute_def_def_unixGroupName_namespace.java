 ...
 */
public class urn_perun_group_attribute_def_def_unixGroupName_namespace extends GroupAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Group group, Attribute attribute)
    ...
    try {
      ...
      Attribute resourceUnixGroupName = new Attribute(sess.getPerunBl().getAttributesManagerBl()
          .getAttributeDefinition(sess, A_R_unixGroupName_namespace + ":" + groupNameNamespace));
      ...
      List<Attribute> groupUnixGIDs = sess.getPerunBl().getAttributesManagerBl()
          .getAllAttributesStartWithNameWithoutNullValue(sess, group, A_G_unixGID_namespace + ":");
      List<Attribute> resourceVersionOfUnixGIDs =
          sess.getPerunBl().getModulesUtilsBl().getListOfResourceGIDsFromListOfGroupGIDs(sess, groupUnixGIDs);
