...
public interface UserFacilityAttributesModuleImplApi extends AttributesModuleImplApi {
  ...
  /**
   * Checks if value of assigned attribute in relationship between those two entities has a correct semantics.
   *
  ...
  /**
   * Checks if value of assigned attribute in relationship between those two entities has a correct syntax.
   *
   * @param session   Perun session
   * @param user      User of the facility.
   * @param facility  Facility to be used by a user.
  ...
  /**
   * Tries to fill an attribute in the relationship between a facility and user
   *
   * @param session   Perun Session
   * @param user      User of the facility
