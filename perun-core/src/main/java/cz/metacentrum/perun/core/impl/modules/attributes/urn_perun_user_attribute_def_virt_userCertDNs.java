...
public class urn_perun_user_attribute_def_virt_userCertDNs extends UserVirtualAttributesModuleAbstract
  ...
  public List<AuditEvent> resolveVirtualAttributeValueChange(PerunSessionImpl perunSession, AuditEvent message)
    ...
    if (message instanceof UserExtSourceAddedToUser && ExtSourcesManager.EXTSOURCE_X509.equals(
    ...
    } else if (message instanceof UserExtSourceRemovedFromUser && ExtSourcesManager.EXTSOURCE_X509.equals(
