 ...
 */
public class urn_perun_vo_attribute_def_def_applicationViewPreferences extends VoAttributesModuleAbstract
    implements VoAttributesModuleImplApi {

  private final List<String> basicColumnNames =
      List.of("voId", "voName", "type", "state", "extSourceName", "extSourceType", "user", "createdBy", "createdAt",
