...
/**
 * Implementation of connection used in Perun to catch connection events. Methods of Connection object from constructor
 * are fully used. Some methods are enriched by auditer transaction methods.
 *
