...
public class GroupsManagerEntry implements GroupsManager {
  ...
  public void addMember(PerunSession sess, List<Group> groups, Member member)
      throws MemberNotExistsException, PrivilegeException, AlreadyMemberException, GroupNotExistsException,
                 WrongAttributeValueException, WrongReferenceAttributeValueException, WrongAttributeAssignmentException,
    ...
    for (Group group : groups) {
      ...
      Attribute attrSynchronizeEnabled =
          getPerunBl().getAttributesManagerBl().getAttribute(sess, group, GROUPSYNCHROENABLED_ATTRNAME);
      if ("true".equals(attrSynchronizeEnabled.getValue()) ||
              getGroupsManagerBl().isGroupInStructureSynchronizationTree(sess, group)) {
  ...
  public void allowGroupToHierarchicalVo(PerunSession sess, Group group, Vo vo)
      throws VoNotExistsException, GroupNotExistsException, PrivilegeException, RelationNotExistsException,
  ...
  @Override
  public void allowGroupsToHierarchicalVo(PerunSession sess, List<Group> groups, Vo vo)
      throws VoNotExistsException, GroupNotExistsException, PrivilegeException, RelationNotExistsException,
                 RelationExistsException {
    Utils.checkPerunSession(sess);
    getPerunBl().getVosManagerBl().checkVoExists(sess, vo);
  ...
  public boolean canExtendMembershipInGroup(PerunSession sess, Member member, Group group)
      throws MemberNotExistsException, GroupNotExistsException, PrivilegeException {
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "canExtendMembershipInGroup_Member_Group_policy",
  ...
  public void copyMembers(PerunSession sess, Group sourceGroup, List<Group> destinationGroups, List<Member> members)
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "source-copyMembers_Group_List<Group>_List<Member>_boolean_policy",
        sourceGroup)) {
    ...
    for (Group destinationGroup : destinationGroups) {
      ...
      // Authorization
      if (!AuthzResolver.authorizedInternal(sess, "dest-copyMembers_Group_List<Group>_List<Member>_boolean_policy",
          destinationGroup)) {
        throw new PrivilegeException(sess, "copyMembers");
      }
    }
  ...
  public Group createGroup(PerunSession sess, Vo vo, Group group)
      throws GroupExistsException, PrivilegeException, VoNotExistsException {
    Utils.checkPerunSession(sess);
  ...
  public Group createGroup(PerunSession sess, Group parentGroup, Group group)
      throws GroupNotExistsException, GroupExistsException, PrivilegeException, GroupRelationNotAllowed,
                 GroupRelationAlreadyExists, ExternallyManagedException {
    Utils.checkPerunSession(sess);
  ...
  @Override
  public Group createGroupUnion(PerunSession sess, Group resultGroup, Group operandGroup)
      throws GroupNotExistsException, PrivilegeException, GroupRelationNotAllowed, GroupRelationAlreadyExists,
                 WrongAttributeValueException, WrongReferenceAttributeValueException, ExternallyManagedException,
  ...
  public void deleteAllGroups(PerunSession sess, Vo vo)
      throws VoNotExistsException, PrivilegeException, GroupAlreadyRemovedException,
                 GroupAlreadyRemovedFromResourceException, GroupRelationDoesNotExist, GroupRelationCannotBeRemoved {
    Utils.checkPerunSession(sess);
  ...
  public void deleteGroup(PerunSession sess, Group group, boolean forceDelete)
      throws GroupNotExistsException, PrivilegeException, RelationExistsException, GroupAlreadyRemovedException,
                 GroupAlreadyRemovedFromResourceException, GroupRelationDoesNotExist, GroupRelationCannotBeRemoved,
    ...
    if (getGroupsManagerBl().isGroupInStructureSynchronizationTree(sess, group) ||
            getGroupsManagerBl().hasGroupSynchronizedChild(sess, group)) {
  ...
  public void deleteGroups(PerunSession perunSession, List<Group> groups, boolean forceDelete)
      throws GroupNotExistsException, PrivilegeException, GroupAlreadyRemovedException, RelationExistsException,
                 GroupAlreadyRemovedFromResourceException, GroupRelationDoesNotExist, GroupRelationCannotBeRemoved,
                 ExternallyManagedException {
    ...
    for (Group group : groups) {
      ...
      if (getGroupsManagerBl().isGroupInStructureSynchronizationTree(perunSession, group) ||
              getGroupsManagerBl().hasGroupSynchronizedChild(perunSession, group)) {
        throw new ExternallyManagedException("Group " + group + " or some of the subGroups are externally managed!");
      }
    }
  ...
  @Override
  public void disallowGroupsToHierarchicalVo(PerunSession sess, List<Group> groups, Vo vo)
      throws VoNotExistsException, GroupNotExistsException, PrivilegeException, RelationNotExistsException {
    Utils.checkPerunSession(sess);
    getPerunBl().getVosManagerBl().checkVoExists(sess, vo);
  ...
  @Override
  public void extendMembershipInGroup(PerunSession sess, Member member, Group group)
      throws ExtendMembershipException, PrivilegeException, MemberNotExistsException, GroupNotExistsException {
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "extendMembershipInGroup_Member_Group_policy",
        Arrays.asList(member, group))) {
  ...
  public void forceGroupStructureSynchronization(PerunSession sess, Group group)
      throws GroupNotExistsException, PrivilegeException, GroupStructureSynchronizationAlreadyRunningException {
    Utils.checkPerunSession(sess);
    getGroupsManagerBl().checkGroupExists(sess, group);
  ...
  public void forceGroupSynchronization(PerunSession sess, Group group)
      throws GroupNotExistsException, PrivilegeException, GroupSynchronizationAlreadyRunningException,
  ...
  public Map<Group, Object> getAllGroupsWithHierarchy(PerunSession sess, Vo vo)
    ...
    groups.keySet().removeIf(
        group -> !AuthzResolver.authorizedInternal(sess, "filter-getAllGroupsWithHierarchy_Vo_policy", group));
    return groups;
  }
  ...
  public List<RichGroup> getAllRichGroupsWithAttributesByNames(PerunSession sess, Vo vo, List<String> attrNames)
    ...
    richGroups.removeIf(richGroup -> !AuthzResolver.authorizedInternal(sess,
        "filter-getAllRichGroupsWithAttributesByNames_Vo_List<String>_policy", richGroup));
  ...
  public List<RichGroup> getAllRichGroupsWithAttributesByNames(PerunSession sess, Vo vo, List<String> attrNames,
    ...
    if (!AuthzResolver.authorizedInternal(sess,
        "getAllRichGroupsWithAttributesByNames_Vo_List<String>_List<String>_List<RoleAssignmentType>_policy", vo)) {
      throw new PrivilegeException(sess, "getAllRichGroupsWithAttributesByNames");
    }

    List<RichGroup> richGroups =
        getGroupsManagerBl().getAllRichGroupsWithAttributesByNames(sess, vo, attrNames, roles, types);
    richGroups.removeIf(richGroup -> !AuthzResolver.authorizedInternal(sess,
  ...
  public List<RichGroup> getAllRichSubGroupsWithAttributesByNames(PerunSession sess, Group parentGroup,
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "getAllRichSubGroupsWithAttributesByNames_Group_List<String>_policy",
        parentGroup)) {
      throw new PrivilegeException(sess, "getAllRichSubGroupsWithAttributesByNames");
    }
    List<RichGroup> richGroups =
        getGroupsManagerBl().getAllRichSubGroupsWithAttributesByNames(sess, parentGroup, attrNames);

    richGroups.removeIf(richGroup -> !AuthzResolver.authorizedInternal(sess,
        "filter-getAllRichSubGroupsWithAttributesByNames_Group_List<String>_policy", richGroup));
  ...
  public List<RichGroup> getAllRichSubGroupsWithAttributesByNames(PerunSession sess, Group parentGroup,
    ...
    List<RichGroup> richGroups =
        getGroupsManagerBl().getAllRichSubGroupsWithAttributesByNames(sess, parentGroup, attrNames, roles, types);
    richGroups.removeIf(richGroup -> !AuthzResolver.authorizedInternal(sess,
        "filter-getAllRichSubGroupsWithAttributesByNames" +
            "_Group_List<String>_List<String>_List<RoleAssignmentType>_policy",
        richGroup));
  ...
  public Group getGroupByName(PerunSession sess, Vo vo, String name)
      throws GroupNotExistsException, PrivilegeException, VoNotExistsException {
    Utils.checkPerunSession(sess);
    getPerunBl().getVosManagerBl().checkVoExists(sess, vo);
  ...
  public List<RichMember> getGroupDirectRichMembers(PerunSession sess, Group group)
    ...
    return getPerunBl().getMembersManagerBl()
               .filterOnlyAllowedAttributes(sess, getGroupsManagerBl().getGroupDirectRichMembers(sess, group), group,
                   true);
  }

  @Override
  public Member getGroupMemberById(PerunSession sess, Group group, int memberId)
      throws NotGroupMemberException, GroupNotExistsException, PrivilegeException {
  ...
  public List<RichMember> getGroupRichMembers(PerunSession sess, Group group)
    ...
    return getPerunBl().getMembersManagerBl()
               .filterOnlyAllowedAttributes(sess, getGroupsManagerBl().getGroupRichMembers(sess, group), group, true);
  }
  ...
  public List<RichMember> getGroupRichMembers(PerunSession sess, Group group, Status status)
    ...
    return getPerunBl().getMembersManagerBl()
               .filterOnlyAllowedAttributes(sess, getGroupsManagerBl().getGroupRichMembers(sess, group, status), group,
                   true);
  }

  @Override
  public List<RichMember> getGroupRichMembersByIds(PerunSession sess, int groupId, List<Integer> memberIds,
                                                   List<String> attrNames)
      throws GroupNotExistsException, PrivilegeException, AttributeNotExistsException {
    Utils.checkPerunSession(sess);
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "getGroupRichMembersByIds_int_List<Integer>_List<String>_policy",
        group)) {
    ...
    members.removeIf(member -> !AuthzResolver.authorizedInternal(sess,
        "filter-getGroupRichMembersByIds_int_List<Integer>_List<String>_policy", member));

    List<RichMember> richMembers =
        perunBl.getMembersManagerBl().getRichMembersWithAttributes(sess, group, members, attributeDefinitions);
  ...
  public List<RichMember> getGroupRichMembersWithAttributes(PerunSession sess, Group group)
    ...
    return getPerunBl().getMembersManagerBl()
               .filterOnlyAllowedAttributes(sess, getGroupsManagerBl().getGroupRichMembersWithAttributes(sess, group),
                   group, true);
  }
  ...
  public List<RichMember> getGroupRichMembersWithAttributes(PerunSession sess, Group group, Status status)
    ...
    return getPerunBl().getMembersManagerBl().filterOnlyAllowedAttributes(sess,
        getGroupsManagerBl().getGroupRichMembersWithAttributes(sess, group, status), group, true);
  }

  @Override
  public List<Group> getGroupUnions(PerunSession sess, Group group, boolean reverseDirection)
      throws GroupNotExistsException, PrivilegeException {
    Utils.checkPerunSession(sess);
    getGroupsManagerBl().checkGroupExists(sess, group);
  ...
  public List<Group> getGroupsByIds(PerunSession sess, List<Integer> ids) throws PrivilegeException {
    ...
    groups.removeIf(
        group -> !AuthzResolver.authorizedInternal(sess, "filter-getGroupsByIds_List<Integer>_policy", group));
  ...
  public Paginated<RichGroup> getGroupsPage(PerunSession sess, Vo vo, GroupsPageQuery query, List<String> attrNames)
      throws VoNotExistsException, PrivilegeException, MemberNotExistsException, GroupNotExistsException,
                 MemberGroupMismatchException {
    Utils.checkPerunSession(sess);
    perunBl.getVosManagerBl().checkVoExists(sess, vo);

    Member member =
        query.getMemberId() == null ? null : perunBl.getMembersManagerBl().getMemberById(sess, query.getMemberId());
    if (member != null) {
    ...
    // Authorization
    if (member != null) {
      if (!AuthzResolver.authorizedInternal(sess, "member-getGroupsPage_Vo_GroupsPageQuery_List<String>_policy",
          member)) {
  ...
  public List<Group> getMemberGroups(PerunSession sess, Member member)
    ...
    groups.removeIf(
        group -> !AuthzResolver.authorizedInternal(sess, "filter-getMemberGroups_Member_policy", member, group));
    return groups;
  }

  @Override
  public List<Group> getMemberGroupsByAttribute(PerunSession sess, Member member, Attribute attribute)
      throws WrongAttributeAssignmentException, PrivilegeException, MemberNotExistsException,
    ...
    if (!this.getPerunBl().getAttributesManagerBl()
             .isFromNamespace(sess, attribute, AttributesManagerEntry.NS_GROUP_ATTR)) {
    ...
    groups.removeIf(
        group -> !AuthzResolver.authorizedInternal(sess, "filter-getMemberGroupsByAttribute_Member_Attribute_policy",
            group));
  ...
  public List<RichGroup> getMemberRichGroupsWithAttributesByNames(PerunSession sess, Member member,
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "getMemberRichGroupsWithAttributesByNames_Member_List<String>_policy",
        member)) {
    ...
    richGroups.removeIf(richGroup -> !AuthzResolver.authorizedInternal(sess,
        ...
        Arrays.asList(member, richGroup)));
  ...
  public List<RichGroup> getMemberRichGroupsWithAttributesByNames(PerunSession sess, Member member,
    ...
    List<RichGroup> richGroups =
        getGroupsManagerBl().getMemberRichGroupsWithAttributesByNames(sess, member, attrNames, roles, types);
    richGroups.removeIf(richGroup -> !AuthzResolver.authorizedInternal(sess,
        "filter-getMemberRichGroupsWithAttributesByNames" +
            "_Member_List<String>_List<String>_List<RoleAssignmentType>_policy",
        Arrays.asList(member, richGroup)));
  ...
  public List<RichMember> getParentGroupRichMembers(PerunSession sess, Group group)
    ...
    return getPerunBl().getMembersManagerBl()
               .filterOnlyAllowedAttributes(sess, getGroupsManagerBl().getParentGroupRichMembers(sess, group), group,
                   true);
  }
  ...
  public List<RichMember> getParentGroupRichMembersWithAttributes(PerunSession sess, Group group)
    ...
    return getPerunBl().getMembersManagerBl().filterOnlyAllowedAttributes(sess,
        getGroupsManagerBl().getParentGroupRichMembersWithAttributes(sess, group), group, true);
  }
  ...
  public List<RichUser> getRichAdmins(PerunSession perunSession, Group group, List<String> specificAttributes,
      ...
      throws PrivilegeException, GroupNotExistsException, UserNotExistsException {
    Utils.checkPerunSession(perunSession);
    getGroupsManagerBl().checkGroupExists(perunSession, group);
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(perunSession, "getRichAdmins_Group_List<String>_boolean_boolean_policy",
        group)) {
      throw new PrivilegeException(perunSession, "getRichAdmins");
    }

    return getPerunBl().getUsersManagerBl().filterOnlyAllowedAttributes(perunSession,
        getGroupsManagerBl().getRichAdmins(perunSession, group, specificAttributes, allUserAttributes,
            onlyDirectAdmins));
  }
  ...
  public List<RichUser> getRichAdmins(PerunSession perunSession, Group group)
    ...
    return getPerunBl().getUsersManagerBl()
               .filterOnlyAllowedAttributes(perunSession, getGroupsManagerBl().getRichAdmins(perunSession, group));
  }
  ...
  public List<RichUser> getRichAdminsWithAttributes(PerunSession perunSession, Group group)
    ...
    return getPerunBl().getUsersManagerBl().filterOnlyAllowedAttributes(perunSession,
        getGroupsManagerBl().getRichAdminsWithAttributes(perunSession, group));
  }
  ...
  public RichGroup getRichGroupByIdWithAttributesByNames(PerunSession sess, int groupId, List<String> attrNames)
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "getRichGroupByIdWithAttributesByNames_int_List<String>_policy",
        group)) {
      throw new PrivilegeException(sess, "getRichGroupByIdWithAttributesByNames");
    }

    return getGroupsManagerBl().filterOnlyAllowedAttributes(sess,
        getGroupsManagerBl().getRichGroupByIdWithAttributesByNames(sess, groupId, attrNames));

  }

  @Override
  public List<RichGroup> getRichGroupsAssignedToResourceWithAttributesByNames(PerunSession sess, Resource resource,
                                                                              List<String> attrNames)
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess,
        "getRichGroupsAssignedToResourceWithAttributesByNames_Resource_List<String>_policy", resource)) {
      throw new PrivilegeException(sess, "getRichGroupsAssignedToResourceWithAttributesByNames");
    }

    List<RichGroup> richGroups =
        getGroupsManagerBl().getRichGroupsWithAttributesAssignedToResource(sess, resource, attrNames);

    richGroups.removeIf(richGroup -> !AuthzResolver.authorizedInternal(sess,
        "filter-getRichGroupsAssignedToResourceWithAttributesByNames_Resource_List<String>_policy", richGroup,
        resource));
  ...
  @Override
  public List<RichGroup> getRichGroupsAssignedToResourceWithAttributesByNames(PerunSession sess, Member member,
                                                                              Resource resource, List<String> attrNames)
      throws ResourceNotExistsException, PrivilegeException, MemberNotExistsException {
    Utils.checkPerunSession(sess);
    this.getPerunBl().getResourcesManagerBl().checkResourceExists(sess, resource);
    this.getPerunBl().getMembersManagerBl().checkMemberExists(sess, member);
    ...
    List<RichGroup> richGroups =
        getGroupsManagerBl().getRichGroupsWithAttributesAssignedToResource(sess, member, resource, attrNames);
  ...
  public List<RichGroup> getRichSubGroupsWithAttributesByNames(PerunSession sess, Group parentGroup,
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "getRichSubGroupsWithAttributesByNames_Group_List<String>_policy",
        parentGroup)) {
      throw new PrivilegeException(sess, "getRichSubGroupsWithAttributesByNames");
    }
    List<RichGroup> richGroups =
        getGroupsManagerBl().getRichSubGroupsWithAttributesByNames(sess, parentGroup, attrNames);

    richGroups.removeIf(richGroup -> !AuthzResolver.authorizedInternal(sess,
        "filter-getRichSubGroupsWithAttributesByNames_Group_List<String>_policy", richGroup));
  ...
  public boolean isAllowedGroupToHierarchicalVo(PerunSession sess, Group group, Vo vo)
      throws VoNotExistsException, GroupNotExistsException, PrivilegeException {
    Utils.checkPerunSession(sess);
    getPerunBl().getVosManagerBl().checkVoExists(sess, vo);
    getGroupsManagerBl().checkGroupExists(sess, group);
  ...
  public boolean isDirectGroupMember(PerunSession sess, Group group, Member member)
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "isDirectGroupMember_Group_Member_policy",
  ...
  public void moveGroup(PerunSession sess, Group destinationGroup, Group movingGroup)
      throws GroupNotExistsException, PrivilegeException, GroupMoveNotAllowedException, WrongAttributeValueException,
    ...
    if (destinationGroup != null) {
      ...
      // We want to check MFA for parent groups as well,
      // since we are changing its structure (moving one of its subgroups)
      Group parentGroup;
      try {
  ...
  @Override
  public void removeAdmin(PerunSession sess, Group group, User user)
      throws PrivilegeException, GroupNotExistsException, UserNotAdminException, UserNotExistsException,
  ...
  @Override
  public void removeAdmin(PerunSession sess, Group group, Group authorizedGroup)
  ...
  public void removeMember(PerunSession sess, Group group, Member member)
      throws MemberNotExistsException, NotGroupMemberException, PrivilegeException, GroupNotExistsException,
                 WrongAttributeAssignmentException, AttributeNotExistsException, ExternallyManagedException {
    Utils.checkPerunSession(sess);
    getGroupsManagerBl().checkGroupExists(sess, group);
    getPerunBl().getMembersManagerBl().checkMemberExists(sess, member);
  ...
  @Override
  public void removeMember(PerunSession sess, Member member, List<Group> groups)
      throws MemberNotExistsException, NotGroupMemberException, PrivilegeException, GroupNotExistsException,
                 WrongAttributeAssignmentException, AttributeNotExistsException, ExternallyManagedException {
    Utils.checkPerunSession(sess);
    for (Group group : groups) {
  ...
  @Override
  public Member setMemberGroupStatus(PerunSession sess, Member member, Group group, MemberGroupStatus status)
      throws GroupNotExistsException, MemberNotExistsException, PrivilegeException, NotGroupMemberException {
    ...
    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "setMemberGroupStatus_Member_Group_MemberGroupStatus_policy",
        Arrays.asList(member, group))) {
  ...
  @Override
  public void suspendGroupSynchronization(PerunSession sess, boolean suspend) throws PrivilegeException {
    Utils.checkPerunSession(sess);

    // Authorization
    if (!AuthzResolver.authorizedInternal(sess, "suspendGroupSynchronization_boolean_policy")) {
      throw new PrivilegeException(sess, "suspendGroupSynchronization");
    }

    getGroupsManagerBl().suspendGroupSynchronization(sess, suspend);
  }
  ...
  @Override
  public Group updateGroup(PerunSession sess, Group group)
      throws GroupNotExistsException, GroupExistsException, PrivilegeException {
    Utils.checkPerunSession(sess);
    getGroupsManagerBl().checkGroupExists(sess, group);
    Utils.notNull(group, "group");
    Utils.notNull(group.getName(), "group.name");
