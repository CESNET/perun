...
public class ServicesManagerImpl implements ServicesManagerImplApi {
  ...
  public final static String serviceMappingSelectQuery =
  ...
  public final static String facilityDestinationMappingSelectQuery =
      destinationMappingSelectQuery + ", facility_service_destinations.propagation_type as f_s_des_propagation_type ";
  ...
  public final static String richDestinationWithLastSuccessfulPropagationMappingSelectQuery =
      " " + destinationMappingSelectQuery + ", " +
          "facilities.id as facilities_id, facilities.uu_id as facilities_uu_id, facilities.name as facilities_name, facilities.dsc as facilities_dsc, " +
          "facilities.created_at as facilities_created_at, facilities.created_by as facilities_created_by, facilities.modified_at as facilities_modified_at, facilities.modified_by as facilities_modified_by, " +
          "facilities.modified_by_uid as facilities_modified_by_uid, facilities.created_by_uid as facilities_created_by_uid, " +
          serviceMappingSelectQuery + ", " +
  ...
  public static final RowMapper<ServicesPackage> SERVICESPACKAGE_MAPPER = (resultSet, i) -> {
    ...
    if (resultSet.getInt("s_packages_modified_by_uid") == 0) {
      ...
      sPackage.setModifiedByUid(resultSet.getInt("s_packages_modified_by_uid"));
    }
    if (resultSet.getInt("s_packages_created_by_uid") == 0) {
      sPackage.setCreatedByUid(null);
    } else {
      sPackage.setCreatedByUid(resultSet.getInt("s_packages_created_by_uid"));
    }
    return sPackage;
  };
  ...
  public void blockServiceOnFacility(PerunSession sess, int serviceId, int facilityId)
    ...
    try {
      jdbc.update(
          "insert into service_denials(id, facility_id, service_id, created_by, modified_by, created_by_uid, modified_by_uid) values (?,?,?,?,?,?,?)",
          newBanId, facilityId, serviceId, sess.getPerunPrincipal().getActor(), sess.getPerunPrincipal().getActor(),
  ...
  public void blockServiceOnDestination(PerunSession sess, int serviceId, int destinationId)
    ...
    try {
      int newBanId = Utils.getNewId(jdbc, "service_denials_id_seq");
      jdbc.update(
          "insert into service_denials(id, destination_id, service_id, created_by, modified_by, created_by_uid, modified_by_uid) values (?,?,?,?,?,?,?)",
          newBanId, destinationId, serviceId, sess.getPerunPrincipal().getActor(), sess.getPerunPrincipal().getActor(),
          sess.getPerunPrincipal().getUserId(),
          sess.getPerunPrincipal().getUserId());
    } catch (DuplicateKeyException ex) {
      throw new ServiceAlreadyBannedException(
  ...
  public List<Service> getServicesFromDestination(int destinationId) {
    try {
      @SuppressWarnings("ConstantConditions")
      List<Service> servicesFromDestination =
          jdbc.query("select distinct " + ServicesManagerImpl.serviceMappingSelectQuery +
  ...
  public Service createService(PerunSession sess, Service service) {
    try {
      ...
      jdbc.update(
          "insert into services(id,name,description,delay,recurrence,enabled,script,use_expired_members,created_by,created_at,modified_by,modified_at,created_by_uid, modified_by_uid) " +
              "values (?,?,?,?,?,?,?,?,?," + Compatibility.getSysdate() + ",?," + Compatibility.getSysdate() + ",?,?)",
          newId, service.getName(),
          service.getDescription(), service.getDelay(), service.getRecurrence(), service.isEnabled(),
          service.getScript(), service.isUseExpiredMembers(),
  ...
  public void updateService(PerunSession sess, Service service) {
    try {
      ...
      jdbc.update(
          "update services set name=?, description=?, delay=?, recurrence=?, enabled=?, script=?, use_expired_members=?," +
  ...
  public Service getServiceByName(PerunSession sess, String name) throws ServiceNotExistsException {
    try {
      return jdbc.queryForObject("select " + serviceMappingSelectQuery + " from services where name=?", SERVICE_MAPPER,
          name);
  ...
  public Service getServiceById(PerunSession sess, int id) throws ServiceNotExistsException {
    try {
      return jdbc.queryForObject("select " + serviceMappingSelectQuery + " from services where id=?", SERVICE_MAPPER,
          id);
    } catch (EmptyResultDataAccessException ex) {
  ...
  public List<Service> getServicesByAttributeDefinition(PerunSession sess, AttributeDefinition attributeDefinition) {
    try {
      return jdbc.query("select " + serviceMappingSelectQuery +
  ...
  public List<Resource> getAssignedResources(PerunSession sess, Service service) {
    try {
      return jdbc.query(
          "select " + ResourcesManagerImpl.resourceMappingSelectQuery + " from resource_services join resources on " +
              "resource_services.resource_id=resources.id  where service_id=?", ResourcesManagerImpl.RESOURCE_MAPPER,
          service.getId());
    } catch (RuntimeException ex) {
      throw new InternalErrorException(ex);
    }
  ...
  public List<ServicesPackage> getServicesPackages(PerunSession sess) {
    try {
      List<ServicesPackage> servicesPackages =
          jdbc.query("select " + servicePackageMappingSelectQuery + " from service_packages", SERVICESPACKAGE_MAPPER);
  ...
  public ServicesPackage getServicesPackageById(PerunSession sess, int servicesPackageId)
    ...
    try {
      ServicesPackage servicesPackage =
          jdbc.queryForObject("select " + servicePackageMappingSelectQuery + " from service_packages where id = ?",
  ...
  public ServicesPackage createServicesPackage(PerunSession sess, ServicesPackage servicesPackage) {
    try {
      ...
      jdbc.update(
          "insert into service_packages (id, name, description, created_by,created_at,modified_by,modified_at,created_by_uid,modified_by_uid) " +
              "values (?,?,?,?," + Compatibility.getSysdate() + ",?," + Compatibility.getSysdate() + ",?,?)", newId,
          servicesPackage.getName(),
          servicesPackage.getDescription(), sess.getPerunPrincipal().getActor(), sess.getPerunPrincipal().getActor(),
          sess.getPerunPrincipal().getUserId(), sess.getPerunPrincipal().getUserId());
  ...
  public void updateServicesPackage(PerunSession sess, ServicesPackage servicesPackage) {
    try {
      jdbc.update(
          ...
          servicesPackage.getDescription(), servicesPackage.getName(), sess.getPerunPrincipal().getActor(),
          sess.getPerunPrincipal().getUserId(), servicesPackage.getId());
    } catch (RuntimeException e) {
      throw new InternalErrorException(e);
    }
  }
  ...
  public void addServiceToServicesPackage(PerunSession sess, ServicesPackage servicesPackage, Service service)
    ...
    try {
      jdbc.update(
          "insert into service_service_packages (package_id, service_id, created_by,created_at,modified_by,modified_at,created_by_uid,modified_by_uid) " +
              "values (?,?,?," + Compatibility.getSysdate() + ",?," + Compatibility.getSysdate() + ",?,?)",
  ...
  public void addRequiredAttribute(PerunSession sess, Service service, AttributeDefinition attribute)
    ...
    try {
      ...
      jdbc.update(
          "insert into service_required_attrs(service_id, attr_id, created_by,created_at,modified_by,modified_at,created_by_uid,modified_by_uid) " +
              "values (?,?,?," + Compatibility.getSysdate() + ",?," + Compatibility.getSysdate() + ",?,?)",
          service.getId(), attribute.getId(),
          sess.getPerunPrincipal().getActor(), sess.getPerunPrincipal().getActor(),
          sess.getPerunPrincipal().getUserId(), sess.getPerunPrincipal().getUserId());
  ...
  public Destination getDestinationById(PerunSession sess, int id) throws DestinationNotExistsException {
    try {
      return jdbc.queryForObject("select " + destinationMappingSelectQuery + " from destinations where id=?",
  ...
  public void addDestination(PerunSession sess, Service service, Facility facility, Destination destination)
    ...
    try {
      jdbc.update(
          "insert into facility_service_destinations (service_id, facility_id, destination_id, propagation_type, created_by,created_at,modified_by,modified_at,created_by_uid, modified_by_uid) " +
              "values (?,?,?,?,?," + Compatibility.getSysdate() + ",?," + Compatibility.getSysdate() + ",?,?)",
          service.getId(), facility.getId(), destination.getId(),
          destination.getPropagationType(), sess.getPerunPrincipal().getActor(), sess.getPerunPrincipal().getActor(),
          sess.getPerunPrincipal().getUserId(), sess.getPerunPrincipal().getUserId());
    } catch (DuplicateKeyException e) {
  ...
  public List<Destination> getDestinations(PerunSession sess, Service service, Facility facility) {
    try {
      return jdbc.query("select " + facilityDestinationMappingSelectQuery +
              " from facility_service_destinations join destinations on destinations.id=facility_service_destinations.destination_id " +
              "where service_id=? and facility_id=? order by destinations.destination", DESTINATION_MAPPER, service.getId(),
          facility.getId());
    } catch (RuntimeException e) {
      throw new InternalErrorException(e);
    }
  ...
  public List<RichDestination> getAllRichDestinations(PerunSession perunSession, Facility facility) {
    try {
      return jdbc.query("select " + richDestinationWithLastSuccessfulPropagationMappingSelectQuery +
  ...
  public boolean destinationExists(PerunSession sess, Service service, Facility facility, Destination destination) {
    try {
      int numberOfExistences = jdbc.queryForInt(
          "select count(1) from facility_service_destinations fsd join destinations d on fsd.destination_id = d.id where fsd.service_id=? and fsd.facility_id=? and d.destination=? and d.type=?",
          service.getId(), facility.getId(), destination.getDestination(), destination.getType());
      if (numberOfExistences == 1) {
        return true;
      } else if (numberOfExistences > 1) {
  ...
  public List<Service> getAssignedServices(PerunSession perunSession, Facility facility) {
    try {
      return jdbc.query("select distinct " + serviceMappingSelectQuery +
              " from services join resource_services on services.id = resource_services.service_id join resources on resource_services.resource_id = resources.id where resources.facility_id=?",
          SERVICE_MAPPER, facility.getId());
    } catch (RuntimeException e) {
      throw new InternalErrorException(e);
    }
  }
  ...
  public List<Service> getAssignedServices(PerunSession perunSession, Facility facility, Vo vo) {
    try {
      return jdbc.query("select distinct " + serviceMappingSelectQuery +
              " from services join resource_services on services.id = resource_services.service_id join resources on resource_services.resource_id = resources.id where resources.facility_id=? and resources.vo_id=?",
  ...
  public Destination getDestination(PerunSession sess, String destination, String type)
    ...
    try {
      return jdbc.queryForObject(
          "select " + destinationMappingSelectQuery + " from destinations where destination=? and type=?",
  ...
  public Destination createDestination(PerunSession sess, Destination destination) {
    ...
    try {
      ...
      jdbc.update(
          "insert into destinations (id, destination, type, created_by,created_at,modified_by,modified_at,created_by_uid, modified_by_uid) " +
              "values (?,?,?,?," + Compatibility.getSysdate() + ",?," + Compatibility.getSysdate() + ",?,?)",
          destinationId, destination.getDestination(), destination.getType(),
          sess.getPerunPrincipal().getActor(), sess.getPerunPrincipal().getActor(),
          sess.getPerunPrincipal().getUserId(), sess.getPerunPrincipal().getUserId());
  ...
  public List<Destination> getFacilitiesDestinations(PerunSession sess, Vo vo) {
    try {
      return jdbc.query("select distinct " + destinationMappingSelectQuery +
