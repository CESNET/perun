 ...
 */
public class urn_perun_member_attribute_def_def_workplace extends MemberAttributesModuleAbstract
  ...
  public void changedAttributeHook(PerunSessionImpl session, Member member, Attribute attribute)
    ...
    if (attribute.getValue() != null) {
      ...
      try {
        ...
        throw new WrongReferenceAttributeValueException(attribute, userWorkplace,
            "Mismatch in checking of member workplace and user workplace (different checking rules)", ex);
      }
    }
  }
