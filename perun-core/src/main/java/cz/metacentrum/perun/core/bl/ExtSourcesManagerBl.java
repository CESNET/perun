...
public interface ExtSourcesManagerBl {
   ...
   * @throws ExtSourceAlreadyAssignedException
   */
  void addExtSources(PerunSession perunSession, Group group, List<ExtSource> sources)
      throws ExtSourceAlreadyAssignedException;
   ...
   */
  void checkExtSourceAssignedToVo(PerunSession sess, ExtSource extSource, int voId)
   ...
   * @throws InternalErrorException
   */
  CandidateGroup generateCandidateGroup(PerunSession perunSession, Map<String, String> groupSubjectData,
   ...
   * @throws InternalErrorException
   */
  List<CandidateGroup> generateCandidateGroups(PerunSession perunSession, List<Map<String, String>> groupSubjectsData,
                                               ExtSource source, String loginPrefix);
  ...
  /**
   * Get the candidate from the ExtSource. Login of the candidate will be used to gain data from the ExtSource.
   *
   ...
   */
  CandidateSync getCandidate(PerunSession perunSession, ExtSource source, String login)
   ...
   * @throws InternalErrorException
   */
  CandidateSync getCandidate(PerunSession perunSession, Map<String, String> subjectData, ExtSource source,
                             String login);
