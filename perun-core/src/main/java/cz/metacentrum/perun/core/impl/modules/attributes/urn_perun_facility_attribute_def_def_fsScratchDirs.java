 ...
 * @author David Flor
 */
public class urn_perun_facility_attribute_def_def_fsScratchDirs extends FacilityAttributesModuleAbstract implements
  ...
  public void checkAttributeSyntax(PerunSessionImpl perunSession, Facility facility, Attribute attribute)
    ...
    if (scratchDirsNormalized.size() != scratchDirsKeys.size()) {
      ...
      throw new WrongAttributeValueException(attribute, facility, "Scratch directory duplicated detected on this " +
                                                                      "facility.");
    }
  }
  ...
  public void checkAttributeSemantics(PerunSessionImpl perunSession, Facility facility, Attribute attribute)
    ...
    if (attribute.getValue() == null) {
      throw new WrongReferenceAttributeValueException(attribute, null, facility, null, "Attribute cannot be null!");
    }
  }
