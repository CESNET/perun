...
/**
 * Virtual attribute for Office 365 email forwarding. If the mail forwarding is disabled the returned value is ''.
...
public class urn_perun_user_facility_attribute_def_virt_enabledO365MailForward
  ...
  private static final String A_U_F_DISABLE0365MAILFORWARD =
      AttributesManager.NS_USER_FACILITY_ATTR_DEF + ":disableO365MailForward";
  private static final String A_U_F_O365MAILFORWARD = AttributesManager.NS_USER_FACILITY_ATTR_DEF + ":o365MailForward";
