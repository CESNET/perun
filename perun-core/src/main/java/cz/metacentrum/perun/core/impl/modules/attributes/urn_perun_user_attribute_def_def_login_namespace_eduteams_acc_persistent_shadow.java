...
/**
 * Class for checking logins uniqueness in the namespace and filling eduteams-acc-persistent id. It is only storage! Use
 * module login eduteams_acc_persistent for access the value.
 */
public class urn_perun_user_attribute_def_def_login_namespace_eduteams_acc_persistent_shadow
  ...
  private static final String extSourceNameEduteams = "https://proxy.acc.eduteams.org/proxy";
  private static final String domainNameEduteams = "eduteams.org";
  private static final String attrNameEduteams = "login-namespace:eduteams-acc-persistent-shadow";
