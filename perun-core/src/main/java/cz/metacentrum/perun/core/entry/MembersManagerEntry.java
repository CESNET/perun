...
public class MembersManagerEntry implements MembersManager {
	...
	public Member createServiceMember(PerunSession sess, Vo vo, Candidate candidate, List<User> serviceUserOwners) throws InternalErrorException, GroupNotExistsException, ExtendMembershipException, AlreadyMemberException, GroupOperationsException, UserNotExistsException, WrongAttributeValueException, PrivilegeException, WrongReferenceAttributeValueException, VoNotExistsException {
	...
	public Member createMember(PerunSession sess, Vo vo, User user) throws InternalErrorException, UserNotExistsException, VoNotExistsException, PrivilegeException, GroupNotExistsException, WrongReferenceAttributeValueException, ExtendMembershipException, GroupOperationsException, AlreadyMemberException, WrongAttributeValueException {
		return this.createMember(sess, vo, user, new ArrayList<Group>());
	}

	public Member createMember(PerunSession sess, Vo vo, User user, List<Group> groups) throws InternalErrorException, UserNotExistsException, VoNotExistsException, PrivilegeException, GroupNotExistsException, WrongReferenceAttributeValueException, ExtendMembershipException, GroupOperationsException, AlreadyMemberException, WrongAttributeValueException {
		Utils.checkPerunSession(sess);
	...
	public Member createMember(PerunSession sess, Vo vo, ExtSource extSource, String login) throws InternalErrorException, VoNotExistsException, ExtSourceNotExistsException, GroupNotExistsException, PrivilegeException, GroupOperationsException, ExtendMembershipException, AlreadyMemberException, WrongReferenceAttributeValueException, WrongAttributeValueException {
		return createMember(sess, vo, extSource, login, new ArrayList<Group>());
	}

	public Member createMember(PerunSession sess, Vo vo, ExtSource extSource, String login, List<Group> groups) throws InternalErrorException, VoNotExistsException, ExtSourceNotExistsException, GroupNotExistsException, PrivilegeException, GroupOperationsException, ExtendMembershipException, AlreadyMemberException, WrongReferenceAttributeValueException, WrongAttributeValueException {
		Utils.checkPerunSession(sess);
