 ...
 * It is only storage! Use module login eurofusion_persistent for access the value.
 */
public class urn_perun_user_attribute_def_def_login_namespace_eurofusion_persistent_shadow
  ...
  private final static String attrNameEuroFusion = "login-namespace:eurofusion-persistent-shadow";

  private final static String CONFIG_EXT_SOURCE_NAME_EURO_FUSION = "extSourceNameEuroFusion";
  private final static String CONFIG_DOMAIN_NAME_EURO_FUSION = "domainNameEuroFusion";
