...
public interface DatabaseManagerBl {
   ...
   */
  static java.sql.Array prepareSQLArrayOfNumbers(List<? extends PerunBean> perunBeans,
   ...
   * @throws InternalErrorException if oracle method to work with an array can't be get or invoked
   */
  static java.sql.Array prepareSQLArrayOfNumbersFromIntegers(List<Integer> integers,
                                                             PreparedStatement preparedStatement) throws SQLException {
   ...
   * @throws InternalErrorException if oracle method to work with an array can't be get or invoked
   */
  static java.sql.Array prepareSQLArrayOfStrings(List<String> strings, PreparedStatement preparedStatement)
      throws SQLException {
