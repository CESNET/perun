 ...
 */
public class urn_perun_vo_attribute_def_def_autoApproveByGroupMembership extends VoAttributesModuleAbstract implements VoAttributesModuleImplApi {
	...
	public AttributeDefinition getAttributeDefinition() {
		...
		attr.setDescription("List of group IDs in which if the user is already a valid member, their application to any group in Vo will be automatically approved.");
		return attr;
	}
}
