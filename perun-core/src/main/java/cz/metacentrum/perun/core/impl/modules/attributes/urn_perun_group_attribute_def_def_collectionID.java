 ...
 */
public class urn_perun_group_attribute_def_def_collectionID extends GroupAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Group group, Attribute attribute)
    ...
    if (attribute.getValue() == null) {
      throw new WrongReferenceAttributeValueException(attribute, "Attribute collectionID cannot be null.");
    }
  }
