 ...
 */
public class urn_perun_resource_attribute_def_virt_unixGroupName extends ResourceVirtualAttributesModuleAbstract
  ...
  public void checkAttributeSemantics(PerunSessionImpl sess, Resource resource, Attribute attribute)
    ...
    try {
      groupNameAttribute = sess.getPerunBl().getAttributesManagerBl()
          .getAttribute(sess, resource, A_R_unixGroupName_namespace + unixGroupNameNamespaceAttribute.getValue());
  ...
  public Attribute getAttributeValue(PerunSessionImpl sess, Resource resource,
    ...
    try {
      Attribute groupNameAttribute = sess.getPerunBl().getAttributesManagerBl()
          .getAttribute(sess, resource, A_R_unixGroupName_namespace + unixGroupNameNamespaceAttribute.getValue());
