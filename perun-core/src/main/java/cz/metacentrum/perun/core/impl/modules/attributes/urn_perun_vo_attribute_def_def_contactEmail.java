 ...
 * @author Jiří Mauritz
 */
public class urn_perun_vo_attribute_def_def_contactEmail extends VoAttributesModuleAbstract
  ...
  public void checkAttributeSyntax(PerunSessionImpl sess, Vo vo, Attribute attribute)
    ...
    for (String email : contactEmails) {
      if (!(sess.getPerunBl().getModulesUtilsBl().isNameOfEmailValid(sess, email))) {
