...
public class ExtSourceJSON extends ExtSourceImpl implements ExtSourceApi {
  ...
  /**
   * Initialize JSON file. The file is either specified in the extSource configuration 'file' property, or a combination
   * of configuration 'directory' property and 'file' attribute of the group
   *
