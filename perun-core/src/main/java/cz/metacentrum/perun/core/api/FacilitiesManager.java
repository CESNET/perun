...
public interface FacilitiesManager {
	 ...
	 * @throws InternalErrorException
	 */
	void removeService(PerunSession sess, Facility facility, Service service) throws InternalErrorException, ServiceNotExistsException, PrivilegeException, FacilityNotExistsException;
