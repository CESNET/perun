...
/**
 * Class for checking logins uniqueness in the namespace and filling geant-persistent id. It is only storage! Use module
 * login geant_persistent for access the value.
 */
public class urn_perun_user_attribute_def_def_login_namespace_geant_persistent_shadow
  ...
  private static final String attrNameGeant = "login-namespace:geant-persistent-shadow";

  private static final String CONFIG_EXT_SOURCE_NAME_GEANT = "extSourceNameGeant";
  private static final String CONFIG_DOMAIN_NAME_GEANT = "domainNameGeant";
