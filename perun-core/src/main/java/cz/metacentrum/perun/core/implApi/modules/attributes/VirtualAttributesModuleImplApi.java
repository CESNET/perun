...
public interface VirtualAttributesModuleImplApi extends AttributesModuleImplApi {
  ...
  /**
   * Get list of attributes which this attribute value is computed from. In other words attributes whose values change
   * can also directly affect value of this attribute.
   * <p>
   * An attribute should strongly depend on all attributes which values are used in method "getAttributeValue" defined
   * in attribute module for virtual attributes.
   *
