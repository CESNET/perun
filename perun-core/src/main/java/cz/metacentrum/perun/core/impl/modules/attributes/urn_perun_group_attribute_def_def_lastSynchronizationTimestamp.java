 ...
 */
public class urn_perun_group_attribute_def_def_lastSynchronizationTimestamp extends GroupAttributesModuleAbstract
  ...
  public void checkAttributeSyntax(PerunSessionImpl sess, Group group, Attribute attribute)
    ...
    try {
      ...
      throw new WrongAttributeValueException(attribute, group,
          "Format of timestamp is not correct and can't be parsed correctly. Ex. 'yyyy-MM-dd HH:mm:ss.S'", ex);
    }
  }
