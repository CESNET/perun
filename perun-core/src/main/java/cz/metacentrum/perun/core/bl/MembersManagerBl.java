...
public interface MembersManagerBl {
  ...
  Member createMember(PerunSession sess, Vo vo, String extSourceName, String extSourceType, String login,
                      Candidate candidate)
      throws WrongReferenceAttributeValueException, WrongAttributeValueException, AlreadyMemberException,
  ...
  List<RichMember> findCompleteRichMembers(PerunSession sess, Group group, List<String> attrsNames, String searchString,
                                           boolean lookingInParentGroup) throws ParentGroupNotExistsException;
   ...
   * @throws WrongAttributeAssignmentException     if attribute is not vo attribute
   */
  void updateOrganizationsAttributes(PerunSession sess, Vo vo, Member member)
  ...
  void createMemberFromRegistrarAfterCommitValidation(PerunSession sess, Member member);
}
