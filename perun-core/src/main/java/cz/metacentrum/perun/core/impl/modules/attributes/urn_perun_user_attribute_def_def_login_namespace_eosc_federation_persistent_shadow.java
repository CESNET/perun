 ...
 * It is only storage! Use module login eosc_federation_persistent for access the value.
 *
 */
public class urn_perun_user_attribute_def_def_login_namespace_eosc_federation_persistent_shadow
	...
	private final static String attrNameEOSC = "login-namespace:eosc-federation-persistent-shadow";

	private final static String CONFIG_EXT_SOURCE_NAME_EOSC = "extSourceNameEOSC";
	private final static String CONFIG_DOMAIN_NAME_EOSC = "domainNameEOSC";
