...
/**
 * Group synchronization filename
 * Defines file inside the directory configured in the extsource definition.
 *
 * @author Johana Supikova <supikova@ics.muni.cz>
 */
public class urn_perun_group_attribute_def_def_groupSynchronizationFilename extends GroupAttributesModuleAbstract implements GroupAttributesModuleImplApi {
	private static final Logger log = LoggerFactory.getLogger(urn_perun_group_attribute_def_def_groupSynchronizationFilename.class);
