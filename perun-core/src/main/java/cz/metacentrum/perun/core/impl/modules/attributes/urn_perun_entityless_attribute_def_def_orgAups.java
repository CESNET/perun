 ...
 */
public class urn_perun_entityless_attribute_def_def_orgAups extends EntitylessAttributesModuleAbstract
  ...
  public void checkAttributeSyntax(PerunSessionImpl perunSession, String key, Attribute attribute)
    ...
    for (String mapKey : mapKeys) {
      ...
      if (value == null || value.isEmpty()) {
        throw new WrongAttributeValueException(attribute, "AUPs for key: '" + mapKey + "' can't be empty.");
      }
        ...
        for (int i = 0; i < array.length(); i++) {
          ...
          if (!object.has("version")) {
            throw new WrongAttributeValueException(attribute,
                "AUP for key: '" + mapKey + "' is missing key version in JSON.");
          }
          if (!object.has("date")) {
            throw new WrongAttributeValueException(attribute,
                "AUP for key: '" + mapKey + "' is missing key date in JSON.");
          }
          if (!object.has("link")) {
            throw new WrongAttributeValueException(attribute,
                "AUP for key: '" + mapKey + "' is missing key link in JSON.");
          }
          if (!object.has("text")) {
            throw new WrongAttributeValueException(attribute,
                "AUP for key: '" + mapKey + "' is missing key text in JSON.");
          }
        }
