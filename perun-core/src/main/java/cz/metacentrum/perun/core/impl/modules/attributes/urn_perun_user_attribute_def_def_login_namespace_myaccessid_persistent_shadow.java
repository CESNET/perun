...
/**
 * Class for checking logins uniqueness in the namespace and filling myaccessid-persistent id. It is only storage! Use
 * module login myaccessid_persistent for access the value.
 */
public class urn_perun_user_attribute_def_def_login_namespace_myaccessid_persistent_shadow
    extends urn_perun_user_attribute_def_def_login_namespace {


  private static final Logger LOG =
      LoggerFactory.getLogger(urn_perun_user_attribute_def_def_login_namespace_myaccessid_persistent_shadow.class);

  private static final String CONFIG_EXT_SOURCE_NAME_MY_ACCESS_ID = "extSourceNameMyAccessId";
  private static final String CONFIG_DOMAIN_NAME_MY_ACCESS_ID = "domainNameMyAccessId";
  private static final String FRIENDLY_NAME = "login-namespace:myaccessid-persistent-shadow";
  private static final String FRIENDLY_NAME_PARAMETER = "myaccessid-persistent-shadow";
  ...
  public AttributeDefinition getAttributeDefinition() {
    ...
    attr.setDescription("Login for MyAccessId. Do not use it directly! " +
                        "Use \"user:virt:login-namespace:myaccessid-persistent\" attribute instead.");
    return attr;
  }
  ...
  private String getDomainName() {
    return loader.loadString(getClass().getSimpleName(), CONFIG_DOMAIN_NAME_MY_ACCESS_ID);
  }
  ...
  private String getExtSourceName() {
    return loader.loadString(getClass().getSimpleName(), CONFIG_EXT_SOURCE_NAME_MY_ACCESS_ID);
  }
