 ...
 * It is only storage! Use module login myaccessid_persistent for access the value.
 */
public class urn_perun_user_attribute_def_def_login_namespace_myaccessid_persistent_shadow
  ...
  private final static Logger log = LoggerFactory.getLogger(
      urn_perun_user_attribute_def_def_login_namespace_myaccessid_persistent_shadow.class);

  private final static String CONFIG_EXT_SOURCE_NAME_MY_ACCESS_ID = "extSourceNameMyAccessId";
  private final static String CONFIG_DOMAIN_NAME_MY_ACCESS_ID = "domainNameMyAccessId";
  private final static String FRIENDLY_NAME = "login-namespace:myaccessid-persistent-shadow";
  private final static String FRIENDLY_NAME_PARAMETER = "myaccessid-persistent-shadow";
