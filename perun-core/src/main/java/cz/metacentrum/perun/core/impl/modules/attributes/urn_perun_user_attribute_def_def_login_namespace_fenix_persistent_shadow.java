...
/**
 * Class for checking logins uniqueness in the namespace and filling fenix-persistent id. It is only storage! Use module
 * login fenix_persistent for access the value.
 */
public class urn_perun_user_attribute_def_def_login_namespace_fenix_persistent_shadow
  ...
  private static final String attrNameFenix = "login-namespace:fenix-persistent-shadow";

  private static final String CONFIG_EXT_SOURCE_NAME_FENIX = "extSourceNameFenix";
  private static final String CONFIG_DOMAIN_NAME_FENIX = "domainNameFenix";
