...
public class FacilitiesManagerEntry implements FacilitiesManager {
	...
	@Override
	public void removeService(PerunSession sess, Facility facility, Service service) throws InternalErrorException, ServiceNotExistsException, PrivilegeException, FacilityNotExistsException {
		Utils.checkPerunSession(sess);
		getFacilitiesManagerBl().checkFacilityExists(sess, facility);
