...
public enum MembersManagerMethod implements ManagerMethod {
    ...
    public RichMember call(ApiCaller ac, Deserializer params) throws PerunException {
      ...
      if (!params.contains("userData")) {
        ...
        if (params.contains("guestName")) {
          ...
          if (params.contains("titleBefore")) {
            userData.setTitleBefore(params.readString("titleBefore"));
          }
          if (params.contains("titleAfter")) {
            userData.setTitleAfter(params.readString("titleAfter"));
          }
        } else {
          throw new RpcException(RpcException.Type.MISSING_VALUE,
  ...
  setSponsoredMember {
    ...
    public RichMember call(ApiCaller ac, Deserializer params) throws PerunException {
      ...
      return ac.getMembersManager()
          .setSponsoredMember(ac.getSession(), vo, userToBeSponsored, namespace, password, login, sponsor, validityTo);
    }
  },
  ...
  createSponsoredMembers {
    ...
    public List<Map<String, String>> call(ApiCaller ac, Deserializer params) throws PerunException {
      ...
      if (email == null && sendActivationLink) {
        throw new RpcException(RpcException.Type.MISSING_VALUE,
            "Can't send link for activation when email is missing!");
      }
      User sponsor = null;
  ...
  getSponsoredMembersAndTheirSponsors {
    ...
    public List<MemberWithSponsors> call(ApiCaller ac, Deserializer params) throws PerunException {
      ...
      List<String> attrNames =
          params.contains("attrNames") ? params.readList("attrNames", String.class) : Collections.emptyList();
  ...
  getMembers {
    ...
    public List<Member> call(ApiCaller ac, Deserializer parms) throws PerunException {
      if (parms.contains("status")) {
        return ac.getMembersManager()
            .getMembers(ac.getSession(), ac.getVoById(parms.readInt("vo")), Status.valueOf(parms.readString("status")));
      } else {
  ...
  findMembersByNameInVo {
    ...
    public List<Member> call(ApiCaller ac, Deserializer parms) throws PerunException {
      return ac.getMembersManager()
          .findMembersByNameInVo(ac.getSession(), ac.getVoById(parms.readInt("vo")), parms.readString("searchString"));
    }
  },
  ...
  findMembersInGroup {
    @Override
    public List<Member> call(ApiCaller ac, Deserializer parms) throws PerunException {
      return ac.getMembersManager().findMembersInGroup(ac.getSession(), ac.getGroupById(parms.readInt("group")),
  ...
  findMembersInParentGroup {
    @Override
    public List<Member> call(ApiCaller ac, Deserializer parms) throws PerunException {
      return ac.getMembersManager().findMembersInParentGroup(ac.getSession(), ac.getGroupById(parms.readInt("group")),
          parms.readString("searchString"));
    }
  },
  ...
  findRichMembersInGroup {
    ...
    public List<RichMember> call(ApiCaller ac, Deserializer parms) throws PerunException {
      return ac.getMembersManager()
          .findRichMembersWithAttributesInGroup(ac.getSession(), ac.getGroupById(parms.readInt("group")),
              parms.readString("searchString"));
    }
  },
  ...
  findRichMembersInParentGroup {
    ...
    public List<RichMember> call(ApiCaller ac, Deserializer parms) throws PerunException {
      return ac.getMembersManager()
          .findRichMembersWithAttributesInParentGroup(ac.getSession(), ac.getGroupById(parms.readInt("group")),
              parms.readString("searchString"));
    }
  },
  ...
  findMembersInVo {
    ...
    public List<Member> call(ApiCaller ac, Deserializer parms) throws PerunException {
      return ac.getMembersManager()
          .findMembersInVo(ac.getSession(), ac.getVoById(parms.readInt("vo")), parms.readString("searchString"));
    }
  },
  ...
  findRichMembersInVo {
    ...
    public List<RichMember> call(ApiCaller ac, Deserializer parms) throws PerunException {
      return ac.getMembersManager()
          .findRichMembersInVo(ac.getSession(), ac.getVoById(parms.readInt("vo")), parms.readString("searchString"));
    }
  },
  ...
  findRichMembersWithAttributesInVo {
    ...
    public List<RichMember> call(ApiCaller ac, Deserializer parms) throws PerunException {
      return ac.getMembersManager()
          .findRichMembersWithAttributesInVo(ac.getSession(), ac.getVoById(parms.readInt("vo")),
              parms.readString("searchString"));
    }
  },
    ...
    public Void call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      try {
        ...
        throw new RpcException(RpcException.Type.CANNOT_DESERIALIZE_VALUE,
            "SuspendedTo is not in correct format yyyy-MM-dd and can't be parser correctly!");
      }
  ...
  canBeMember {
    @Override
    public Integer call(ApiCaller ac, Deserializer parms) throws PerunException {
      if (ac.getMembersManager()
          .canBeMember(ac.getSession(), ac.getVoById(parms.readInt("vo")), parms.read("user", User.class),
  ...
  canBeMemberWithReason {
    ...
    public Integer call(ApiCaller ac, Deserializer parms) throws PerunException {
      if (ac.getMembersManager()
          .canBeMemberWithReason(ac.getSession(), ac.getVoById(parms.readInt("vo")), parms.read("user", User.class),
              parms.readString("loa"))) {
        return 1;
      } else {
        return 0;
  ...
  getNewExtendMembership {
    ...
    public String call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      if (parms.contains("member")) {
        Date d =
            ac.getMembersManager().getNewExtendMembership(ac.getSession(), ac.getMemberById(parms.readInt("member")));
        if (d != null) {
