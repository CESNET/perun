...
public enum SecurityTeamsManagerMethod implements ManagerMethod {
  ...
  createSecurityTeam {
    ...
    public SecurityTeam call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      if (parms.contains("securityTeam")) {
        return ac.getSecurityTeamsManager()
            .createSecurityTeam(ac.getSession(), parms.read("securityTeam", SecurityTeam.class));
  ...
  updateSecurityTeam {
    ...
    public SecurityTeam call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      return ac.getSecurityTeamsManager()
          .updateSecurityTeam(ac.getSession(), parms.read("securityTeam", SecurityTeam.class));
    }
  },
    ...
    public Void call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      if (parms.contains("force")) {
        ac.getSecurityTeamsManager()
            .deleteSecurityTeam(ac.getSession(), ac.getSecurityTeamById(parms.readInt("securityTeam")),
    ...
    public List<User> call(ApiCaller ac, Deserializer parms) throws PerunException {
      try {
        if (parms.contains("onlyDirectAdmins")) {
          return AuthzResolver.getAdmins(ac.getSession(), ac.getSecurityTeamById(parms.readInt("securityTeam")),
              Role.SECURITYADMIN, parms.readBoolean("onlyDirectAdmins"));
        } else {
          return AuthzResolver.getAdmins(ac.getSession(), ac.getSecurityTeamById(parms.readInt("securityTeam")),
  ...
  getAdminGroups {
    ...
    public List<Group> call(ApiCaller ac, Deserializer parms) throws PerunException {
      try {
        return AuthzResolver.getAdminGroups(ac.getSession(), ac.getSecurityTeamById(parms.readInt("securityTeam")),
            Role.SECURITYADMIN);
      } catch (RoleCannotBeManagedException ex) {
        throw new InternalErrorException(ex);
      }
  ...
  removeUserFromBlacklist {
    ...
    public Void call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      ac.getSecurityTeamsManager()
          .removeUserFromBlacklist(ac.getSession(), ac.getSecurityTeamById(parms.readInt("securityTeam")),
              ac.getUserById(parms.readInt("user")));
      return null;
    }
  },
  ...
  getBlacklist {
    ...
    public List<User> call(ApiCaller ac, Deserializer parms) throws PerunException {
      if (parms.contains("facility")) {
        return ac.getSecurityTeamsManager()
            .getBlacklist(ac.getSession(), ac.getFacilityById(parms.readInt("facility")));
      } else {
        return ac.getSecurityTeamsManager()
            .getBlacklist(ac.getSession(), ac.getSecurityTeamById(parms.readInt("securityTeam")));
      }
    }
  },
  ...
  getBlacklistWithDescription {
    ...
    public List<Pair<User, String>> call(ApiCaller ac, Deserializer parms) throws PerunException {
      if (parms.contains("facility")) {
        return ac.getSecurityTeamsManager()
            .getBlacklistWithDescription(ac.getSession(), ac.getFacilityById(parms.readInt("facility")));
      } else {
        return ac.getSecurityTeamsManager()
            .getBlacklistWithDescription(ac.getSession(), ac.getSecurityTeamById(parms.readInt("securityTeam")));
      }
    }
  };
}
