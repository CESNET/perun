  ...
  getVoMembersCountsByStatus {
    ...
    public Map<String, Integer> call(ApiCaller ac, Deserializer parms) throws PerunException {
      Map<Status, Integer> counts =
          ac.getVosManager().getVoMembersCountsByStatus(ac.getSession(), ac.getVoById(parms.readInt("vo")));
    ...
    public List<User> call(ApiCaller ac, Deserializer parms) throws PerunException {
      try {
        if (parms.contains("role")) {
          ...
          return AuthzResolver.getAdmins(ac.getSession(), ac.getVoById(parms.readInt("vo")), roleName,
