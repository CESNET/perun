...
public enum NotificationManagerMethod implements ManagerMethod {
  ...
  createPerunNotifReceiver {
    ...
    public PerunNotifReceiver call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      if (parms.contains("receiver")) {
        ...
        throw new RpcException("Parameters missing",
            "Parameter 'receiver' or parameters 'locale', 'target', 'type', 'templateId' not provided.");
      }
    }
  },
  ...
  updatePerunNotifReceiver {
    ...
    public PerunNotifReceiver call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      if (parms.contains("receiver")) {
        return ac.getNotificationManager()
            .updatePerunNotifReceiver(ac.getSession(), parms.read("receiver", PerunNotifReceiver.class));
      } else {
  ...
  createPerunNotifRegex {
    ...
    public PerunNotifRegex call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      return ac.getNotificationManager()
          .createPerunNotifRegex(ac.getSession(), parms.read("regex", PerunNotifRegex.class));
    }
  },
  ...
  updatePerunNotifRegex {
    ...
    public PerunNotifRegex call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      if (parms.contains("regex")) {
        return ac.getNotificationManager()
            .updatePerunNotifRegex(ac.getSession(), parms.read("regex", PerunNotifRegex.class));
      } else {
  ...
  saveTemplateRegexRelation {
    ...
    public Void call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      ac.getNotificationManager()
          .saveTemplateRegexRelation(ac.getSession(), parms.readInt("templateId"), parms.readInt("regexId"));
      return null;
    }
  },
  ...
  removePerunNotifTemplateRegexRelation {
    ...
    public Void call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      ac.getNotificationManager().removePerunNotifTemplateRegexRelation(ac.getSession(), parms.readInt("templateId"),
          parms.readInt("regexId"));
      return null;
    }
  },
  ...
  createPerunNotifTemplateMessage {
    ...
    public PerunNotifTemplateMessage call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      return ac.getNotificationManager()
          .createPerunNotifTemplateMessage(ac.getSession(), parms.read("message", PerunNotifTemplateMessage.class));
    }
  },
  ...
  updatePerunNotifTemplateMessage {
    ...
    public PerunNotifTemplateMessage call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      if (parms.contains("message")) {
        return ac.getNotificationManager()
            .updatePerunNotifTemplateMessage(ac.getSession(), parms.read("message", PerunNotifTemplateMessage.class));
      } else {
  ...
  createPerunNotifTemplate {
    ...
    public PerunNotifTemplate call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      return ac.getNotificationManager()
          .createPerunNotifTemplate(ac.getSession(), parms.read("template", PerunNotifTemplate.class));
    }
  },
  ...
  updatePerunNotifTemplate {
    ...
    public PerunNotifTemplate call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      if (parms.contains("template")) {
        return ac.getNotificationManager()
            .updatePerunNotifTemplate(ac.getSession(), parms.read("template", PerunNotifTemplate.class));
      } else {
