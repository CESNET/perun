		...
		public List<User> call(ApiCaller ac, Deserializer parms) throws PerunException {
			if (parms.contains("attributeName")) {
				if (parms.contains("attributeValue")) {
					...
					} else if(attr.getType().equals(String.class.getName()) || attr.getType().equals("java.lang.LargeString")) {
					...
					} else if(attr.getType().equals(ArrayList.class.getName()) || attr.getType().equals("java.util.LargeArrayList")) {
