...
public enum AuthzResolverMethod implements ManagerMethod {
  ...
  getUserRoleNames {
    @Override
    public List<String> call(ApiCaller ac, Deserializer parms) throws PerunException {
      List<String> roles = cz.metacentrum.perun.core.api.AuthzResolver.getUserRoleNames(ac.getSession(),
  ...
  getGroupRoleNames {
    @Override
    public List<String> call(ApiCaller ac, Deserializer parms) throws PerunException {
      List<String> roles = cz.metacentrum.perun.core.api.AuthzResolver.getGroupRoleNames(ac.getSession(),
   ...
   *  (supported object types: Group | RichGroup | Vo | Resource | Facility).
   ...
   * RESOURCEADMIN | RESOURCESELFSERVICE | SPONSOR | TOPGROUPCREATOR | GROUPCREATOR | VOADMIN | VOOBSERVER |
   * PERUNOBSERVER | CABINETADMIN | AUDITCONSUMERADMIN )
   ...
   * RichGroup | Vo | Resource | Facility).
   * @exampleParam role "VOADMIN"
   ...
   * Group | RichGroup | Vo | Resource | Facility).
   * @exampleParam role "VOADMIN"
   * @exampleParam complementaryObjects [ { "id" : 123 , "name" : "My testing VO" , "shortName" : "test_vo" ,
   * "beanName" : "Vo" } , {...} , {...} ]
   */
