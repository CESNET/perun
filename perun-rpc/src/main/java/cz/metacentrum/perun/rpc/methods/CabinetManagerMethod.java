...
public enum CabinetManagerMethod implements ManagerMethod {
  ...
  createPublicationSystem {
    public PublicationSystem call(ApiCaller ac, Deserializer parms) throws PerunException {
      ...
      return ac.getCabinetManager()
          .createPublicationSystem(ac.getSession(), parms.read("pubsys", PublicationSystem.class));
    }
  },
  ...
  updatePublicationSystem {
    public PublicationSystem call(ApiCaller ac, Deserializer parms) throws PerunException {
      parms.stateChangingCheck();
      return ac.getCabinetManager()
          .updatePublicationSystem(ac.getSession(), parms.read("pubsys", PublicationSystem.class));
    }
  },
  ...
  deleteAuthorship {
    public Void call(ApiCaller ac, Deserializer parms) throws PerunException {
      parms.stateChangingCheck();
      Authorship authorship = ac.getCabinetManager()
          .getAuthorshipByUserAndPublicationId(parms.readInt("userId"), parms.readInt("publicationId"));
  ...
  createPublication {
    public Publication call(ApiCaller ac, Deserializer parms) throws PerunException, CabinetException {
      ...
      Publication returnedPub =
          ac.getCabinetManager().createPublication(ac.getSession(), parms.read("publication", Publication.class));
  ...
  findExternalPublications {
    public List<Publication> call(ApiCaller ac, Deserializer parms) throws PerunException, CabinetException {
      return ac.getCabinetManager()
          .findExternalPublications(ac.getSession(), parms.readInt("user"), parms.readInt("yearSince"),
              parms.readInt("yearTill"), parms.readString("pubSysNamespace"));
    }
  },
