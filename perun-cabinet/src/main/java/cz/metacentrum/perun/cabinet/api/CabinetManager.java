...
public interface CabinetManager {
  ...
  /**
   * Delete publication by its ID. Only author of the record or CabinetAdmin can do this. - Author deletes authorships
   * and thanks from publication. - CabinetAdmin also delete publication record.
   *
  ...
  /**
   * Finds publications of perun's user specified in param Search is done in external publication systems (MU, ZCU) All
   ...
   * @throws CabinetException
   */
  List<Publication> findExternalPublications(PerunSession sess, int userId, int yearSince, int yearTill,
   ...
   * @throws InternalErrorException When implementation fails
   */
  PublicationSystem updatePublicationSystem(PerunSession session, PublicationSystem ps)
      throws CabinetException, PrivilegeException;
