        ...
        if (data.errorId) {
            switch (data.name) {
                ...
                case "TimestampExceetedMaxAgeException":
                    (staticMessager.newMessage("Link has expired", "Please continue to <a href='subscribe.html'>Elixir mailing list Manager</a> and send a new subscription request", "danger", $("#messager"), false)).draw();
                    break;
                case "AlreadyMemberException":
                    (staticMessager.newMessage("User is already subscribed", "to mailing list bioinfo-cz@elixir-czech.cz", "success", $("#messager"), false)).draw();
                    break;
                default :
            ...
            (staticMessager.newMessage("Your email was successfully subscribed", "to mailing list bioinfo-cz@elixir-czech.cz", "success", $("#messager"), false)).draw();
        }
    });
