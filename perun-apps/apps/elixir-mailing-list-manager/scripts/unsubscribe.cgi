...
my $parametersRegExp = '^([-_A-Za-z0-9+]+(\.[-_A-Za-z0-9]+)*@[-A-Za-z0-9]+(\.[-A-Za-z0-9]+)*(\.[A-Za-z]{2,})) info@elixir-czech.cz ([0-9]+)$';
...
You have been unsubscribed as a receiver of the information mailing list of the Czech ELIXIR node.
