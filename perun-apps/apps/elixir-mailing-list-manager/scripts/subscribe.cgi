...
my $mailingList = 'info@elixir-czech.cz';
...
my $parametersRegExp = '^[a-zA-Z ]+\|[a-zA-Z ]+\|([-_A-Za-z0-9+]+(\.[-_A-Za-z0-9]+)*@[-A-Za-z0-9]+(\.[-A-Za-z0-9]+)*(\.[A-Za-z]{2,}))\|info@elixir-czech.cz\|([0-9]+)$';
...
print MAIL "Subject: Mailing list INFO--ELIXIR CZ\n\n";
#Email Body
print MAIL qq{Dear user,

You have been enrolled as a receiver of the information mailing list of the Czech ELIXIR node.
