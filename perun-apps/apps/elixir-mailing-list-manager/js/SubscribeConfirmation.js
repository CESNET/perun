        ...
        if (data.errorId) {
            switch (data.name) {
                ...
                case "AlreadyMemberException":
                    (staticMessager.newMessage("User is already subscribed", "to mailing list info@elixir-czech.cz", "success", $("#messager"), false)).draw();
                    break;
                default :
            ...
            (staticMessager.newMessage("Your email was successfully subscribed", "to mailing list info@elixir-czech.cz", "success", $("#messager"), false)).draw();
        }
    });
