...
public class Publication implements Serializable {
	...
	public String toString() {		
		return getClass().getSimpleName()+":[id=" + id + ", externalId=" + externalId + ", pubSysId=" + publicationSystemId + ", title=" + title + ", categoryId=" + categoryId + ", year=" + year + ", isbn=" + isbn + ", doi=" + doi + ", locked=" + locked + ", main=" + main + ", createdBy=" + createdBy + ", createdDate=" + createdDate + ", rank=" + rank + ", authors=" + authors + "]";
	}
