...
public class ServiceProviderConfiguration {
  ...
  public boolean equals(Object o) {
    ...
    if (getDocumentationUrl() != null ? !getDocumentationUrl().equals(that.getDocumentationUrl()) :
        that.getDocumentationUrl() != null) {
      return false;
    }
    if (getPatch() != null ? !getPatch().equals(that.getPatch()) : that.getPatch() != null) {
      return false;
    }
    if (getBulk() != null ? !getBulk().equals(that.getBulk()) : that.getBulk() != null) {
      return false;
    }
    if (getFilter() != null ? !getFilter().equals(that.getFilter()) : that.getFilter() != null) {
      return false;
    }
    if (getChangePassword() != null ? !getChangePassword().equals(that.getChangePassword()) :
        that.getChangePassword() != null) {
      return false;
    }
    ...
    if (getXmlDataFormat() != null ? !getXmlDataFormat().equals(that.getXmlDataFormat()) :
        that.getXmlDataFormat() != null) {
      return false;
    }
    return getAuthenticationSchemes() != null ? getAuthenticationSchemes().equals(that.getAuthenticationSchemes()) :
        that.getAuthenticationSchemes() == null;
