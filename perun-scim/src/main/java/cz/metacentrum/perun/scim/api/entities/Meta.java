...
public class Meta {
  ...
  public boolean equals(Object o) {
    ...
    if (getResourceType() != null ? !getResourceType().equals(meta.getResourceType()) :
        meta.getResourceType() != null) {
      return false;
    }
    if (getCreated() != null ? !getCreated().equals(meta.getCreated()) : meta.getCreated() != null) {
      return false;
    }
    if (getLastModified() != null ? !getLastModified().equals(meta.getLastModified()) :
