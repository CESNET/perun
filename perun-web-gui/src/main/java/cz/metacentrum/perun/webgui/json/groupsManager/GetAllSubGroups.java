 ...
 */
public class GetAllSubGroups implements JsonCallback, JsonCallbackTable<Group>, JsonCallbackOracle<Group> {

  // JSON URL
  static private final String JSON_URL = "groupsManager/getAllSubGroups";
  // Selection model
   ...
   */
  public GetAllSubGroups(int id, JsonCallbackEvents events) {
    this.groupId = id;
    this.events = events;
  }
