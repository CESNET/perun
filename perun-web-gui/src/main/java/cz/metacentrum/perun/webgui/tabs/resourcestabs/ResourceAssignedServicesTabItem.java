...
public class ResourceAssignedServicesTabItem implements TabItem, TabItemWithUrl {
  ...
  public Widget draw() {
    ...
    CustomButton assignServicesButton =
        TabMenu.getPredefinedButton(ButtonType.ADD, true, ButtonTranslation.INSTANCE.assignServiceToResource(),
            new ClickHandler() {
    ...
    final CustomButton removeServicesButton =
        TabMenu.getPredefinedButton(ButtonType.REMOVE, ButtonTranslation.INSTANCE.removeServiceFromResource());
        ...
        UiElements.showDeleteConfirm(servicesForRemoving, text, new ClickHandler() {
          ...
          public void onClick(ClickEvent clickEvent) {
            RemoveServices request =
                new RemoveServices(JsonCallbackEvents.disableButtonEvents(removeServicesButton, localEvents));
