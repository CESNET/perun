...
public class AssignServiceTabItem implements TabItem {
  ...
  public Widget draw() {
    ...
    final CustomButton assignButton =
        TabMenu.getPredefinedButton(ButtonType.ADD, ButtonTranslation.INSTANCE.assignSelectedServicesToResource());
      ...
      public void onClick(ClickEvent event) {
        ...
        if (UiElements.cantSaveEmptyListDialogBox(servicesToAssign)) {
          AssignServices request =
              new AssignServices(JsonCallbackEvents.closeTabDisableButtonEvents(assignButton, tab, true));
