 ...
 */
public class GetAttributesDefinition
    implements JsonCallback, JsonCallbackTable<AttributeDefinition>, JsonCallbackOracle<AttributeDefinition> {

  // Selection model
  final MultiSelectionModel<AttributeDefinition> selectionModel =
      new MultiSelectionModel<AttributeDefinition>(new GeneralKeyProvider<AttributeDefinition>());
  ...
  public CellTable<AttributeDefinition> getTable() {
    ...
    final Column<AttributeDefinition, AttributeDefinition> friendlyNameColumn = JsonUtils.addColumn(
        new PerunAttributeFriendlyNameCell((tableFieldUpdater != null) ? "customClickableTextCell" : ""),
    ...
    // DESCRIPTION COLUMN
    final Column<AttributeDefinition, String> descriptionColumn =
        new Column<AttributeDefinition, String>(new TextInputCell()) {
    ...
    // DISPLAY NAME COLUMN
    final Column<AttributeDefinition, String> displayNameColumn =
        new Column<AttributeDefinition, String>(new TextInputCell()) {
          public String getValue(AttributeDefinition attrDef) {
