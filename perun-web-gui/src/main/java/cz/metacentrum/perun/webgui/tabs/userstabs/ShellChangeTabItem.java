    ...
    selectShellButton.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent event) {
        ...
        SetAttribute request =
            new SetAttribute(JsonCallbackEvents.disableButtonEvents(selectShellButton, new JsonCallbackEvents() {
              @Override
              public void onFinished(JavaScriptObject jso) {
    ...
    defaultButton.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent event) {
        ...
        RemoveAttributes request =
            new RemoveAttributes(JsonCallbackEvents.disableButtonEvents(defaultButton, new JsonCallbackEvents() {
              @Override
              public void onFinished(JavaScriptObject jso) {
                // refresh only what's necessary
                events.onFinished(jso);
