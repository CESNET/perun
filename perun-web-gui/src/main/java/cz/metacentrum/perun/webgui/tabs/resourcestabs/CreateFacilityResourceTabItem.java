    ...
    createButton.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent event) {
        ...
        JsonCallbackEvents localEvents = new JsonCallbackEvents() {
          ...
          public void onFinished(JavaScriptObject jso) {
            ...
            session.getTabManager()
                .addTabToCurrentTab(new CreateFacilityResourceManageServicesTabItem(facility, res), true);
          }
        ...
        if (validator.validateTextBox()) {
          ...
          request.createResource(nameTextBox.getTextBox().getText().trim(), descriptionTextBox.getText().trim(),
              facility.getId(), vosDropDown.getSelectedObject().getId());
        }
      }
    });
