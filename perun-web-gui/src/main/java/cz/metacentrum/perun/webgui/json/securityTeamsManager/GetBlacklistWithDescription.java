 ...
 */
public class GetBlacklistWithDescription
    implements JsonCallback, JsonCallbackTable<Pair<User, String>>, JsonCallbackOracle<Pair<User, String>> {

  // Selection model
  final MultiSelectionModel<Pair<User, String>> selectionModel =
      new MultiSelectionModel<Pair<User, String>>(new PairKeyProvider<User, String>());
  // JSON URL
  ...
  public CellTable<Pair<User, String>> getTable() {
    ...
    Column<Pair<User, String>, String> nameColumn =
        JsonUtils.addColumn(new CustomClickableTextCell(), new JsonUtils.GetValue<Pair<User, String>, String>() {
          @Override
          public String getValue(Pair<User, String> object) {
