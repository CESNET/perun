 ...
 */
public class GetRichTaskResultsByTaskAndDestination
    implements JsonCallback, JsonCallbackTable<TaskResult>, JsonCallbackOracle<TaskResult> {
  // JSON URL
  static private final String JSON_URL = "tasksManager/getTaskResultsForGUIByTaskAndDestination";
  // Selection model
  final MultiSelectionModel<TaskResult> selectionModel =
      new MultiSelectionModel<TaskResult>(new GeneralKeyProvider<TaskResult>());
  // Session
  ...
  public CellTable<TaskResult> getEmptyTable() {
    ...
    // Sorting
    ColumnSortEvent.ListHandler<TaskResult> columnSortHandler =
        new ColumnSortEvent.ListHandler<TaskResult>(dataProvider.getList());
