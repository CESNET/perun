...
public class FacilityDetailTabItem implements TabItem, TabItemWithUrl {
  ...
  public Widget draw() {
    ...
    if (JsonUtils.isExtendedInfoVisible()) {
      menu.setHTML(0, column,
          "<strong>ID:</strong><br/><span class=\"inputFormInlineComment\">" + facility.getId() + "</span>");
      column++;
      menu.setHTML(0, column, "&nbsp;");
      menu.getFlexCellFormatter().setWidth(0, column, "25px");
      column++;
    ...
    menu.setHTML(0, column, "<strong>Description:</strong><br/><span class=\"inputFormInlineComment\">" +
        SafeHtmlUtils.fromString((facility.getDescription() != null) ? facility.getDescription() : "").asString() +
        "&nbsp;</span>");
