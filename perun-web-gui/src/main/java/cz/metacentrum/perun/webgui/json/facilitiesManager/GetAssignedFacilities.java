...
public class GetAssignedFacilities implements JsonCallback, JsonCallbackTable<Facility> {
  ...
  final MultiSelectionModel<Facility> selectionModel =
      new MultiSelectionModel<Facility>(new GeneralKeyProvider<Facility>());
  ...
  public void onLoadingStart() {
    session.getUiElements()
        .setLogText("Loading assigned facilities for " + type.toString() + " id: " + typeId + " started.");
  ...
  public void onFinished(JavaScriptObject jso) {
    ...
    sortTable();
    session.getUiElements().setLogText(
        "Loading assigned facilities for " + type.toString() + " id: " + typeId + " finished: " + list.size());
