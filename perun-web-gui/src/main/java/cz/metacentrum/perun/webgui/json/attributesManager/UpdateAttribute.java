    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      public void onError(PerunError error) {
        session.getUiElements()
            .setLogErrorText("Updating attribute definition: " + attributeDefinition.getDisplayName() + " failed.");
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements().setLogSuccessText(
            "Attribute definition: " + attributeDefinition.getDisplayName() + " successfully updated.");
