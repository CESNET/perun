...
public class GetAllowedResources implements JsonCallback, JsonCallbackTable<Resource> {
	...
	private int userId;
	// JSON URL
	static private final String JSON_URL = "usersManager/getAllowedResources";
	// Selection model
	...
	public void onError(PerunError error) {
		session.getUiElements().setLogErrorText("Error while loading users resources.");
	...
	public void onLoadingStart() {
		session.getUiElements().setLogText("Loading users resources started.");
