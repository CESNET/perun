...
public class AssignGroupTabItem implements TabItem {
  ...
  public Widget draw() {
    ...
    final CustomButton assignButton =
        TabMenu.getPredefinedButton(ButtonType.ADD, ButtonTranslation.INSTANCE.assignGroupToSelectedResources());
      ...
      public void onClick(ClickEvent event) {
        ...
        if (UiElements.cantSaveEmptyListDialogBox(toAssign)) {
          AssignGroupToResources request =
              new AssignGroupToResources(JsonCallbackEvents.disableButtonEvents(assignButton, new JsonCallbackEvents() {
                @Override
                public void onFinished(JavaScriptObject jso) {
