...
public class CreateSecurityTeamTabItem implements TabItem {
  ...
  public Widget draw() {
    ...
    final CustomButton createButton =
        TabMenu.getPredefinedButton(ButtonType.CREATE, buttonTranslation.createSecurityTeam());
    createButton.addClickHandler(new ClickHandler() {
      public void onClick(ClickEvent event) {
        ...
        CreateSecurityTeam request = new CreateSecurityTeam(
            JsonCallbackEvents.closeTabDisableButtonEvents(createButton, tab, true, new JsonCallbackEvents() {
              @Override
        ...
        request.createSecurityTeam(nameTextBox.getTextBox().getText().trim(),
            descriptionTextBox.getTextBox().getText().trim());
      }
    });
