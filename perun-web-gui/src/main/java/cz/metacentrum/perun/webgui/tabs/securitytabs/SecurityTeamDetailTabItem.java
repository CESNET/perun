...
public class SecurityTeamDetailTabItem implements TabItem, TabItemWithUrl {
  ...
  public Widget draw() {
    ...
    CustomButton change =
        new CustomButton("", "Edit SecurityTeam details", SmallIcons.INSTANCE.applicationFormEditIcon());
    ...
    if (JsonUtils.isExtendedInfoVisible()) {
      menu.setHTML(0, column,
          "<strong>ID:</strong><br/><span class=\"inputFormInlineComment\">" + securityTeam.getId() + "</span>");
      column++;
      menu.setHTML(0, column, "&nbsp;");
      menu.getFlexCellFormatter().setWidth(0, column, "25px");
      column++;
    ...
    menu.setHTML(0, column, "<strong>Description:</strong><br/><span class=\"inputFormInlineComment\">" +
        SafeHtmlUtils.fromString((securityTeam.getDescription() != null) ? securityTeam.getDescription() : "")
            .asString() + "</span>");
