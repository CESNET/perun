...
public class AddExtSource {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onError(PerunError error) {
        session.getUiElements()
            .setLogErrorText("Adding external source: " + extSourceId + " to VO: " + voId + " failed.");
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("External source: " + extSourceId + " successfully added to Vo: " + voId);
  ...
  public void addGroupExtSource(final int groupId, final int extSourceId) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onError(PerunError error) {
        session.getUiElements()
            .setLogErrorText("Adding external source: " + extSourceId + " to group: " + groupId + " failed.");
        events.onError(error);
      }
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("External source: " + extSourceId + " successfully added to group: " + groupId);
        events.onFinished(jso);
      }
