...
public class GetFacilityAssignedServicesForGUI implements JsonCallback, JsonCallbackTable<RichService> {
  ...
  // JSON URL
  static private final String JSON_URL = "servicesManager/getFacilityAssignedServicesForGUI";
  // Selection model
  final MultiSelectionModel<RichService> selectionModel =
      new MultiSelectionModel<RichService>(new GeneralKeyProvider<RichService>());
  // Session
  ...
  public CellTable<RichService> getTable() {
    ...
    Column<RichService, String> allowedGloballyColumn =
        JsonUtils.addColumn(new JsonUtils.GetValue<RichService, String>() {
          public String getValue(RichService object) {
            String send = "";
