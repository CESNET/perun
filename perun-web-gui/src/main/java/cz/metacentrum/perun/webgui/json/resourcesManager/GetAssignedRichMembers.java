...
public class GetAssignedRichMembers implements JsonCallback, JsonCallbackTable<RichMember> {
  ...
  // Selection model
  final MultiSelectionModel<RichMember> selectionModel =
      new MultiSelectionModel<RichMember>(new GeneralKeyProvider<RichMember>());
  final SingleSelectionModel<RichMember> singleSelectionModel =
      new SingleSelectionModel<RichMember>(new GeneralKeyProvider<RichMember>());
