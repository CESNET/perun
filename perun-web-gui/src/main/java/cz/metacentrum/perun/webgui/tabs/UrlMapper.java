...
public class UrlMapper {
   ...
   * @return
   */
  static public <T extends JavaScriptObject> ArrayList<T> parseListFromUrl(String paramName, PerunEntity entity,
   ...
   * @param list
   */
  static private <T extends JavaScriptObject> void addEntityToList(PerunEntity entity, int id, final int i,
  ...
  private boolean parseTab(String tabString) {
    ...
    try {
      ...
      UiElements.generateAlert("URL parsing error",
          "This tab couldn't be opened: " + tabPackage + " / " + tabName + ". ");
      GWT.log(e.toString());
    }
