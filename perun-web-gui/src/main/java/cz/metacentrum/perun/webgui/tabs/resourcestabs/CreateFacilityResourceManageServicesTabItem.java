...
public class CreateFacilityResourceManageServicesTabItem implements TabItem {
  ...
  public Widget draw() {
    ...
    final CustomButton assignButton =
        TabMenu.getPredefinedButton(ButtonType.ADD, "Assign selected service to resource");
    final CustomButton removeButton =
        TabMenu.getPredefinedButton(ButtonType.REMOVE, "Remove selected service from resource");
    CustomButton finishButton =
        TabMenu.getPredefinedButton(ButtonType.FINISH, "Finishes services assigning and configuration");
    ...
    assignButton.addClickHandler(new ClickHandler() {
      public void onClick(ClickEvent event) {
        ...
        AssignServices request =
            new AssignServices(JsonCallbackEvents.disableButtonEvents(assignButton, new JsonCallbackEvents() {
              @Override
              public void onFinished(JavaScriptObject jso) {
    ...
    removeButton.addClickHandler(new ClickHandler() {
      public void onClick(ClickEvent event) {
        ...
        RemoveServices request =
            new RemoveServices(JsonCallbackEvents.disableButtonEvents(removeButton, new JsonCallbackEvents() {
              @Override
              public void onFinished(JavaScriptObject jso) {
