...
/**
 * The list of assigned SecurityTeams
 *
 * @author Pavel Zlámal <zlamal@cesnet.cz>
 */
public class GetAssignedSecurityTeams
    implements JsonCallback, JsonCallbackTable<SecurityTeam>, JsonCallbackOracle<SecurityTeam> {

  // Selection model
  final MultiSelectionModel<SecurityTeam> selectionModel =
      new MultiSelectionModel<SecurityTeam>(new GeneralKeyProvider<SecurityTeam>());
  // JSON URL
  private final String JSON_URL = "facilitiesManager/getAssignedSecurityTeams";
  // session
   ...
   * @param facilityId
   */
  public GetAssignedSecurityTeams(int facilityId) {
   ...
   */
  public GetAssignedSecurityTeams(int facilityId, JsonCallbackEvents events) {
    this.facilityId = facilityId;
    this.events = events;
  }
  ...
  public CellTable<SecurityTeam> getTable() {
    ...
    loaderImage.setEmptyResultMessage("Facility has no Security team assigned.");
