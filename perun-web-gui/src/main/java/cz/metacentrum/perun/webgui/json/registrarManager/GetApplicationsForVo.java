 ...
 */
public class GetApplicationsForVo
    implements JsonCallback, JsonCallbackTable<Application>, JsonCallbackOracle<Application> {

  // JSON URL
  static private final String JSON_URL = "registrarManager/getApplicationsForVo";
  // Selection model
    ...
    Column<Application, String> extSourceColumn = JsonUtils.addColumn(
        ...
        new JsonUtils.GetValue<Application, String>() {
          public String getValue(Application object) {
            ...
            return Utils.convertCertCN(object.getCreatedBy()) + " / " +
                Utils.translateIdp(Utils.convertCertCN(object.getExtSourceName()));
          }
        }, tableFieldUpdater);
    ...
    columnSortHandler.setComparator(extSourceColumn, new Comparator<Application>() {
      public int compare(Application arg0, Application arg1) {
        ...
        if (arg0.getUser() != null) {
          ...
          compare1 = Utils.convertCertCN(arg0.getCreatedBy()) + " / " +
              Utils.translateIdp(Utils.convertCertCN(arg0.getExtSourceName()));
        }
        if (arg1.getUser() != null) {
          compare2 = arg1.getUser().getFullName();
        } else {
          compare2 = Utils.convertCertCN(arg1.getCreatedBy()) + " / " +
              Utils.translateIdp(Utils.convertCertCN(arg1.getExtSourceName()));
        }
  ...
  public void filterTable(String filter) {
    ...
    if (list.isEmpty() && !filter.isEmpty()) {
      loaderImage.setEmptyResultMessage(
          "No applications with username matching '" + filter + "' found for this VO or it's groups.");
    } else {
      loaderImage.setEmptyResultMessage("No applications matching search criteria found for this VO or it's groups.");
    }
