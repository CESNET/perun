...
public class AddAuthorTabItem implements TabItem, TabItemWithUrl {
  ...
  public Widget draw() {
    ...
    final CustomButton addButton = TabMenu.getPredefinedButton(ButtonType.ADD,
        "Add selected user(s) as author(s) of publication: " + publication.getTitle());
        ...
        if (UiElements.cantSaveEmptyListDialogBox(list)) {
          ...
          for (int i = 0; i < list.size(); i++) {
            ...
            CreateAuthorship request =
                new CreateAuthorship(JsonCallbackEvents.disableButtonEvents(addButton, authorshipEvents));
