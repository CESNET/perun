...
public class CreateAttribute {
   ...
   */
  public void createAttributeDefinition(final String displayName, final String friendlyName, final String description,
                                        final String namespace, final String type, final boolean unique) {
