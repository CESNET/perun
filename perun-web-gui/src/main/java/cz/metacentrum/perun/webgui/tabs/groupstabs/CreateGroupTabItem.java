      ...
      public void onClick(ClickEvent event) {
        ...
        if (asSubGroup.getValue()) {
          if (vosGroups.getSelectedObject() != null) {
            cg.createGroupInGroup(vosGroups.getSelectedObject().getId(), groupNameTextBox.getTextBox().getText().trim(),
                groupDescriptionTextBox.getText().trim());
          } else {
          ...
          cg.createGroupInVo(voId, groupNameTextBox.getTextBox().getText().trim(),
              groupDescriptionTextBox.getText().trim());
        }
      }
    });
