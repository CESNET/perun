...
public class AddMemberToVoTabItem implements TabItem, TabItemWithUrl {
  ...
  public Widget draw() {
    ...
    addCandidatesButton =
        TabMenu.getPredefinedButton(ButtonType.ADD, ButtonTranslation.INSTANCE.addSelectedCandidateToVo());
    ...
    JsonCallbackEvents selectOneEvent =
        JsonCallbackEvents.mergeEvents(JsonCallbackEvents.disableButtonEvents(searchButton), new JsonCallbackEvents() {
          @Override
          public void onFinished(JavaScriptObject jso) {
        ...
        if (candidateToBeAdded == null) {
          ...
          if (candidateToBeAdded.getCandidate() != null) {
            ...
            CreateMember request =
                new CreateMember(JsonCallbackEvents.disableButtonEvents(addCandidatesButton, new JsonCallbackEvents() {
