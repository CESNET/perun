  ...
  public Widget draw() {
    ...
    moveButton.addClickHandler(new ClickHandler() {
      public void onClick(ClickEvent event) {
        ...
        final JsonCallbackEvents nextEvent =
            JsonCallbackEvents.disableButtonEvents(moveButton, new JsonCallbackEvents() {
              int groupsCounter = 0;
    ...
    layout.setHTML(3, 0,
        "Group(s) will be moved (including all their sub-groups) under destination group! If no destination group is selected, group will be moved to top-level.<p>We strongly recommend to move groups one by one.");
