...
public class GetCategories implements JsonCallback, JsonCallbackTable<Category> {
  ...
  // Selection model
  final MultiSelectionModel<Category> selectionModel =
      new MultiSelectionModel<Category>(new GeneralKeyProvider<Category>());
  // session
          ...
          public void update(int index, Category object, String newText) {
            ...
            try {
              ...
              session.getUiElements()
                  .setLogErrorText("Rank mismatch for category: " + object.getName() + " and value: " + newText);
            }
          }
        });
