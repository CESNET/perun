...
public class CreatePublication {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onError(PerunError error) {
        session.getUiElements()
            .setLogErrorText("Creating publicaton ext.ID: " + publication.getExternalId() + " failed.");
   ...
   * @param main
   */
  public void createPublication(final String title, final int category, final int year, final String ISBN,
                                final String doi, final String main) {
