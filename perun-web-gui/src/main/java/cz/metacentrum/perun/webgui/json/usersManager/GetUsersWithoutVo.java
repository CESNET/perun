 ...
 */
@Deprecated
public class GetUsersWithoutVo implements JsonCallback, JsonCallbackTable<User> {

	// session
	private PerunWebSession session = PerunWebSession.getInstance();
	// json url
	static private final String JSON_URL = "usersManager/getUsersWithoutVoAssigned";
	// Data provider
	 ...
	 */
	public GetUsersWithoutVo() {}

	/**
	 * Creates a new request with custom events
	 * @param events
	 */
	public GetUsersWithoutVo(JsonCallbackEvents events) {
		this.events = events;
	}
