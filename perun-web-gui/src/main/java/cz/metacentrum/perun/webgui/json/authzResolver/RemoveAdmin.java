...
public class RemoveAdmin {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("User " + user.getFullName() + " removed from managers of " + group.getName());
  ...
  public void removeVoAdmin(final VirtualOrganization vo, final User user) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("User " + user.getFullName() + " removed from managers of " + vo.getName());
        events.onFinished(jso);
      }
  ...
  public void removeFacilityAdmin(final Facility facility, final User user) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("User " + user.getFullName() + " removed form managers of " + facility.getName());
        events.onFinished(jso);
      }
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements().setLogSuccessText(
            "Group " + group.getShortName() + " removed from managers of " + groupToAddAdminTo.getName());
        events.onFinished(jso);
      }
  ...
  public void removeVoAdminGroup(final VirtualOrganization vo, final Group group) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("Group " + group.getShortName() + " removed from managers of " + vo.getName());
        events.onFinished(jso);
      }
  ...
  public void removeFacilityAdminGroup(final Facility facility, final Group group) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("Group " + group.getShortName() + " removed from managers of " + facility.getName());
        events.onFinished(jso);
      }
