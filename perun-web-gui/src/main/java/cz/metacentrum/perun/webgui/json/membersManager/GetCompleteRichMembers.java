 ...
 */
public class GetCompleteRichMembers
    implements JsonCallback, JsonCallbackTable<RichMember>, JsonCallbackOracle<RichMember> {
  ...
  final MultiSelectionModel<RichMember> selectionModel =
      new MultiSelectionModel<RichMember>(new RichMemberKeyProvider());
  // Session
