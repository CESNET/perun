...
public class RemoveExtSource {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onError(PerunError error) {
        session.getUiElements()
            .setLogErrorText("Removing external source: " + extSourceId + " from VO: " + voId + " failed.");
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("External source: " + extSourceId + " successfully removed from VO: " + voId);
  ...
  public void removeGroupExtSource(final int groupId, final int extSourceId) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onError(PerunError error) {
        session.getUiElements()
            .setLogErrorText("Removing external source: " + extSourceId + " from Group: " + groupId + " failed.");
        events.onError(error);
      }
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("External source: " + extSourceId + " successfully removed from Group: " + groupId);
        events.onFinished(jso);
      }
