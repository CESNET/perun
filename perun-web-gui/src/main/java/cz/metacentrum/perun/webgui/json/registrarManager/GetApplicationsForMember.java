 ...
 */
public class GetApplicationsForMember
  ...
  // Selection model
  final MultiSelectionModel<Application> selectionModel =
      new MultiSelectionModel<Application>(new GeneralKeyProvider<Application>());
  // Session
