...
public class ResourceAssignedGroupsTabItem implements TabItem, TabItemWithUrl {
  ...
  public static final String URL = "manage-groups";
  /**
   * Perun web session
   */
  ...
  public Widget draw() {
    ...
    CustomButton assignGroupButton =
        TabMenu.getPredefinedButton(ButtonType.ADD, true, ButtonTranslation.INSTANCE.assignGroupToResource(),
            new ClickHandler() {
    ...
    final CustomButton removeGroupButton =
        TabMenu.getPredefinedButton(ButtonType.REMOVE, ButtonTranslation.INSTANCE.removeGroupFromResource());
      ...
      public void onClick(ClickEvent event) {
        ...
        UiElements.showDeleteConfirm(groupsForRemoving, text, new ClickHandler() {
          ...
          public void onClick(ClickEvent clickEvent) {
            RemoveGroupsFromResource request =
                new RemoveGroupsFromResource(JsonCallbackEvents.disableButtonEvents(removeGroupButton, localEvents));
