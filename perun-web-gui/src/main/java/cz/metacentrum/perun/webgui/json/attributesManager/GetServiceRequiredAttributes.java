 ...
 */
public class GetServiceRequiredAttributes
  ...
  public CellTable<AttributeDefinition> getTable() {
    ...
    final Column<AttributeDefinition, AttributeDefinition> friendlyNameColumn =
        JsonUtils.addColumn(new PerunAttributeFriendlyNameCell(),
