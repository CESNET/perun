...
public class VoGroupsTabItem implements TabItem, TabItemWithUrl {
  ...
  public Widget draw() {
    ...
    CustomButton createButton =
        TabMenu.getPredefinedButton(ButtonType.CREATE, true, ButtonTranslation.INSTANCE.createGroup(),
            new ClickHandler() {
    ...
    final CustomButton removeButton =
        TabMenu.getPredefinedButton(ButtonType.DELETE, ButtonTranslation.INSTANCE.deleteGroup());
