...
public class Confirm {
   ...
   * @param useIcons           (uses icons in widget) - if no icon set, use default
   */
  public Confirm(String caption, Widget content, ClickHandler okClickHandler, ClickHandler cancelClickHandler,
                 boolean useIcons) {
    this.content = content;
    this.okClickHandler = okClickHandler;
   ...
   */
  public Confirm(String caption, Widget content, ClickHandler okClickHandler, ClickHandler cancelClickHandler,
                 String okButtonText, String cancelButtonText, boolean useIcons) {
    this.content = content;
    this.okButtonText = okButtonText;
  ...
  public void show() {
    ...
    Scheduler.get().scheduleDeferred(new Command() {
      ...
      public void execute() {
        ...
        if ((cancelButton == null && okButton != null) || focusOkButton) {
