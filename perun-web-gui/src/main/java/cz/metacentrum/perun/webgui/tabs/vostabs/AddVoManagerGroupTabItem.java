...
public class AddVoManagerGroupTabItem implements TabItem {
  ...
  private Widget fillGroupsContent(GetAllGroups groups, TabMenu tabMenu,
            ...
            if (!found) {
              ...
              UiElements.generateInfo("You have selected 'all vo members' group",
                  "If this group will be added as 'manager group', all new members of VO " +
                      ...
                      " will be automatically managers of your VO and all removed members will lose management rights.");
            }
            found = true;
            return;
          }
    ...
    final CustomButton addButton =
        TabMenu.getPredefinedButton(ButtonType.ADD, ButtonTranslation.INSTANCE.addSelectedManagersGroupToVo());
