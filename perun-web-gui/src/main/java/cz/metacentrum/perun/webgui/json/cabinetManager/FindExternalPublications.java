...
public class FindExternalPublications implements JsonCallback, JsonCallbackTable<Publication> {
  ...
  public CellTable<Publication> getEmptyTable() {
    ...
    table.setEmptyTableWidget(loaderImage.prepareToSearch(
  ...
  public void retrieveData() {
    ...
    js.retrieveData(JSON_URL,
        "user=" + this.userId + "&yearSince=" + yearSince + "&yearTill=" + yearTill + "&pubSysNamespace=" + namespace,
        this);
    return;
  }
