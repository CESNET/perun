...
public class EditUserDetailsTabItem implements TabItem {
  ...
  public Widget draw() {
    ...
    final CustomButton saveButton =
        TabMenu.getPredefinedButton(ButtonType.SAVE, buttonTranslation.saveResourceDetails());
    ...
    if (session.isPerunAdmin()) {
      ...
      saveButton.addClickHandler(new ClickHandler() {
        public void onClick(ClickEvent event) {
          ...
          UpdateUser request =
              new UpdateUser(JsonCallbackEvents.closeTabDisableButtonEvents(saveButton, tab, true, events));
      ...
      saveButton.addClickHandler(new ClickHandler() {
        public void onClick(ClickEvent event) {
          ...
          u.setTitleBefore(beforeName.getText().trim());
          u.setTitleAfter(afterName.getText().trim());
          UpdateNameTitles request =
              new UpdateNameTitles(JsonCallbackEvents.closeTabDisableButtonEvents(saveButton, tab, true, events));
