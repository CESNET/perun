...
public class EditMailFooterTabItem implements TabItem {
  ...
  public Widget draw() {
    ...
    content.setHTML(2, 0,
        "This text will be added as footer for all email notifications (replacing {mailFooter} tag in mail definition).");
      ...
      public void onClick(ClickEvent clickEvent) {
        ...
        for (Attribute a : list) {
          ...
          if (oldValue.equalsIgnoreCase(newValue) ||
              (oldValue.equalsIgnoreCase("null") && newValue.equalsIgnoreCase(""))) {
        ...
        RemoveAttributes removeRequest =
            new RemoveAttributes(JsonCallbackEvents.closeTabDisableButtonEvents(save, tab, true));
        // send if not empty
        if (!toRemove.isEmpty()) {
