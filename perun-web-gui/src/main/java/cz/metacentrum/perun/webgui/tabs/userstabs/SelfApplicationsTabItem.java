...
public class SelfApplicationsTabItem implements TabItem, TabItemWithUrl {
  ...
  public static final String URL = "appls";
  /**
   * Perun web session
   */
  ...
  public Widget draw() {
    ...
    this.titleWidget.setText(
        Utils.getStrippedStringWithEllipsis(user.getFullNameWithTitles().trim()) + ": Applications");
  ...
  public void open() {
    ...
    session.getUiElements().getBreadcrumbs()
        .setLocation(MainMenu.USER, Utils.getStrippedStringWithEllipsis(user.getFullNameWithTitles().trim()),
            UsersTabs.URL + UrlMapper.TAB_NAME_SEPARATOR + getUrl() + "?id=" + userId, "Applications",
