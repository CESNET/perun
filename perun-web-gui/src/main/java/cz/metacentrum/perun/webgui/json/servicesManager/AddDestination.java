...
public class AddDestination {
	 ...
	 * @param serviceId ID of service to have destination added
	 */
	public AddDestination(int facilityId, int serviceId) {
	 ...
	 */
	public AddDestination(int facilityId, int serviceId, final JsonCallbackEvents events) {
		this.facilityId = facilityId;
		this.serviceId = serviceId;
		this.events = events;
	}
