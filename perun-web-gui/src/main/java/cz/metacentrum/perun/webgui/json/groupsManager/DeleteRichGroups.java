...
public class DeleteRichGroups {
	 ...
	 */
	public DeleteRichGroups(JsonCallbackEvents events) {
		this.events = events;
	}
	 ...
	 */
	public void deleteRichGroups(final ArrayList<RichGroup> groups) {
		deleteRichGroups(groups, true);
	}
	 ...
	 */
	public void deleteRichGroups(final ArrayList<RichGroup> groups, boolean force) {
