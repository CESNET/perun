...
public class EditFacilityDetailsTabItem implements TabItem {
  ...
  public Widget draw() {
    ...
    final CustomButton saveButton =
        TabMenu.getPredefinedButton(ButtonType.SAVE, buttonTranslation.saveFacilityDetails());
    saveButton.addClickHandler(new ClickHandler() {
      public void onClick(ClickEvent event) {
        if (validator.validateTextBox()) {
          ...
          UpdateFacility request =
              new UpdateFacility(JsonCallbackEvents.closeTabDisableButtonEvents(saveButton, tab, true, events));
