...
public class VoResourcesTagsTabItem implements TabItem, TabItemWithUrl {
  ...
  public Widget draw() {
    ...
    CustomButton addButton =
        TabMenu.getPredefinedButton(ButtonType.CREATE, true, ButtonTranslation.INSTANCE.createResourceTag(),
            new ClickHandler() {
    ...
    final CustomButton removeButton =
        TabMenu.getPredefinedButton(ButtonType.DELETE, ButtonTranslation.INSTANCE.deleteResourceTag());
    if (!session.isVoAdmin(voId)) {
    ...
    final CustomButton saveButton =
        TabMenu.getPredefinedButton(ButtonType.SAVE, ButtonTranslation.INSTANCE.updateResourceTag());
