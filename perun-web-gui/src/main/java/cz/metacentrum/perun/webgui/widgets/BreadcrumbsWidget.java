...
public class BreadcrumbsWidget extends Composite {
  ...
  public void setLocation(int menuSectionRole, String main, String mainLink, String sub, String subLink) {
    ...
    if (main != null && !main.isEmpty()) {
      if (mainLink != null && !mainLink.isEmpty()) {
        ...
        innerHtml += "<a title=\"" + main + "\" style=\"now-managing\" href=\"#" + mainLink + active + "\">" +
            Utils.getStrippedStringWithEllipsis(main, 40) + "</a>";
      } else {
    ...
    if (sub != null && !sub.isEmpty()) {
      if (subLink != null && !subLink.isEmpty()) {
        ...
        innerHtml += " &gt; <a title=\"" + sub + "\" style=\"now-managing\" href=\"#" + subLink + active + "\">" +
            Utils.getStrippedStringWithEllipsis(sub, 40) + "</a>";
      } else {
  ...
  public void setLocation(VirtualOrganization vo, String subSection, String subSectionLink) {
    ...
    String innerHtml = "<a title=\"" + vo.getName() + "\" style=\"now-managing\" href=\"#" + VosTabs.URL +
        UrlMapper.TAB_NAME_SEPARATOR + "detail" + "?id=" + vo.getId() + "&active=1;\" >";
  ...
  public void setLocation(Facility facility, String subSection, String subSectionLink) {
    ...
    String innerHtml = "<a title=\"" + facility.getName() + "\" style=\"now-managing\" href=\"#" + FacilitiesTabs.URL +
        UrlMapper.TAB_NAME_SEPARATOR + "detail" + "?id=" + facility.getId() + "&active=1;\" >";
  ...
  public void setLocation(User user, String subSection, String subSectionLink) {
    ...
    String innerHtml =
        "<a title=\"" + user.getFullNameWithTitles() + "\" style=\"now-managing\" href=\"#" + UsersTabs.URL +
            UrlMapper.TAB_NAME_SEPARATOR + "info" + "?id=" + user.getId() + "&active=1;\" >";
