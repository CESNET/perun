...
public class TabMenu extends Composite {
  ...
  private void setStyles() {
    ...
    for (int i = 0; i < cellCount; i++) {
      if (i == 0) {
        menu.getFlexCellFormatter().addStyleName(0, i, "tabMenu-first");
      }
   ...
   */
  public <T extends SuggestOracle> SuggestOracle addFilterWidget(ExtendedSuggestBox box,
                                                                 final PerunSearchEvent filterEvent,
                                                                 final String title) {
