...
public class Application extends JavaScriptObject {
   ...
   * @return
   */
  static public Application construct(VirtualOrganization vo, Group group, String type, String fedInfo, String actor,
                                      String extSourceName, String extSourceType, int extSourceLoa) {
