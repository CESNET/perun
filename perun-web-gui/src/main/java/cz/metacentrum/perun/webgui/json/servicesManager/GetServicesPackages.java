...
public class GetServicesPackages
    implements JsonCallback, JsonCallbackTable<ServicesPackage>, JsonCallbackOracle<ServicesPackage> {

  // Selection model
  final MultiSelectionModel<ServicesPackage> selectionModel =
      new MultiSelectionModel<ServicesPackage>(new GeneralKeyProvider<ServicesPackage>());
  ...
  public CellTable<ServicesPackage> getEmptyTable() {
    ...
    if (!editable) {
      ...
      // DESCRIPTION COLUMN
      final Column<ServicesPackage, String> descriptionColumn =
          new Column<ServicesPackage, String>(new TextInputCell()) {
            public String getValue(ServicesPackage object) {
      ...
      // Link COLUMN
      final Column<ServicesPackage, String> linkColumn =
          new Column<ServicesPackage, String>(new CustomClickableTextCell()) {
            public String getValue(ServicesPackage object) {
