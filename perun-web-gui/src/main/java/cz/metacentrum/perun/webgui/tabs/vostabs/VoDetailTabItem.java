...
public class VoDetailTabItem implements TabItem, TabItemWithUrl {
  ...
  public Widget draw() {
    ...
    if (JsonUtils.isExtendedInfoVisible()) {
      menu.setHTML(0, column,
          "<strong>ID:</strong><br/><span class=\"inputFormInlineComment\">" + vo.getId() + "</span>");
      column++;
      menu.setHTML(0, column, "&nbsp;");
      menu.getFlexCellFormatter().setWidth(0, column, "25px");
      column++;

      menu.setHTML(0, column, "<strong>Short&nbsp;name:</strong><br/><span class=\"inputFormInlineComment\">" +
          SafeHtmlUtils.fromString((vo.getShortName() != null) ? vo.getShortName() : "").asString() + "</span>");
