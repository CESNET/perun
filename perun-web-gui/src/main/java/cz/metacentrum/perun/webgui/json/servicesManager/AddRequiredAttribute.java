    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      public void onError(PerunError error) {
        session.getUiElements().setLogErrorText(
            "Adding required attribute ID: " + attributeId + " to service ID: " + serviceId + " failed.");
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("Attribute ID: " + attributeId + " set as required to service ID: " + serviceId);
        ;
