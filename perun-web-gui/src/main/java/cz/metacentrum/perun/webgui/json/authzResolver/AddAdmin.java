...
public class AddAdmin {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("User " + user.getFullName() + " added as manager of " + group.getName());
  ...
  public void addVoAdmin(final VirtualOrganization vo, final User user) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("User " + user.getFullName() + " added as manager of " + vo.getName());
        events.onFinished(jso);
      }
  ...
  public void addFacilityAdmin(final Facility facility, final User user) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("User " + user.getFullName() + " added as manager of " + facility.getName());
        events.onFinished(jso);
      }
  ...
  public void addGroupAdminGroup(final Group groupToAddAdminTo, final Group group) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("Group " + group.getShortName() + " added as manager of " + groupToAddAdminTo.getName());
        events.onFinished(jso);
      }
  ...
  public void addVoAdminGroup(final VirtualOrganization vo, final Group group) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("Group " + group.getShortName() + " added as manager of " + vo.getName());
        events.onFinished(jso);
      }
  ...
  public void addFacilityAdminGroup(final Facility facility, final Group group) {
    ...
    JsonCallbackEvents newEvents = new JsonCallbackEvents() {
      ...
      public void onFinished(JavaScriptObject jso) {
        session.getUiElements()
            .setLogSuccessText("Group " + group.getShortName() + " added as manager of " + facility.getName());
        events.onFinished(jso);
      }
