...
public class RequestQuotaChangeTabItem implements TabItem {
  ...
  public Widget draw() {
    ...
    final CustomButton requestQuotaButton =
        new CustomButton("Send request", "Send quota change request", SmallIcons.INSTANCE.emailIcon());
    ...
    requestQuotaButton.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent event) {
        ...
        if (quotaType.equals(QuotaType.DATA)) {
          requestQuotaChange(newQuota.getTextBox().getValue().trim() + units.getItemText(units.getSelectedIndex()),
              reason.getTextArea().getText());
        } else {
  ...
  public boolean equals(Object obj) {
    ...
    if (!this.user.equals(((RequestQuotaChangeTabItem) obj).user) &&
        !this.resource.equals(((RequestQuotaChangeTabItem) obj).resource) &&
        this.quotaType != ((RequestQuotaChangeTabItem) obj).quotaType) {
      return false;
    }
