...
public class SendCollectorTest extends AbstractEngineTest {
  ...
  public void sendCollectorTaskExceptionTest() throws Exception {
    ...
    doReturn(sendTask1).doThrow(
            new TaskExecutionException(sendTask2.getTask(), sendTask2.getDestination(), "Test error"))
  ...
  public void setUp() throws Exception {
    ...
    SendCollector sendCollector = new SendCollector(sendCompletionServiceMock, schedulingPoolMock, jmsQueueManagerMock);
