...
$objectExamples{"AssignedResource"} = "{ \"enrichedResource\" : " . $objectExamples{"EnrichedResource"} . " , \"status\" : \"FAILED\" , \"sourceGroupId\" : 10 , \"failureCause\" : \"Wrong attribute value in group 1\"" . " , \"facility\" : " . $objectExamples{"Facility"} . " , \"resourceTags\" : " . $objectExamples{"List<ResourceTag>"} . " }";
...
$objectExamples{"AssignedGroup"} = "{ \"enrichedGroup\" : " . $objectExamples{"EnrichedGroup"} . " , \"status\" : \"FAILED\" , \"sourceGroupId\" : 10 , \"failureCause\" : \"Wrong attribute value in group 1\" }";
