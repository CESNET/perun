...
my @roles = ("UNAUTHORIZED","PERUNADMIN","VOADMIN","VOOBSERVER","GROUPADMIN", "FACILITYADMIN","SELF","SERVICE","REGISTRAR","RPC","ENGINE","SECURITYADMIN","AUTHZRESOLVER","TOPGROUPCREATOR", "GROUPCREATOR", "SPONSOR","SERVICEUSER","RESOURCEADMIN");
