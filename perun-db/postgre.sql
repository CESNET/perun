...
create sequence "exec_services_id_seq" start with 20 increment by 1 maxvalue 9223372036854775807 no minvalue no cycle;
...
create sequence "tasks_id_seq" start with 10 increment by 1 maxvalue 9223372036854775807 no minvalue no cycle;
create sequence "tasks_results_id_seq" start with 10 increment by 1 maxvalue 9223372036854775807 no minvalue no cycle;
...
alter table authz add constraint authz_user_serprinc_autgrp_chk check ((user_id is not null and service_principal_id is null and authorized_group_id is null) or (user_id is null and service_principal_id is not null and
authorized_group_id is null) or (user_id is null and service_principal_id
is null and authorized_group_id is  not null));
