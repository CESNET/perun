...
public final class JsonSerializerJsonSimple implements Serializer {
   ...
   */
  public JsonSerializerJsonSimple(OutputStream out) {
    this.out = out;
  }
  ...
  public void writePerunRuntimeException(PerunRuntimeException prex) {
    ...
    MAPPER.writeValue(out, prex);
  }

  @JsonIgnoreProperties({"name", "createdAt", "createdBy", "modifiedAt", "modifiedBy", "createdByUid", "modifiedByUid",
      "valueCreatedAt", "valueCreatedBy", "valueModifiedAt", "valueModifiedBy", "beanName", "writable", "displayName",
      "description", "entity", "baseFriendlyName", "friendlyNameParameter", "id", "type"})
  private interface AttributeMixIn {
  }

  @JsonIgnoreProperties({"name", "createdAt", "createdBy", "modifiedAt", "modifiedBy", "createdByUid", "modifiedByUid",
      "beanName", "writable", "displayName", "description", "entity", "baseFriendlyName", "friendlyNameParameter", "id",
      "type"})
