...
public class AttributeDefinition extends Auditable implements Comparable<PerunBean>, Serializable {
  ...
  public AttributeDefinition(AttributeDefinition attributeDefinition) {
    super(attributeDefinition.getId(), attributeDefinition.getCreatedAt(), attributeDefinition.getCreatedBy(),
        attributeDefinition.getModifiedAt(), attributeDefinition.getModifiedBy(), attributeDefinition.getCreatedByUid(),
        attributeDefinition.getModifiedByUid());
  ...
  public int compareTo(PerunBean perunBean) {
    ...
    if (perunBean instanceof AttributeDefinition) {
      ...
      if (this.getFriendlyName() == null && attrDef.getFriendlyName() != null) {
        return -1;
      }
      if (attrDef.getFriendlyName() == null && this.getFriendlyName() != null) {
        return 1;
      }
      if (this.getFriendlyName() == null && attrDef.getFriendlyName() == null) {
        return 0;
