...
/**
 * Thrown when the given login is already blocked for the given namespace Thrown also if the given namespace is null and
 * the given login is already blocked globally
 *
