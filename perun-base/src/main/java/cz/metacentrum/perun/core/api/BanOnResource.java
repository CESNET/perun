...
public class BanOnResource extends Ban implements Comparable<PerunBean> {
  ...
  public boolean equals(Object obj) {
    ...
    if (this.getValidityTo() == null ? other.getValidityTo() != null :
        this.getValidityTo().getTime() != other.getValidityTo().getTime()) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getMemberId(), getResourceId());
  }
  ...
  public String serializeToString() {
    ...
    return str.append(this.getClass().getSimpleName()).append(":[").append("id=<").append(getId()).append(">")
        .append(", memberId=<").append(getMemberId()).append(">").append(", resourceId=<").append(getResourceId())
  ...
  public String toString() {
    ...
    return str.append(getClass().getSimpleName()).append(":[id='").append(getId()).append("', memberId='")
        .append(getMemberId()).append("', resourceId='").append(getResourceId()).append("', validityTo='")
