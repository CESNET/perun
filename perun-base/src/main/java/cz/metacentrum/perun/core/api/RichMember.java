...
public class RichMember extends Member implements Comparable<PerunBean> {
  ...
  public String serializeToString() {
    ...
    return str.append(this.getClass().getSimpleName()).append(":[").append(
        ...
        .append(">").append(
            ", type=<")
        .append(getMembershipType() == null ? "\\0" : BeansUtils.createEscaping(getMembershipType().toString()))
        .append(">").append(
            ", sourceGroupId=<").append(getSourceGroupId() == null ? "\\0" : getSourceGroupId().toString()).append(">")
        .append(
