...
public class RpcException extends InternalErrorException {
  ...
  public RpcException(Type type, String errorInfo) {
    super(errorInfo == null ? type.toString() :
        new StringBuilder(type.toString()).append(": ").append(errorInfo).toString());
    this.type = type;
  ...
  public RpcException(Type type, String errorInfo, Throwable cause) {
    super(errorInfo == null ? type.toString() :
        new StringBuilder(type.toString()).append(": ").append(errorInfo).toString(), cause);
    this.type = type;
  ...
  public enum Type {
    ...
    NO_PATHINFO, INVALID_URL, UNKNOWN_SERIALIZER_FORMAT, UNKNOWN_DESERIALIZER_FORMAT, NOT_AN_INTEGER,
    WRONGLY_FORMATTED_CONTENT, CANNOT_DESERIALIZE_VALUE, CANNOT_SERIALIZE_VALUE, MISSING_VALUE, WRONG_PARAMETER,
    AMBIGUOUS_CALL, UNKNOWN_MANAGER, UNKNOWN_METHOD, STATE_CHANGING_CALL, CLASS_NOT_FOUND, UNCATCHED_EXCEPTION,
    NO_REMOTE_USER_SPECIFIED, UNKNOWN_PERUN_RPC_SERVER, COMMUNICATION_ERROR_WITH_PERUN_RPC_SERVER,
    PERUN_RPC_SERVER_ERROR_HTTP_CODE, UNKNOWN_EXCEPTION;
  }
}
