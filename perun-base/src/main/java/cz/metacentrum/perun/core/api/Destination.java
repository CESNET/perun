...
public class Destination extends Auditable implements Comparable<PerunBean> {
  ...
  public static final String DESTINATIONS3JSON = "s3-json";
  public static final String DESTINATIONURLJSON = "url-json";
  ...
  public Destination(int id, String destination, String type, String createdAt, String createdBy, String modifiedAt,
