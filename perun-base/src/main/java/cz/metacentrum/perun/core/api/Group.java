...
public class Group extends Auditable implements Comparable<PerunBean>, HasUUID {
  ...
  public Group(String name, String description, String createdAt, String createdBy, String modifiedAt,
  ...
  public Group(int id, String name, String description, String createdAt, String createdBy, String modifiedAt,
               String modifiedBy, Integer createdByUid, Integer modifiedByUid) {
  ...
  public Group(String name, String description, String createdAt, String createdBy, String modifiedAt,
               String modifiedBy, Integer parentGroupId, Integer createdByUid, Integer modifiedByUid) {
    super(createdAt, createdBy, modifiedAt, modifiedBy, createdByUid, modifiedByUid);
    this.name = name;
    this.description = description;
    this.parentGroupId = parentGroupId;
  ...
  public int compareTo(PerunBean perunBean) {
    ...
    if (perunBean instanceof Group) {
      ...
      if (this.getName() == null && group.getName() != null) {
        return -1;
      }
