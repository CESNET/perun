...
public class UserExtSource extends Auditable implements Comparable<PerunBean> {
  ...
  public String serializeToString() {
    ...
    return str.append(this.getClass().getSimpleName()).append(":[").append("id=<").append(getId()).append(">")
        .append(", login=<").append(getLogin() == null ? "\\0" : BeansUtils.createEscaping(getLogin())).append(">")
        .append(", source=<").append(extSource == null ? "\\0" : getExtSource().serializeToString()).append(">")
        .append(", userId=<").append(getUserId()).append(">").append(", loa=<").append(getLoa()).append(">")
        .append(", lastAccess=<").append(lastAccess == null ? "\\0" : BeansUtils.createEscaping(lastAccess)).append(">")
        .append(']').toString();
  }
  ...
  public String toString() {
    ...
    return str.append(getClass().getSimpleName()).append(":[").append("id='").append(getId()).append('\'')
        .append(", login='").append(login).append('\'').append(", source='").append(extSource).append('\'')
        .append(", userId='").append(getUserId()).append('\'').append(", loa='").append(loa).append('\'')
        .append(", lastAccess='").append(lastAccess).append("\'").append(']').toString();
  }
}
