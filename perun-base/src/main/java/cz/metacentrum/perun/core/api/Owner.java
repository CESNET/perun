...
public class Owner extends Auditable implements Comparable<PerunBean> {
  ...
  public Owner(int id, String name, String contact, String createdAt, String createdBy, String modifiedAt,
  ...
  public Owner(int id, String name, String contact, OwnerType type, String createdAt, String createdBy,
