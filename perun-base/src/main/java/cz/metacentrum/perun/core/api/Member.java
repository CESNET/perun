...
public class Member extends Auditable {
  ...
  public Member(int id, String createdAt, String createdBy, String modifiedAt, String modifiedBy, Integer createdByUid,
  ...
  public Member(int id, int userId, int voId, Status status, String createdAt, String createdBy, String modifiedAt,
  ...
  public void setMembershipType(String type) {
    if (type == null) {
      ...
      this.membershipType = MembershipType.valueOf(type);
    }
  }
