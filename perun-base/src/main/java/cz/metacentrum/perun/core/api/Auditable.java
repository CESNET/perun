...
public abstract class Auditable extends PerunBean implements Serializable {
  ...
  public Auditable(int id, String createdAt, String createdBy, String modifiedAt, String modifiedBy,
  ...
  public Auditable(String createdAt, String createdBy, String modifiedAt, String modifiedBy, Integer createdByUid,
  ...
  public int compareByCreatedAt(Auditable auditable) {
    if (auditable == null || auditable.createdAt == null || this.createdAt == null) {
      throw new InternalErrorRuntimeException(
          new NullPointerException("There is null pointer in auditable object or in createdAt"));
    }
    Date date1;
    try {
