...
public class Role {
  ...
  public static List<String> rolesAsList() {
    return Arrays.asList(AUDITCONSUMERADMIN, CABINETADMIN, ENGINE, FACILITYADMIN, FACILITYOBSERVER,
        ...
        UNKNOWNROLENAME, VOADMIN, VOOBSERVER, SPONSORSHIP, MFA, PROXY, VOBANMANAGER, RESOURCEBANMANAGER,
        FACILITYBANMANAGER, SPONSORNOCREATERIGHTS, SERVICEACCOUNTCREATOR);
  }
}
