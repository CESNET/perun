...
public class PublicationSystem extends PerunBean {
  ...
  public String toString() {
    ...
    return str.append(getClass().getSimpleName()).append(":[id=").append(this.getId()).append(", friendlyName=")
        .append(this.getFriendlyName()).append(", loginNamespace=").append(this.getLoginNamespace())
        .append(", username=").append(this.getUsername()).append(", password=").append(this.getPassword())
        .append(", type=").append(this.getType()).append(", url=").append(this.getUrl()).append("]").toString();
  }
