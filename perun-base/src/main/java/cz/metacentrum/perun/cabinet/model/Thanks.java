...
public class Thanks extends PerunBean {
  ...
  public String toString() {
    ...
    return str.append(getClass().getSimpleName()).append(":[id=").append(getId()).append(", pubId=")
        .append(publicationId).append(", ownerId=").append(ownerId).append(", createdBy=").append(createdBy)
