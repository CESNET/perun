...
public class Publication extends PerunBean {
  ...
  public Publication(int id, int externalId, int publicationSystemId, String title, int year, String main, String isbn,
                     int categoryId, String doi, double rank, boolean locked, String createdBy, Date createdDate) {
    super(id);
    this.rank = rank;
  ...
  public Publication(List<Author> authors, double rank, int id, int externalId, int publicationSystemId, String title,
                     int year, String main, String isbn, int categoryId, String createdBy, Date createdDate, String doi,
                     boolean locked) {
    super(id);
  ...
  public Publication(List<Author> authors, double rank, int id, int externalId, int publicationSystemId, String title,
                     int year, String main, String isbn, int categoryId, String createdBy, Date createdDate, String doi,
                     boolean locked, int createdByUid) {
    this(authors, rank, id, externalId, publicationSystemId, title, year, main, isbn, categoryId, createdBy,
  ...
  public boolean equals(Object o) {
    ...
    return externalId == that.externalId && publicationSystemId == that.publicationSystemId;
  }
  ...
  public String serializeToString() {
    ...
    return str.append(this.getClass().getSimpleName()).append(":[").append("id=<").append(getId()).append(">")
        .append(", externalIdId=<").append(getExternalId()).append(">").append(", pubSysId=<")
        .append(getPublicationSystemId()).append(">").append(", title=<").append(getTitle()).append(">")
        .append(", categoryId=<").append(getCategoryId()).append(">").append(", year=<").append(getYear()).append(">")
        .append(", isbn=<").append(getIsbn()).append(">").append(", doi=<").append(getDoi()).append(">")
        .append(", locked=<").append(getLocked()).append(">").append(", main=<").append(getMain()).append(">")
        .append(", rank=<").append(getRank()).append(">").append(", authors=<").append(getAuthors()).append(">")
        .append(", createdBy=<").append(getCreatedBy()).append(">").append(", createdByUid=<").append(getCreatedByUid())
        .append(">").append(", createdDate=<").append(getCreatedDate()).append(">").append(']').toString();
  }
  ...
  public String toString() {
    ...
    return str.append(getClass().getSimpleName()).append(":[id=").append(getId()).append(", externalId=")
        .append(externalId).append(", pubSysId=").append(publicationSystemId).append(", title=").append(title)
        .append(", categoryId=").append(categoryId).append(", year=").append(year).append(", isbn=").append(isbn)
        .append(", doi=").append(doi).append(", locked=").append(locked).append(", main=").append(main)
        .append(", createdBy=").append(createdBy).append(", createdByUid=").append(createdByUid)
        .append(", createdDate=").append(createdDate).append(", rank=").append(rank).append(", authors=")
        .append(authors).append("]").toString();
  }
