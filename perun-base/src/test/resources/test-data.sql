...
insert into attr_names (created_by_uid,modified_by_uid,display_name,id,default_attr_id,attr_name,friendly_name,namespace,type,dsc,created_at,created_by,modified_at,modified_by) values (null,3261,'Level of assurance',3461,null,'urn:perun:user:attribute-def:virt:loa','loa','urn:perun:user:attribute-def:virt','java.lang.Integer','The highest value of LoA from all users userExtSources.',timestamp '2012-11-06 14:05:52.3','zlamalp@META',timestamp '2013-10-25 12:57:17.6','/C=CZ/O=Masaryk University/CN=Zora Sebestianova/unstructuredName=71378');
