...
public class EventExecServiceResolverImpl implements EventExecServiceResolver {
    ...
    public List<Pair<List<ExecService>, Facility>> parseEvent(String event) throws InvalidEventMessageException, ServiceNotExistsException, InternalErrorException, PrivilegeException {
        ...
        if (matchFound) {
            ...
            PerunSession perunSession = perun.getPerunSession(new PerunPrincipal(propertiesBean.getProperty("perun.principal.name"),
...
/* TESTING ONLY: drop any facilities not named test* */
        	       ...
        	       facilityResolvedFromEvent.getName().equals("torque.ics.muni.cz")) {
                	    ...
                	    log.debug("Dropping facility {} that is not meant for testing", facilityResolvedFromEvent.getName());
                	    continue;
                    }
