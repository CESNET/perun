...
public class AuditParserTest {
	...
	private AuditMessage createdAuditMessage = new AuditMessage();
        private final User user = new User(5, textMismatch,textMismatch, textMismatch, textMismatch, textMismatch, false);
        ...
        String log2 = "RichMember:[id=<12521>, userId=<9181>, voId=<21>, status=<DISABLED>, "
                ...
                + "Attribute:[id=<860>, friendlyName=<membershipExpiration>, namespace=<urn:perun:member:attribute-def:def>, type=<java.lang.String>, value=<2010-12-31 23:59:59.0>], "
