...
/**
 * Extracts the value of the first matching attribute into a form of a single-valued LDAP attribute, optionally using an
      ...
      if (this.appliesToAttribute(attribute)) {
        ...
        if (attribute.getType().equals(ArrayList.class.getName())) {
          ...
          if (values == null || values.size() == 0) {
            ...
            result = (valueTransformer == null) ? values.toString() : valueTransformer.getValue(values, attribute);
          }
