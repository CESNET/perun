...
public class Utils implements cz.metacentrum.perun.ldapc.initializer.api.UtilsApi {
	...
	public void initializeLDAPFromPerun(PerunInitializer perunInitializer, Boolean updateLastProcessedId) throws InternalErrorException {
		try {
			...
			int lastMessageBeforeInitializingData = perunInitializer.getPerunBl().getAuditMessagesManagerBl().getLastMessageId();
			...
			int lastMessageAfterInitializingData = perunInitializer.getPerunBl().getAuditMessagesManagerBl().getLastMessageId();
