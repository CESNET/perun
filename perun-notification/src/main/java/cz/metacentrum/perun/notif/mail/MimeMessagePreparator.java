 ...
 *
 * <p>The corresponding <code>send</code> methods of {@link org.springframework.mail.javamail.JavaMailSender}
 * will take care of the actual creation of a {@link MimeMessage} instance,
 * and of proper exception conversion.
 *
 * <p>It is often convenient to use a {@link org.springframework.mail.javamail.MimeMessageHelper} for populating
 * the passed-in MimeMessage, in particular when working with attachments or
 * special character encodings.
 * See {@link org.springframework.mail.javamail.MimeMessageHelper MimeMessageHelper's javadoc} for an example.
 *
...
public interface MimeMessagePreparator {
	 ...
	 * methods through for automatic conversion to the EmailException hierarchy
	 * @throws java.io.IOException passing any exceptions thrown by MimeMessage methods
	 * through for automatic conversion to the EmailException hierarchy
