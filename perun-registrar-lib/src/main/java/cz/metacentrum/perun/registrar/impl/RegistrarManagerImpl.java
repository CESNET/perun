...
public class RegistrarManagerImpl implements RegistrarManager {
	...
	public ApplicationFormItem addFormItem(PerunSession user, ApplicationForm form, ApplicationFormItem item) throws PrivilegeException, InternalErrorException {
		...
		item.setId(itemId);
		perun.getAuditer().log(user, "Application form item ID=" + form.getId() + " voID=" + form.getVo().getId() + " groupID=" + form.getGroup().getId() + " has been added");
		return item;
	...
	public int updateFormItems(PerunSession sess, ApplicationForm form, List<ApplicationFormItem> items) throws PrivilegeException, InternalErrorException {
		...
		perun.getAuditer().log(sess, "Application form ID=" + form.getId() + " voID=" + form.getVo().getId() + " groupID=" + form.getGroup().getId() + " has had its items updated.");
	...
	public int updateForm(PerunSession user, ApplicationForm form) throws InternalErrorException, PrivilegeException {
		...
		perun.getAuditer().log(user, "Application form ID=" + form.getId() + " voID=" + form.getVo().getId() + " groupID=" + form.getGroup().getId() + " has been updated.");
		return jdbc.update(
	...
	public void deleteFormItem(PerunSession user, ApplicationForm form, int ordnum) throws InternalErrorException, PrivilegeException {
		...
		perun.getAuditer().log(user, "Application form item ID=" + form.getId() + " voID=" + form.getVo().getId() + " groupID=" + form.getGroup().getId() + " has been deleted");
	...
	public List<ApplicationFormItemData> createApplication(PerunSession session, Application application, List<ApplicationFormItemData> data) throws PerunException {
		...
		perun.getAuditer().log(session, "Application ID=" + application.getId() + " voID=" + application.getVo().getId() + " groupID=" + application.getGroup().getId() + " has been created");
	...
	public void deleteApplication(PerunSession sess, Application app) throws PerunException {
		...
		perun.getAuditer().log(sess, "Application ID=" + app.getId() + " voID=" + app.getVo().getId() + " groupID=" + app.getGroup().getId() + " has been deleted");
	...
	public Application verifyApplication(PerunSession sess, int appId) throws PerunException {
		...
		perun.getAuditer().log(sess, "Application ID=" + appId + " voID=" + app.getVo().getId() + " groupID=" + app.getGroup().getId() + " has been verified.");
	...
	public Application rejectApplication(PerunSession sess, int appId, String reason) throws PerunException {
		...
		perun.getAuditer().log(sess, "Application ID=" + app.getId() + " voID=" + app.getVo().getId() + " groupID=" + app.getGroup().getId() + " has been rejected.");
		// return updated application
		return app;
	...
	public Application approveApplication(PerunSession sess, int appId) throws PerunException {
		...
		perun.getAuditer().log(sess, "Application ID=" + appId + " voID=" + app.getVo().getId() + " groupID=" + app.getGroup().getId() + " was approved.");
