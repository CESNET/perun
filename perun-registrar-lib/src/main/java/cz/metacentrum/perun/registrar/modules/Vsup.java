...
public class Vsup extends DefaultRegistrarModule {
  ...
  public Application approveApplication(PerunSession session, Application app)
      ...
      UserNotExistsException, WrongAttributeValueException, WrongReferenceAttributeValueException, PrivilegeException {
    ...
    if (user == null) {
      ...
      Attribute membershipExpirationAttr = perun.getAttributesManagerBl()
          .getAttribute(session, member, AttributesManager.NS_MEMBER_ATTR_DEF + ":membershipExpiration");
      ...
      Attribute manualExpirationAttr = perun.getAttributesManagerBl()
          .getAttribute(session, user, AttributesManager.NS_USER_ATTR_DEF + ":expirationManual");
    ...
    for (ApplicationFormItemData item : data) {
      if (item.getFormItem() != null && Objects.equals(AttributesManager.NS_USER_ATTR_DEF + ":birthNumber",
        ...
        if (rc != null && !rc.isEmpty()) {
          ExtSource es = perun.getExtSourcesManager()
              .checkOrCreateExtSource(session, "RC", ExtSourcesManager.EXTSOURCE_NAME_INTERNAL);
