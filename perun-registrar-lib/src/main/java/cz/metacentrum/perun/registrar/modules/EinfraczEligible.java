...
public class EinfraczEligible extends DefaultRegistrarModule {
  private static final Logger LOG = LoggerFactory.getLogger(EinfraczEligible.class);
  ...
  public void canBeApproved(PerunSession session, Application app) throws PerunException {
    ...
    throw new CantBeApprovedException(
        ...
        "NOT_ELIGIBLE_EINFRACZ", null, null, true, app.getId());
  }
