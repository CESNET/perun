...
public class BBMRINetworks extends DefaultRegistrarModule {
  ...
  public Application approveApplication(PerunSession session, Application app)
      ...
      RegistrarException, GroupNotExistsException, ExternallyManagedException, WrongAttributeAssignmentException,
      AttributeNotExistsException, WrongReferenceAttributeValueException, WrongAttributeValueException,
   ...
   */
  private Set<String> getNetworkIDsFromApplication(PerunSession session, Application app)
