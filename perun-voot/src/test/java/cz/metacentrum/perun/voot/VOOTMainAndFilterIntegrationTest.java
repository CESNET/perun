...
public class VOOTMainAndFilterIntegrationTest extends AbstractVOOTTest {
	...
	@Override
	public void setUpBackground() throws VoExistsException, InternalErrorException, GroupExistsException, AlreadyMemberException, WrongAttributeValueException, WrongAttributeAssignmentException, WrongReferenceAttributeValueException, AlreadyAdminException, AttributeDefinitionNotExistsException, ExtendMembershipException, GroupNotExistsException {
	...
	private void setMail(User user, String mailValue) throws InternalErrorException, WrongAttributeAssignmentException, WrongAttributeValueException, WrongReferenceAttributeValueException, AttributeDefinitionNotExistsException {
