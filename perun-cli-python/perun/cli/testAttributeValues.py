...
def test_attribute_values(
    ...
    try:
        ...
        attr = rpc.attributes_manager.get_member_attribute_by_name(
            member.id, "urn:perun:member:attribute-def:def:membershipExpiration"
        )
        print(
            attr["namespace"] + ":" + attr["friendlyName"],
            attr["type"],
            ":",
            attr["value"],
        )
